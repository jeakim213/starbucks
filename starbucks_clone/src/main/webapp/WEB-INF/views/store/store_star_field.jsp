...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="../common/css/style_store-3.css?v=210917" rel="stylesheet"><!-- 20190621 수정 -->
	...
	<body>
		<div class="teavana_dimm"></div>
		
		<div class="teavana_md_pop">
			<div class="teavana_pop_head">
				<p class="teavana_pop_tit">티바나 전용 MD</p>
				<p class="close"><a href="javascript:void(0)"><img src="../common/img/util/btn_closesa.png" alt="팝업 닫기"></a></p>
			</div>
			<div class="teavana_pop_cont">
				<div class="pop_cont_inner">
					<ul class="teavana_md_list">
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list01.jpg" alt=""></figure>
							<p>티바나 베이직 라임 머그 177ml</p>
						</li>
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list02.jpg" alt=""></figure>
							<p>티바나 베이직 옐로 머그 177ml</p>
						</li>
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list03.jpg" alt=""></figure>
							<p>티바나 베이직 그린 머그 177ml</p>
						</li>
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list04.jpg" alt=""></figure>
							<p>티바나 베이직 블루 머그 177ml</p>
						</li>
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list05.jpg" alt=""></figure>
							<p>티바나 블루 실리콘 글라스 100ml</p>
						</li>
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list06.jpg" alt=""></figure>
							<p>티바나 라임 실리콘 글라스 100ml</p>
						</li>
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list07.jpg" alt=""></figure>
							<p>티바나 라임 티 컵 200ml</p>
						</li>
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list08.jpg" alt=""></figure>
							<p>티바나  오렌지 티 컵 200ml</p>
						</li>
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list09.jpg" alt=""></figure>
							<p>티바나 블루 티 컵 200ml</p>
						</li>
						<li>
							<figure><img src="../common/img/store/teavana/teavana_md_list10.jpg" alt=""></figure>
							<p>티바나 그린 티 컵 200ml</p>
						</li>
					</ul>
				</div>
			</div>
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<!-- 161208 이미지 수정 -->
						<h2><img src="../common/img/store/teavana_new/store_teavana_tit.jpg" alt="티바나 바 매장"></h2><!-- 20190621 이미지 경로 수정 -->
						<!-- 161208 이미지 수정 end -->
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="javascript:void(0)" class="this">티바나 바 매장</a></li><!-- 20190621 수정 -->
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<!-- 월페이퍼 / 스크린세이버 -->
				<div class="starField_visual_wrap">
					<div class="starField_visual_inner">
						<p class="ttl_teavana ttl_teaNew"></p><!-- 20190621 class="ttl_teaNew" 추가 -->
						<p class="visual_teavana"></p>
					</div>
				</div>
				<div class="starField_line_up">
					<!-- <p>DID YOU KNOW?</p> -->
				</div>
				<div class="starField_know_area starTeavanaNew"><!-- 20190621 class="starTeavanaNew" 추가 -->
					<div class="starField_know_inner">
						<!-- 20190621 div class="sf_know_txt" 영역 삭제 -->
						<!-- s::20190621 수정 -->
						<picture class="sf_know_img01">
							<source srcset="../common/img/store/teavana_new/m_store_teavana_bar.png" media="(max-width:960px)">
							<img class="w_pic" src="../common/img/store/teavana_new/store_teavana_bar.png">
						</picture>
						<div class="starField_know_each01">
							<div class="sf_know_txt">
								<strong><i class="ttl_circle"></i>스타벅스 티바나 바</strong>
								<!-- 20210914 수정 -->
								<p class="teavanaTxtPc">
									<em>“고객과 파트너가 스타벅스 티바나를 교감하는 공간 TEAVANA BAR”</em>
									티바나 바 매장에는 좀 더 특별하게 ‘스타벅스 티바나’를 경험할 수 있는 공간이 마련되어 있습니다. <br>
									티바나 바에서 샘플링과 시향, 시음 서비스를 통해 티가 만들어지는 과정을 파트너와 함께 체험해보세요.
								</p>
								<p class="teavanaTxtMo">
									<em>“고객과 파트너가 스타벅스 티바나를 교감하는 공간 TEAVANA BAR”</em>
									티바나 바 매장에는 좀 더 특별하게 ‘스타벅스 티바나’를 경험할 수 있는 공간이 마련되어 있습니다. <br>
									티바나 바에서 샘플링과 시향, 시음 서비스를 통해 <br>티가 만들어지는 과정을 파트너와 함께 체험해보세요.
								</p>
								<!-- //20210914 수정 -->
							</div>
						</div>

						<picture class="sf_know_img02">
							
							<source srcset="../img/event/2022/m_store_special_beverage_new_220418.png" media="(max-width:960px)">
							<img class="w_pic" src="../img/event/2022/store_special_beverage_new_220418.png">
						</picture>
						<div class="starField_know_each02">
							<div class="sf_know_txt">
								<strong><i class="ttl_circle"></i>스타벅스 티바나 SPECIAL BEVERAGE</strong>
								<!-- s::20191107 수정 -->
								<p class="teavanaTxtPc">
									<em>“티바나 특화 매장만의 스페셜 메뉴”</em>
									 폼폼 민트 티, 폼폼 유스베리 티, 제주 그린 티 브리즈, <br>유스베리 로즈 티 브리즈 등 전용 음료를 통해 <br>오직 티바나 특화매장만의 특별한 경험을 즐겨보세요.<br><!-- 20220418 수정 -->
									<span class="starMblock">(일부 쿠폰 사용 불가)</span>
								</p>
								<p class="teavanaTxtMo">
									<em>“티바나 특화 매장만의 스페셜 메뉴”</em>
									폼폼 민트 티, 폼폼 유스베리 티, 제주 그린 티 브리즈,<br>유스베리 로즈 티 브리즈 등 전용 음료를 통해 오직 <br>티바나 특화매장만의 특별한 경험을 즐겨보세요.<!-- 20210906 수정 -->
									<span class="starMblock">(일부 쿠폰 사용 불가)</span>
								</p>
								<!-- e::20191107 수정  --> 
							</div>
                        ...
                        <picture class="sf_know_img03">
							<source srcset="../common/img/store/teavana_new/m_store_tea_journey.png" media="(max-width:960px)">
							<img class="w_pic" src="../common/img/store/teavana_new/store_tea_journey.png">
						</picture>
                        <div class="starField_know_each03">
							<div class="sf_know_txt">
								<strong><i class="ttl_circle ttl_circle"></i>스타벅스 티바나 TEA JOURNEY SERVICE</strong>
								<!-- s::20191107 수정 -->
								<p class="teavanaTxtPc">
									<em>“신선한 티와 재료들의 만남으로 완벽해지는 티바나 경험”</em>
									  티 원재료의 살아있는 풍미와 개성 넘치는 재료들의 만남을 <br>티바나 티 저니로 만나보세요.<br>
									<span class="starMblock">(BOGO 쿠폰 사용 불가)</span>   
								</p>
								<p class="teavanaTxtMo">
									<em>“신선한 티와 재료들의 만남으로 <br>완벽해지는 티바나 경험”</em>
									티 원재료의 살아있는 풍미와 개성 넘치는 재료들의 <br>만남을 티바나 티 저니로 만나보세요.<br>
									<span class="starMblock">(BOGO 쿠폰 사용 불가)</span>   
								</p>
								<!-- e::20191107 수정 -->
							</div>
						...
						<picture class="sf_know_img04">
							<source srcset="../common/img/store/teavana_new/m_store_special_md.png" media="(max-width:960px)">
							<img class="w_pic" src="../common/img/store/teavana_new/store_special_md.png">
						</picture>
						<div class="starField_know_each04">
							<div class="sf_know_txt">
								<strong><i class="ttl_circle ttl_circle"></i>스타벅스 티바나 SPECIAL MD</strong>
								<a class="sf_btn_more sf_btn_more1 sfpop2" href="javascript:void(0);">자세히보기</a>
								<!-- s::20191107 수정 -->
								<p class="teavanaTxtPc">
									<em>“오직 티바나 특화 매장에서만 만나볼 수 있는 다양한 상품”</em>
									‘스타벅스 티바나’의 활기차고 모던한 분위기를 더욱 즐길 수 있는 <br>머그, 피쳐머그, 글라스, 컵을 오직 티바나 특화 매장에서만 만나볼 수 있습니다.<!-- 20210914 수정 -->
								</p>
								<p class="teavanaTxtMo">
									<em>“오직 티바나 특화 매장에서만 <br>만나볼 수 있는 다양한 상품 ”</em>
									‘스타벅스 티바나’의 활기차고 모던한 분위기를 <br>더욱 즐길 수 있는 머그, 피쳐머그, 글라스, 컵을 오직 <br>티바나 특화 매장에서만 만나볼 수 있습니다.<!-- 20210914 수정 -->
								</p>
								<!-- e::20191107 수정 -->
							</div>
						</div>
				...
				<!-- 월페이퍼 / 스크린세이버 end -->
				<!-- (드라이브 스루 매장) ber -->
				<section class="sfield_bar_wrap">
					<article class="sfield_bar_inner sfield_inner_new"><!-- 20190621 class="sfield_inner_new" 추가 -->
						<dl class="sfield_bar">
							<!-- 20190621 텍스트 수정 -->
							<dt><img src="../common/img/store/icon_premier_store.png" alt="">Starbucks TEAVANA Store</dt>
							<dd>티바나 특화 음료를 판매하는 <span class="store_star_field_count_text">개</span> 매장을 확인하세요.</dd>
							<!-- 20190621 텍스트 수정 end -->
						</dl>
					</article>
					<!-- 161208 셀렉트 박스 추가 수정 -->
					<div class="sfield_selector_wrap">
						<div class="sfield_selector_inner">
							<div class="sfield_selector_area">
								<dl class="sfield_selector">
									<dt>매장 바로가기</dt>
									<dd>
										<div class="select_box">
											<label for="" class="value">매장 바로가기</label>
											<select title="매장 바로가기" name="store_select" id="store_select">
												<option value="">매장 바로가기</option>
											</select>
										</div>
									</dd>
								</dl>
			...
			<script>
				$(document).ready(function(){
					...
					$(".select_box select").on("change",function(){
						...
						var gps_lat = $(this).find("option:selected").data("lat");
						var gps_lng = $(this).find("option:selected").data("long");
						var thisIndex = $(this).find("option:selected").data("index");
						if($(this).val() != ""){
							var markerPosition = new daum.maps.LatLng(gps_lat, gps_lng);
					...
					$(".sfpop2").click(function(){
						var wh = $(window).scrollTop();
						$(".teavana_md_pop").css('top', wh+150 + "px");
						$(".teavana_dimm, .teavana_md_pop").fadeIn();
					});

					//20171221 추가 : 끝
					$(".close").click(function(){
						$(this).parent().parent().fadeOut();
						$(".teavana_dimm").fadeOut();
					});
