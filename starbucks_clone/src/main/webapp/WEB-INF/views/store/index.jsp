					...
					<nav class="mob_gnb_menus">
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="store_nitro_coldbrew">나이트로 콜드브루</a></li>
									<li><a href="store_coldbrew">콜드 브루</a></li>
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li class="en"><a href="index" class="this">STORE</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				...
				<section class="store_bn1_section">
					<article class="store_bn_inner">
						...
						<div class="store_bn1_btn"><a href="store_map">매장 찾기</a></div>
					</article>
				</section>
				...
				<section class="store_bn2_section">
					<article class="store_bn_inner">
						...
						<div class="store_bn2_btn"><a href="store_drive">자세히 보기</a></div>
					</article>
				</section>
				...
				<section class="store_bn3_section">
					<article class="store_bn_inner">
						...
						<div class="store_bn3_btn"><a href="store_reserve">자세히 보기</a></div>
					</article>
				</section>
				...
				<section class="store_bn4_section">
					<article class="store_bn_inner">
						...
						<div class="store_bn4_btn"><a href="store_community">자세히 보기</a></div>
					</article>
				</section>
				...
				<!-- <section class="store_bn6_section">
					<article class="store_bn_inner">
						...
						<div class="store_bn6_btn"><a href="/store/store_cheongdam ">자세히 보기</a></div>
					</article>
				</section> -->
				<!-- 161223 청담스타 추가 end -->		
				<!-- //20210727 일부 메뉴 비노출 -->	
