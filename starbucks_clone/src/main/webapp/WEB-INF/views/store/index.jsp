			...
			<div class="tablet_gnb_wrap">
				...
				<nav class="tablet_gnb_sep">
					<ul>
						...
						<li class="tablet_gnb03"><a href="store_map.do.html"><span class="a11y">매장찾기</span></a><!-- 접근성_20171106 span추가 --></li>
					...
					<nav class="mob_gnb_menus">
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="store_nitro_coldbrew.do.html">나이트로 콜드브루</a></li>
									<li><a href="store_coldbrew.do.html">콜드 브루</a></li>
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="store_map.do-1.html?disp=quick">빠른 검색</a></li>
									<li><a href="store_map.do-2.html?disp=locale">지역 검색</a></li>
								</ul>
							</li>
							<li><a href="store_drive.do.html">드라이브 스루 매장</a></li>
							<li><a href="store_reserve.do.html">스타벅스 리저브™ 매장</a></li>
							<li><a href="store_community.do.html">커뮤니티 스토어 매장</a></li>
							<li>
								...
								<ul>
									...
									<li><a href="store_star_field.do.html">티바나 바 매장</a></li>
...
<ul>
	...
	<li class="util_nav04"><a href="store_map.do.html">Find a Store</a></li>
</ul>
				</nav>
				<p class="btn_search">
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/store/store_tit.jpg" alt="STORE"></h2>
						<ul class="smap">
							...
							<li class="en"><a href="index.do.html" class="this">STORE</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				...
				<!-- 170106 일시적용 -->
				<div class="store_yt_layer" role="dialog" aria-hidden="true" aria-labelledby="store_pop_tit"><!-- 접근성_20171201 role, aria 추가 -->
					<h4 class="a11y" id="store_pop_tit">스타벅스 청담스타점 360도 VR</h4><!-- 접근성_20171201 추가 -->
					<p class="store_yt_close"><a href="javascript:void(0);" role="button">닫기</a></p><!-- 접근성_20171201 role 추가 -->
					<iframe id="storeYt" width="100%" height="100%" src="https://www.youtube.com/embed/lY92-YeTu4M?rel=0&enablejsapi=1" frameborder="0" allowfullscreen="" title="스타벅스 1,000호점 청담스타점 360 VR"></iframe><!-- 접근성_20171201 title 추가 -->
				</div>
				<!-- 170106 일시적용 end -->
				...
				<!-- <div class="storeSlideArea">
					<div class="bxslide-main">
							...
							<div class="bnr_temp_store">
								<div class="bnr_temp_store_inner">
									<div class="bnr_temp_store_txt_wrap">
										...
										<p class="btn_temp_store">
											<a href="javascript:void(0);" role="button">동영상 보기</a>접근성_20171201 role 추가
										</p>
									</div>
								</div>
							</div>
						...
						170106 일시중단
						<ul class="store_slider">
						</ul>
						<div class="store_slider_control_pager">
							<div class="store_slider_controls"></div>
							<div class="store_slider_pagers"></div>
						</div>
				...
				<!-- <div class="m_main_slide">
					...
					<div class="m_main_controller">
						<div class="m2_main_controls"></div>
						<div class="m2_main_pagers"></div>
					</div>
				...
				<div class="newsArea">
					...
					<div class="newsArea_bg">
						<div class="newsArea_bgl">
							<dl>
								<dt><img class="w_pic" src="../common/img/menu/news_title.png" alt="보도자료"><img class="m_pic" src="../common/img/common/icon_board_speaker-1.png" alt=""></dt><!-- jsp 수정 - 이미지 및 클래스 추가 -->
								<dd>
									<ul class="news_result">
										<li><a href="javascript:void(0)">스타벅스, 다회용컵 할인으로 30억원 환경사랑1</a></li>
										<li><a href="javascript:void(0)">스타벅스, 다회용컵 할인으로 30억원 환경사랑2</a></li>
										<li><a href="javascript:void(0)">스타벅스, 다회용컵 할인으로 30억원 환경사랑3</a></li>
									</ul>
								</dd>
							</dl>
							<p class="btn"><a href="javascript:void(0)"><img src="../common/img/coffee/icon_coffee_notice_more.png" alt="보도자료 바로가기"></a></p>
						</div>
				...
				<section class="store_bn1_section">
					<article class="store_bn_inner">
						<img class="m_pic" src="../common/img/store/m_store_bn1_171109.jpg" alt="">
						<div class="store_bn1_txt">
							<img class="w_pic" src="../common/img/store/store_bn1_txt01.png" alt="나의 일상이 되는 또 다른 공간 커피 한 잔의 여유를 만나는 스타벅스 매장 이제 전국 어디에서나 만날 수 있는 스타벅스 매장을 지역별, 타입별, 서비스별 등의 설정을 통해 더욱 쉽고 빠르게 찾아보세요.">
							<img class="m_pic" src="../common/img/store/m_store_btxt1.png" alt="나의 일상이 되는 또 다른 공간 커피 한 잔의 여유를 만나는 스타벅스 매장 이제 전국 어디에서나 만날 수 있는 스타벅스 매장을 지역별, 타입별, 서비스별 등의 설정을 통해 더욱 쉽고 빠르게 찾아보세요.">
						</div>
						<div class="store_bn1_btn"><a href="store_map.do.html">매장 찾기</a></div>
					</article>
				</section>
				<!-- 1.나의 일상이 되는 또 다른 공간 커피 한 잔의 여유를 만나는 스타벅스 매장 end -->
				<!-- 2.차에서 경험하는 새로운 스타벅스 드라이브 스루 Drive Thru 매장 -->
				<section class="store_bn2_section">
					<article class="store_bn_inner">
						<img class="m_pic" src="../common/img/store/m_store_bimg2.jpg" alt="">
						<div class="store_bn2_txt">
							<img class="w_pic" src="../common/img/store/store_bn2_txt01.png" alt="차에서 경험하는 새로운 스타벅스 드라이브 스루 Drive Thru 매장 전 세계 최초의 Digital을 경험할 수 있는 차별화된 드라이브 스루 매장에서 색다른 서비스를 만나보세요.">
							<img class="m_pic" src="../common/img/store/m_store_btxt2.png" alt="차에서 경험하는 새로운 스타벅스 드라이브 스루 Drive Thru 매장 전 세계 최초의 Digital을 경험할 수 있는 차별화된 드라이브 스루 매장에서 색다른 서비스를 만나보세요.">
						</div>
						<div class="store_bn2_btn"><a href="store_drive.do.html">자세히 보기</a></div>
					</article>
				</section>
				<!--  2.차에서 경험하는 새로운 스타벅스 드라이브 스루 Drive Thru 매장 end -->
				<!-- 3.최고 그 이상의 가치 스타벅스 리저브™ 커피  -->
				<section class="store_bn3_section">
					<article class="store_bn_inner">
						<img class="m_pic" src="../common/img/store/m_store_bimg3.jpg" alt="">
						<div class="store_bn3_txt">
							<img class="w_pic" src="../common/img/store/store_bn3_txt01.png" alt="최고 그 이상의 가치 스타벅스 리저브 커피 스타벅스 리저브 매장을 방문하여 단일 원산지 원두의 프리미엄 커피와 함께 격조 높은 커피를 경험해보세요.">
							<img class="m_pic" src="../common/img/store/m_store_btxt3.png" alt="최고 그 이상의 가치 스타벅스 리저브 커피 스타벅스 리저브 매장을 방문하여 단일 원산지 원두의 프리미엄 커피와 함께 격조 높은 커피를 경험해보세요.">
						</div>
						<div class="store_bn3_btn"><a href="store_reserve.do.html">자세히 보기</a></div>
					</article>
				</section>
				<!-- 3.최고 그 이상의 가치 스타벅스 리저브™ 커피 end -->
				<!-- 4.지역사회와 소통하는 매장 따뜻한 마음이 만든 커뮤니티 스토어 -->
				<section class="store_bn4_section">
					<article class="store_bn_inner">
						<img class="m_pic" src="../common/img/store/m_store_bimg4.jpg" alt="">
						<div class="store_bn4_txt">
							<img class="w_pic" src="../common/img/store/store_bn4_txt01.png" alt="지역사회와 소통하는 매장 따뜻한 마음이 만든 커뮤니티 스토어 지역사회의 긍정적인 변화와 장기적인 발전을 위해 매장의 수익금을 지역사회의에 환원하는 커뮤니티 스토어의 따뜻함을 느껴보세요.">
							<img class="m_pic" src="../common/img/store/m_store_btxt4.png" alt="지역사회와 소통하는 매장 따뜻한 마음이 만든 커뮤니티 스토어 지역사회의 긍정적인 변화와 장기적인 발전을 위해 매장의 수익금을 지역사회의에 환원하는 커뮤니티 스토어의 따뜻함을 느껴보세요.">
						</div>
						<div class="store_bn4_btn"><a href="store_community.do.html">자세히 보기</a></div>
					</article>
				</section>
				<!-- 4.지역사회와 소통하는 매장 따뜻한 마음이 만든 커뮤니티 스토어 end -->
				
				<!-- 20210727 일부 메뉴 비노출 -->
				<!-- 161223 청담스타 추가 -->
				<!-- <section class="store_bn6_section">
					<article class="store_bn_inner">
						<img class="m_pic" src="//image.istarbucks.co.kr/common/img/store/m_store_bimg6_img01.jpg" alt="" />
						<div class="store_bn6_txt">
							<img class="w_pic" src="//image.istarbucks.co.kr/common/img/store/store_btxt6_01.png" alt="스타벅스 1,000호점 청담스타 스타벅스를 보다 특별하게, 보다 건강하게 즐길 수 있는 스토어 스타벅스 1,000호점인 청담스타에서 홈메이드 스타일의 전용푸드와 스타벅스 리저브 커피를 만나보세요." />
							<img class="m_pic" src="//image.istarbucks.co.kr/common/img/store/m_store_btxt6_01.png" alt="스타벅스 1,000호점 청담스타 스타벅스를 보다 특별하게, 보다 건강하게 즐길 수 있는 스토어 스타벅스 1,000호점인 청담스타에서 홈메이드 스타일의 전용푸드와 스타벅스 리저브 커피를 만나보세요." /></div>
						<div class="store_bn6_btn"><a href="/store/store_cheongdam.do ">자세히 보기</a></div>
					</article>
				</section> -->
				<!-- 161223 청담스타 추가 end -->		
				<!-- //20210727 일부 메뉴 비노출 -->	
...
// 					});
			...
			<script src="../common/js/store/store_main.js"></script>
			...
			$(document).ready(function(){
				...
				/* 170106 일시적용 */
				$('.btn_temp_store a').click(function(){
					$('.store_yt_layer').attr("tabindex","0").attr("aria-hidden","false").fadeIn().focus(); // 접근성_20171201 속성 추가
				});
				$('.store_yt_close a').click(function(){
					$('.store_yt_layer').attr("tabindex", "-1").attr("aria-hidden", "true").fadeOut(); // 접근성_20171201 속성 추가
					var yt = $('#storeYt').attr('src');
					$('#storeYt').attr('src', '');
					$('#storeYt').attr('src', yt);
					$('.btn_temp_store a:visible').focus(); // 접근성_20171201 focus 이동 추가
				});
				/* 170106 일시적용 end */
                ...
                function(data) {
                    if(data.list.length > 0) {
                        ...
                        $.each( data.list, function(x, y) {
                            ...
                            if(y.banner_GBN == "I") {
                                tmpStr += '<li style="background-color: '+y.simg_NM+'"><div class="isBannerClick" data-link="'+y.links+'" style="background-image: url('+y.img_UPLOAD_PATH.replace("www", "image")+'/upload/banner/'+y.img_NM+'); background-size: cover; background-repeat: no-repeat;" >';
                                if(y.links != "") {
                                    if(y.banner_TARGET == "Y") {
                                        tmpTarget = "target='_blank'";
                                    }
                                    tmpStr += '<a href="'+y.links+'" '+tmpTarget+' style="width:100%;height"100%"></a>';
                                }
                                tmpStr += '</div></li>';
                                
                                
                                ytbArr.push('<a href="'+y.links+'" '+tmpTarget+' style="width:100%;height"100%"></a>');
                                ...
                                tmpStr += '<li style="background-color: '+y.simg_NM+'"><div class="video"><iframe width="100%" height="100%" src="https://www.youtube.com/embed/'+y.youtube+'?wmode=transparent&rel=0" frameborder="0" allowfullscreen></iframe></div></li>';
                                m_tmpStr += '<li class="respon_video"><div class="video"><iframe width="100%" height="100%" src="https://www.youtube.com/embed/'+y.youtube+'?wmode=transparent&rel=0" frameborder="0" allowfullscreen></iframe></div></li>';

                                ytbArr.push('<iframe width="100%" height="100%" src="https://www.youtube.com/embed/'+y.youtube+'?wmode=transparent&rel=0" frameborder="0" allowfullscreen></iframe>');
                            }
                            
                            $('.store_slider').append(tmpStr);
                            $('.m_main_slider').append(m_tmpStr);
                            
                            $(".isBannerClick").on("click", function(){
                        ...
                        var storeSlide = $('.store_slider').bxSlider({
                            pause: 5000,
                            speed: 2000,
                            mode: 'fade',
                            controls: true,
                            ...
                            //auto: false,
                             pager: true,
                             pagerSelector:'.store_slider_pagers',
                             autoControlsSelector:'.store_slider_controls',
                            autoHover: true,
                            onSlideBefore : function($slideElement, oldIndex, newIndex){
                                
                            	console.log(ytbArr);
                            	
                                $('.store_slider li').each(function(ix){
                                	
                                    $(this).children('div').html("");
                                    $(this).css({ 'background-color':'#000' });
                                    $(this).children('div').append( ytbArr[ix] );
                                });
                        ...
                        $("#prevBtn a").on("click",function(e){
                            storeSlide.goToPrevSlide();
                            e.preventDefault();
                        });

                        $("#nextBtn a").on("click",function(e){
                            storeSlide.goToNextSlide();
                            e.preventDefault();
                        });
                        ...
                        var m_slider = $('.m_main_slider').bxSlider({
                            ...
                            autoControls: true,
                            autoControlsCombine: true,
                            pagerSelector: '.m2_main_pagers',
                            autoControlsSelector: '.m2_main_controls' ,
                            onSlideBefore : function($slideElement, oldIndex, newIndex){
                                $('.respon_video').html("");
                                $slideElement.append( ytbArr[newIndex] );
                            }                       
                        });
				...
				// 150819 성연욱 수정
				$('.respon_video').eq(0).append('<iframe width="100%" height="100%" src="https://www.youtube.com/embed/kLiB9fQq2h8?wmode=transparent&rel=0" frameborder="0" allowfullscreen></iframe>');
				$('.respon_video').eq(1).append('<iframe width="100%" height="100%" src="https://www.youtube.com/embed/R2f__L6OKbk?wmode=transparent&rel=0" frameborder="0" allowfullscreen></iframe>');
				// 150819 성연욱 수정 end
