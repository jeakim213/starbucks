		...
		<!-- 서브 gnb end -->
			...
			<div id="container" class="reserveStoreWrap">  <!-- 20171714 수정 : reserveStoreWrap 클래스 추가 -->
				...
				<!-- 170105 황기흠 수정 -->
					...
					<style type="text/css">
						article.reserveStore_middle01 {background-image: url('../upload/banner/reservebnr/Y7YBKr_20220404155751368.png');  }
					</style>
				...
				<section class="reserve_store_bottom">
					<div class="st_cont">
						...
						<article class="reserveStore_bottom02">
							...
							<p class="link01">
								<a href="../coffee/higher_enjoy.do-4.html?PACKAGE=04 " targer="_blank" alt="추출방식별상세특징보러가기">
									추출방식별 상세특징 보러가기
								</a>
							</p>	
							<!--// 20170713추가 -->
