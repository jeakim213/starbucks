						...
						<section class="shopArea_pop01_inner">
							...
							<article class="shopArea_box">
								<div class="shopArea_left">
									<p class="big_img"><img src="../common/img/util/reward/shopArea_big_img01.jpg" alt="스타벅스 소공동점"></p>
									<ul class="s_img">
										<li><a href="javascript:void(0);"><img src="../common/img/util/reward/shopArea_s_img01.jpg" alt="스타벅스 소공동점"></a></li>
										<li><a href="javascript:void(0);"><img src="../common/img/util/reward/shopArea_s_img02.jpg" alt="스타벅스 소공동점"></a></li>
										<li><a href="javascript:void(0);"><img src="../common/img/util/reward/shopArea_s_img03.jpg" alt="스타벅스 소공동점"></a></li>
										<li><a href="javascript:void(0);"><img src="../common/img/util/reward/shopArea_s_img04.jpg" alt="스타벅스 소공동점"></a></li>
										<li><a href="javascript:void(0);"><img src="../common/img/util/reward/shopArea_s_img05.jpg" alt="스타벅스 소공동점"></a></li>
										<li><a href="javascript:void(0);"><img src="../common/img/util/reward/shopArea_s_img06.jpg" alt="스타벅스 소공동점"></a></li>
										<li><a href="javascript:void(0);"><img src="../common/img/util/reward/shopArea_s_img07.jpg" alt="스타벅스 소공동점"></a></li>
									</ul>
								</div>
								<div class="scrollbar-inner">
									<div class="shopArea_right">
										...
										<ul class="pop_btns_zon2">
											<li class="btn_f"><a href="javascript:void(0);"><img src="../common/img/util/reward/btn_f.gif" alt="패이스북"></a></li>
											<li class="btn_t"><a href="javascript:void(0);"><img src="../common/img/util/reward/btn_t.gif" alt="트위터"></a></li>
											<li class="btn_k"><a href="javascript:void(0);"><img src="../common/img/util/reward/btn_k.gif" alt="카카오스토리"></a></li>
										</ul>
										<dl class="shopArea_info">
											...
											<dd>02-758-8843</dd>
											<dt>타입</dt>
											<dd><span><img src="../common/img/util/reward/icon_shopArea_info01.gif" alt="R"></span></dd>
											<dt>서비스</dt>
											<dd><span><img src="../common/img/util/reward/icon_shopArea_info02.gif" alt="음식"></span><span><img src="../common/img/util/reward/icon_shopArea_info03.gif" alt="커피"></span><span><img src="../common/img/util/reward/icon_shopArea_info04.gif" alt="음료"></span></dd>
											<dt>위치 및 시설</dt>
											<dd><span><img src="../common/img/util/reward/icon_shopArea_info05.gif" alt="지하철"></span></dd>
									...
									<div class="my_ms_shopArea_bar">
										<ul>
											<li>
												...
												<figure><img alt="" src="../common/img/util/reward/shopArea_bar_sam1.png"></figure>
