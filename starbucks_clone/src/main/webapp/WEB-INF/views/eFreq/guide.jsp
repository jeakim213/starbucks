					...
					<nav class="mob_gnb_menus">
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="guide?promoSeq=172">이용안내</a></li>
									<li><a href="status-1?promoSeq=172" required="login">이용현황</a></li>
								</ul>
							</li>
										...
										<p>
											...
											<div class="ms_reward_mem_list">
												...
												<div class="ms_reward_mem_list_each">
													...
													<div class="ms_reward_mem_list_txt">
														...
														<div>스타벅스 리워드 회원에게는 <em>디지털 e-프리퀀시 바코드가 계정에 자동 발급됩니다.</em><br class="for_web"> 발급된 e-프리퀀시 바코드는 e-프리퀀시 이벤트 기간 중 확인 가능합니다.<br><br><a class="btn_guide_barcode_chk" href="status-1?promoSeq=172">회원 계정에 등록된 바코드 확인하기 &gt;</a></div>
													</div>
												</div>
												<div class="ms_reward_mem_list_each">
													<figure>
													...
													<div class="ms_reward_mem_list_txt">
														...
														<div>매장에서 제조 음료 구매 시, e-프리퀀시 바코드 화면을 제시하거나  등록된 스타벅스 카드로 결제하여<br class="for_web"> e-스티커를 적립할 수 있습니다. 등록된 스타벅스 카드 사용 시에는 별과 e-스티커 모두 동시 적립됩니다.<br class="for_web"> (현금/신용카드로 결제 시에도 회원 계정에 등록된 스타벅스 카드를 제시하면 e-스티커 적립이 가능합니다.)<br><br><a class="btn_guide_sticker_chk" href="status-2??promoSeq=172">적립된 e-스티커 조회하기 &gt;</a></div>
													</div>
												</div>
												<div class="ms_reward_mem_list_each">
													<figure>
											...
											<div class="ms_reward_mem_list">
												...
												<div class="ms_reward_mem_list_each">
													...
													<div class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">Step 1. 발급</strong>
														<div>스타벅스 홈페이지 회원에게는 <em>디지털 e-프리퀀시 바코드가 계정에 자동 발급 됩니다.</em><br class="for_web"> 발급된 e-프리퀀시 바코드는 e-프리퀀시 이벤트 기간 중 확인 가능합니다.<br><br><a class="btn_guide_barcode_chk" href="status-1?promoSeq=172">회원 계정에 등록된 바코드 확인하기 &gt;</a></div>
													</div>
												</div>
												<div class="ms_reward_mem_list_each">
													<figure>
													...
													<div class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">Step 2. 적립</strong>
														<div>매장에서 제조 음료 구매 시 e-프리퀀시 바코드 화면을 제시하면 e-스티커를 적립할 수 있습니다.<br> 적립된 e-스티커 내역은 e-프리퀀시 이벤트 기간 중 웹 페이지/모바일 애플리케이션/영수증을 통해 확인할 수 있습니다.<br><br><a class="btn_guide_sticker_chk" href="status-1?promoSeq=172">적립된 e-스티커 조회하기 &gt;</a></div>
													</div>
												</div>
												<div class="ms_reward_mem_list_each">
													<figure>
												...
												<div class="ms_reward_mem_list_each">
													...
													<div class="ml0">
														<ul class="sticker_save_chk_list">
															...
															<li>스타벅스 리워드 회원 및 홈페이지 회원은 스타벅스 홈페이지 로그인 후 My Starbucks &gt; My e-프리퀀시 메뉴 또는 휴대폰에서 웹 페이지(http://www.starbucks.co.kr/) 접속, 모바일 APP(다운로드 : http://www.starbucks.co.kr/util/app_tip)을 통해서도 e-프리퀀시 적립이 가능합니다.</li>
											...
											<div class="ms_reward_mem_list">
												...
												<div class="ms_reward_mem_list_each">
													...
													<p class="ms_reward_mem_list_txt">
														...
														보유한 e-스티커를 지인, 친구, 동료에게 선물할 수 있습니다.<br><br><a class="btn_guide_barcode_chk" href="gift?promoSeq=172">e-스티커 보내기(선물) 바로가기 &gt;</a>
													</p>
												</div>
											</div>
											<div class="ms_reward_mem_list">
...
<nav class="ms_nav" id="msRnb">					
	<ul>
		...
		<li class="msRnb_btn"><a href="javascript:void(0);" onclick="fn_rewardTumblerMsrCheck();">개인컵 리워드 설정</a></li>
		<li class="msRnb_btn"><a href="login/login" required="login">My DT Pass</a></li>
		<li>
