...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="../common/css/style_util-1.css" rel="stylesheet">
		<link href="../common/css/style_efreq.css?v=220413" rel="stylesheet">
		<link href="../common/css/2022summer_style_efreq.css?v=220413" rel="stylesheet"> <!-- 220405 수정 -->
	</head>
	<body>
				...
				<div class="top_msr_wrap" style="display:none;">
					...
					<div class="notice_icons">
						...
						<div class="notice_icon4">
							<a href="status.do.html?TYPE=BARCODE">
								<p></p>
					...
					<nav class="mob_gnb_menus">
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="guide.do.html?promoSeq=172">이용안내</a></li>
									<li><a href="status.do-1.html?promoSeq=172" required="login">이용현황</a></li>
								</ul>
							</li>
		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
                ...
                <header class="ms_sub_tit_wrap">
                    <div class="ms_sub_tit_bg">
                        <div class="ms_sub_tit_inner">
                            <h4><img alt="이용안내" src="../common/img/util/efreq/ttl_efreq_guide.png"></h4>
                            <ul class="smap">
                                <li><a href="javascript:void(0)"><img src="../common/img/common/icon_home_w.png" alt="홈으로"></a></li>
                                <li><img class="arrow" src="../common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
                                <li><a href="javascript:void(0)"><span class="en">My Starbucks</span></a></li>
                                <li><img class="arrow" src="../common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
                                <li><a href="javascript:void(0)"><span class="en">My e</span><span class="kor">-프리퀀시</span></a></li>
                                <li><img class="arrow" src="../common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
                                <li><a href="javascript:void(0)"><span class="kor">이용안내</span></a></li>
                            </ul>
                        </div>
                    </div>
                </header>
                ...
                <div class="ms_cont_wrap">
                    <!-- ms_cont -->
					<div class="ms_cont efreq2022summer"> <!-- 220405 클래스 수정 -->
						<section class="efreq_guide_ttl">
							<header>
								<h5>e-프리퀀시 이용안내</h5>
							</header>
							<article><strong>스타벅스 프리퀀시 이벤트가 온라인으로 쏘옥~ 들어왔습니다.</strong><br>더욱 스마트해진 스타벅스 e-프리퀀시에 대해 자세히 알아보고 더욱 편리하게 이용해 보세요.</article>
						</section>
						<section class="efreq_guide_list">						
							<!-- s::210825 수정 -->
							<div class="efreq_guide_type1">
								<dl class="efreq_guide_type_dl egt1">
									<dt>
										<strong>e-프리퀀시란</strong>
										<span class="arrow"><a href="javascript:void(0);"></a></span>
									</dt>
									<dd>
										<p>
											<strong>기존 종이 스티커를 사용하여 진행하던 프리퀀시와 달리 e-프리퀀시 바코드를 스캔 후 <br class="for_web">e-스티커를 적립하여 진행하는 친환경적이고, 편리한 이벤트 방법입니다.</strong><br><br>
											<span class="add_txt">* 스타벅스 리워드 회원은 계정에 등록된 스타벅스 카드로 결제 시 별과 e-스티커가 모두 동시에 적립됩니다.</span> <!-- 스타벅스 리워드 수정  -->
											<i class="webguide_icon1"></i>
										</p>
									</dd>
								</dl>
							</div>
							<div class="efreq_guide_type2">
								<dl class="efreq_guide_type_dl egt2">
									<dt>
										<strong>e-프리퀀시 용어 정리</strong>
										<span class="arrow"><a href="javascript:void(0);"></a></span>
									</dt>
									<dd>
										<!-- 210402 수정(클래스, 마크업, 문구) -->
										<p class="efreq_barcode_guide">
											<strong class="efreq_term_ttl">e-프리퀀시 바코드</strong>
											<span class="efreq_term_txt1">스타벅스 홈페이지 회원 또는 스타벅스 리워드 회원에게 자동 발급되는 디지털 바코드를 지칭하며,<br> e-프리퀀시 이벤트 기간 중 e-프리퀀시 바코드를 통해 e-스티커를 적립할 수 있습니다.</span>
											<span class="efreq_term_txt2"> 스타벅스 리워드 회원은 계정에 등록된 스타벅스 카드로 결제 시 별과 e-스티커가 모두 동시에 적립됩니다.</span>
											<i class="webguide_icon2"></i>
										</p>
										<!-- //210402 수정(클래스, 마크업, 문구) -->
										
										<p>
											<!-- 2017winter 수정 20171017_2 -->
											<strong class="efreq_term_ttl">e-스티커</strong>
											e-프리퀀시 이벤트 조건에 따라 적립되는 디지털 스티커입니다. 각 이벤트 e-스티커의 종류와 지급기준은<br class="for_web"> 이벤트 상세 안내를 통해 확인하실 수 있습니다.
											<i class="webguide_icon3"></i>
											<!-- 2017winter 수정 20171017_2 end -->
										</p>
										<p>
											<strong class="efreq_term_ttl">e-스티커 보내기(선물)</strong>
											자신이 적립한 e-스티커를 다른 사람(다른 e-프리퀀시 바코드)에게 보낼 수 있는 기능입니다.<br class="for_web"> 친구들과 필요한 e-스티커를 주고 받아 보세요. e-프리퀀시가 두 배로 즐거워집니다.
											<i class="webguide_icon4"></i>
										</p>
									</dd>
								</dl>
							</div>
							<div class="efreq_guide_type1">
								<dl class="efreq_guide_type_dl egt3">
									<dt>
										<strong>e-프리퀀시 바코드 발급, 적립, 사용하는 방법</strong>
										<span class="arrow"><a href="javascript:void(0);"></a></span>
									</dt>
									<dd>
										<p>
											<strong>e-프리퀀시 바코드를 발급(지급) 받는 방법 및 적립/사용 방법을 알려드립니다.</strong><br>
											<!-- <i class="icon_barcode"></i> -->
											<div class="ms_reward_mem_list">
												<strong>스타벅스 리워드 회원</strong> <!-- 스타벅스 리워드 수정  -->
												<div class="ms_reward_mem_list_each">
													<figure>
														<img alt="" src="../upload/common/img/util/efreq/21_cm_webguide_icon5.png"> <!-- 20220405 수정 -->
													</figure>
													<div class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">Step 1. 발급</strong>
														<div>스타벅스 리워드 회원에게는 <em>디지털 e-프리퀀시 바코드가 계정에 자동 발급됩니다.</em><br class="for_web"> 발급된 e-프리퀀시 바코드는 e-프리퀀시 이벤트 기간 중 확인 가능합니다.<br><br><a class="btn_guide_barcode_chk" href="status.do-1.html?promoSeq=172">회원 계정에 등록된 바코드 확인하기 &gt;</a></div>
													</div>
												</div>
												<div class="ms_reward_mem_list_each">
													<figure>
														<img alt="" src="../upload/common/img/util/efreq/22_summer_webguide_icon6.png"> <!-- 20220405 수정 -->
													</figure>
													<div class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">Step 2. 적립</strong>
														<div>매장에서 제조 음료 구매 시, e-프리퀀시 바코드 화면을 제시하거나  등록된 스타벅스 카드로 결제하여<br class="for_web"> e-스티커를 적립할 수 있습니다. 등록된 스타벅스 카드 사용 시에는 별과 e-스티커 모두 동시 적립됩니다.<br class="for_web"> (현금/신용카드로 결제 시에도 회원 계정에 등록된 스타벅스 카드를 제시하면 e-스티커 적립이 가능합니다.)<br><br><a class="btn_guide_sticker_chk" href="status.do-2.html??promoSeq=172">적립된 e-스티커 조회하기 &gt;</a></div>
													</div>
												</div>
												<div class="ms_reward_mem_list_each">
													<figure>
														<img alt="" src="../upload/common/img/util/efreq/22_summer_webguide_icon7.png"> <!-- 20220405 수정 -->
													</figure>
													<div class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">Step 3. 사용(예약/수령)</strong>
														<ul class="sticker_save_chk_list">
															<li>완성된 e-프리퀀시 증정품은 자동으로 증정되지 않습니다. 모든 증정품은 스타벅스 모바일 APP에서 증정품을 예약하고, 예약 수령을 선택한 일자에 지정한 매장을 방문해야만 수령 가능하며, 예약 확정 후 e-스티커가 최종 차감됩니다.</li>
															<li>모든 증정품은 매장 영업시간을 기준으로 증정됩니다. 매장별 영업시간이 상이하오니, 방문 전 모바일 APP을 통해 매장 영업시간을 반드시 확인해 주시기 바랍니다.</li>
															<li>증정품 예약 확인 바코드는 저장 후 자유롭게 양도 가능하며, 바코드 확인이 가능할 경우 예약된 증정품의 대리 수령 또한 가능합니다.<br>(단, 예약증 관리에 대해 당사는 책임지지 않으며, 관리 부주의로 인한 도난 및 분실 시 적립된 e-스티커는 보호되지 않습니다.)</li>
															<li>예약 수령일 기준, 증정품 미수령 시 페널티가 부과됩니다.</li>
														</ul>
													</div>
												</div>
											</div>
											<div class="ms_reward_mem_list">
												<strong>홈페이지(온라인) 회원</strong>
												<div class="ms_reward_mem_list_each">
													<figure>
														<img alt="" src="../upload/common/img/util/efreq/21_cm_webguide_icon8.png"> <!-- 20220405 수정 -->
													</figure>
													<div class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">Step 1. 발급</strong>
														<div>스타벅스 홈페이지 회원에게는 <em>디지털 e-프리퀀시 바코드가 계정에 자동 발급 됩니다.</em><br class="for_web"> 발급된 e-프리퀀시 바코드는 e-프리퀀시 이벤트 기간 중 확인 가능합니다.<br><br><a class="btn_guide_barcode_chk" href="status.do-1.html?promoSeq=172">회원 계정에 등록된 바코드 확인하기 &gt;</a></div>
													</div>
												</div>
												<div class="ms_reward_mem_list_each">
													<figure>
													...
													<div class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">Step 2. 적립</strong>
														<div>매장에서 제조 음료 구매 시 e-프리퀀시 바코드 화면을 제시하면 e-스티커를 적립할 수 있습니다.<br> 적립된 e-스티커 내역은 e-프리퀀시 이벤트 기간 중 웹 페이지/모바일 애플리케이션/영수증을 통해 확인할 수 있습니다.<br><br><a class="btn_guide_sticker_chk" href="status.do-1.html?promoSeq=172">적립된 e-스티커 조회하기 &gt;</a></div>
													</div>
												</div>
												<div class="ms_reward_mem_list_each">
													<figure>
													...
													<div class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">Step 3. 사용(예약/수령)</strong>
														<div>모든 증정품은 스타벅스 모바일 APP에서 증정품을 예약하고, 예약 수령을 선택한 일자에 지정한 매장을 방문해야만 수령 가능합니다. <br>증정품 예약은 스타벅스 모바일 APP에서만 가능합니다. (홈페이지 예약 불가능)</div><!-- 210827 수정 -->
													</div>
												</div>
											</div>
							...
							<div class="efreq_guide_type2">
								<dl class="efreq_guide_type_dl egt4">
									<dt>
										<strong>e-스티커 적립 현황 확인 방법</strong>
										<span class="arrow"><a href="javascript:void(0);"></a></span>
									</dt>
									<dd>
										<p>
											모든 e-스티커는 등록된 e-프리퀀시 바코드 스캔을 통해 자동으로 적립되며,<br class="for_web"> 홈페이지 및 스타벅스 리워드 회원의 경우, e-프리퀀시 바코드를 보유하고 있다면 누구에게라도<br class="for_web"> e-스티커를 선물할 수 있습니다.<br><br>
										</p>
										<!-- s::210827 수정 -->
										<div class="sticker_save_chk_wrap">
											<strong>e-스티커 적립 현황 확인하기</strong>
											<div class="sticker_save_chk_cont">
												<p>
													<strong class="sticker_save_chk_ttl">스타벅스 리워드  &amp; 홈페이지 회원</strong><br>
													로그인 후 My Starbucks &gt; My e-프리퀀시 &gt; 이용 현황 메뉴에서 진행 중인 e-프리퀀시 이벤트의 적립 현황 상세 내용을 확인할 수 있습니다.
												</p>
											</div>
										</div>
										<ul class="sticker_save_chk_list">
											<li>e-스티커의 적립 현황은 e-프리퀀시 이벤트 기간 중에만 확인 가능합니다.</li>
											<li>e-스티커는 자동으로 조합되어 부착된 상태만 확인 가능하며, 스스로 붙이거나 조합할 수 없습니다.</li>
											<li>e-스티커의 적립/사용/선물 등의 내역은 ‘e-스티커 히스토리’ 메뉴에서 확인할 수 있습니다.</li> <!-- 210902 수정 -->
											<li>e-스티커의 히스토리는 What’s New &gt; e-프리퀀시 &gt; 이용 현황(로그인 후 확인 가능, 비회원 이용 불가) 또는<br class="for_web"> 로그인 후 My Starbucks &gt; My e-프리퀀시 &gt; 이용 현황(회원 전용)에서 확인할 수 있습니다.</li>
										</ul>
										<!-- e::210827 수정 -->
									</dd>
								</dl>
							...
							<div class="efreq_guide_type1">
								<dl class="efreq_guide_type_dl egt5">
									<dt>
										<strong>완성 e-프리퀀시 증정품 교환 방법</strong>
										<span class="arrow"><a href="javascript:void(0);"></a></span>
									</dt>
									<dd>
										<p>
											<strong>e-프리퀀시 이벤트 기간 동안 e-스티커를 모두 모았다면, 기간 내 증정품으로 교환할 수 있습니다.<br> 
												e-프리퀀시 완성 조건 및 증정품은 e-프리퀀시 이벤트 별 상이하므로 이벤트 별 상세 내용이 별도 안내됩니다. <br>
												증정품은 한정 수량 제작되어 선착순으로 증정됩니다. 이벤트 기간 내  증정품 수량 소진 시 증정품은 대체될 수 있습니다.
											</strong><br>
											<div class="ms_reward_mem_list user">
												<strong>스타벅스 리워드  &amp; 홈페이지 회원</strong>
												<div class="ms_reward_mem_list_each">
													<!-- <figure><img alt="" src="//image.istarbucks.co.kr/common/img/util/efreq/icon_store_barcode.png"></figure> -->
													<div class="ml0">
														<ul class="sticker_save_chk_list">
															<li>완성된 e-프리퀀시 증정품은 자동으로 증정되지 않습니다. 모든 증정품은 스타벅스 모바일 APP에서 증정품을 예약하고, 예약 수령을 선택한 일자에 지정한 매장을 방문해야만 수령 가능합니다.</li>
															<li>모든 증정품은 매장 영업시간을 기준으로 증정됩니다. 매장별 영업시간이 상이하오니, 방문 전 모바일 APP을 통해 매장 영업시간을 반드시 확인해 주시기 바랍니다.</li>
															<li>증정품 예약 확인 바코드는 저장 후 자유롭게 양도 가능하며, 바코드 확인이 가능할 경우 예약된 증정품의 대리 수령 또한 가능합니다. (단, 예약증 관리에 대해 당사는 책임지지 않으며, 관리 부주의로 인한 도난 및 분실 시 적립된 e-스티커는 보호되지 않습니다.)</li>															
															<li>예약 수령일 기준, 증정품 미수령 시 페널티가 부과됩니다.</li>
															<li>완성된 e-프리퀀시는 해당 e-프리퀀시 기간 중에만 증정품으로 교환이 가능합니다.</li>
															<li>e-프리퀀시 이벤트 종료 후에는 증정품 교환이 불가하며, 완성된 e-프리퀀시, 적립된 e-스티커, e-프리퀀시 증정품 교환 e-쿠폰 모두 소멸됩니다.</li>
															<li>스타벅스 e-프리퀀시 이벤트 기간 중 회원 탈퇴 시, 적립된 e-스티커는 모두 소멸되며 재가입 시 소멸된 e-스티커는 복원되지 않습니다.</li>
															<li>스타벅스 리워드 회원 및 홈페이지 회원은 스타벅스 홈페이지 로그인 후 My Starbucks &gt; My e-프리퀀시 메뉴 또는 휴대폰에서 웹 페이지(http://www.starbucks.co.kr/) 접속, 모바일 APP(다운로드 : http://www.starbucks.co.kr/util/app_tip.do)을 통해서도 e-프리퀀시 적립이 가능합니다.</li>
															<li>본 안내사항은 2022년 5월 10일 런칭한 '2022 서머 e-프리퀀시 이벤트'에 한하며, 향후 이벤트 운영 정책이 변경될 수 있습니다.</li> <!-- 220504 수정 -->															
														</ul>	
													</div>
												</div>
											</div>
										
										<div class="app_btn_appDown">
											<ul>
												<li><a href="https://play.google.com/store/apps/details?id=com.starbucks.co" target="_blank"><img src="../common/img/util/efreq/btn_down_app1.png" alt=""></a></li>
												<li><a href="https://itunes.apple.com/kr/app/seutabeogseukadeu/id466682252?mt=8" target="_blank"><img src="../common/img/util/efreq/btn_down_app2.png" alt=""></a></li>
							...
							<div class="efreq_guide_type2">
								<dl class="efreq_guide_type_dl egt6">
									<dt>
										<strong>e-스티커 및  e-프리퀀시 증정품 선물 방법</strong> <!-- 210902 수정 -->
										<span class="arrow"><a href="javascript:void(0);"></a></span>
									</dt>
									<dd>
										<p>
											<strong>e-프리퀀시 이벤트 참여 중 친구나 지인들에게 e-스티커 또는 증정품을 선물할 수 있습니다.</strong><br>
											<!-- <i class="icon_giftbox"></i> -->
											<div class="ms_reward_mem_list">
												<strong>e-스티커 선물하기</strong>
												<div class="ms_reward_mem_list_each">
													<figure>
														<img alt="" src="../upload/common/img/util/efreq/22_summer_webguide_icon9.png"> <!-- 2204045 수정 -->
													</figure>
													<p class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">스타벅스 리워드 회원 &amp; 홈페이지 회원</strong>
														보유한 e-스티커를 지인, 친구, 동료에게 선물할 수 있습니다.<br><br><a class="btn_guide_barcode_chk" href="gift.do.html?promoSeq=172">e-스티커 보내기(선물) 바로가기 &gt;</a>
													</p>
												</div>
											</div>
											<div class="ms_reward_mem_list">
												<strong>e-쿠폰 선물하기</strong>
												<div class="ms_reward_mem_list_each">
													<figure>
														<!-- s::210901 추가,수정 -->
														<img alt="" src="../upload/common/img/util/efreq/21_cm_webguide_icon10.png"> <!-- 2204045 수정 -->
														<!-- e::210901 추가,수정 -->
													</figure>
													<p class="ms_reward_mem_list_txt">
														<strong class="ms_reward_mem_list_ttl">스타벅스 리워드 회원 &amp; 홈페이지 회원</strong>
														e-프리퀀시 이용현황 화면 하단 ‘e-스티커 발행하기’ 버튼을 통해 e-쿠폰으로 발행한 후, MMS로 지인에게 선물할 수 있습니다. <!-- 210902 수정 -->
													</p>
												</div>
											</div>
							...
							<div class="efreq_guide_type1">
								<dl class="efreq_guide_type_dl egt5">
									<dt>
										<strong>기타 유의사항</strong> <!-- 210902 수정 -->
										<span class="arrow"><a href="javascript:void(0);"></a></span>
									</dt>
									<dd>
										<div class="ms_reward_mem_list user mt0">
											<strong>무기명 카드 이용 고객</strong>
											<div class="ms_reward_mem_list_each">
												<!-- <figure><img alt="" src="//image.istarbucks.co.kr/common/img/util/efreq/icon_store_barcode.png"></figure> -->
												<div class="ml0">										
													<ul class="sticker_save_chk_list">
													    <li>무기명 카드 이용 고객은 결제한 무기명 카드에 e-스티커가 적립되며, 영수증을 통해 e-스티커 적립 내역을 확인할 수 있습니다. 무기명 카드를 스타벅스 리워드 회원 계정에 등록하시면 적립된 e-스티커는 자동 이전됩니다.</li>
													    <li>무기명 카드를 통한 증정품 예약, 교환, e-스티커 선물하기 및 e-스티커 합산은 불가하며, 스타벅스 리워드 회원이 되면 가능합니다.</li>
													    <li>무기명 카드의 도난 및 분실 등에 대해 당사는 책임지지 않으며, 해당 상황의 경우 카드에 적립된 e-스티커는 보호되지 않습니다.</li>
													</ul>
												</div>
											</div>
										</div>
										<div class="ms_reward_mem_list user">
											<strong>비회원 Guest 인증 고객</strong>
											<div class="ms_reward_mem_list_each">
												<!-- <figure><img alt="" src="//image.istarbucks.co.kr/common/img/util/efreq/icon_store_barcode.png"></figure> -->
												<div class="ml0">									
													<ul class="sticker_save_chk_list">
														<li>비회원 사이렌 오더를 이용하는 고객 중 GUEST 인증을 통해 서비스 이용 시, e-프리퀀시 이벤트 참여가 가능하며 적립 내역은 전자 영수증을 통해 확인 가능합니다.</li>
														<li>GUEST 인증을 통해 사이렌 오더를 이용하는 고객이 동일한 개인 정보로 회원 가입 시 e-스티커는 자동으로 이전됩니다.</li>
														<li>증정품 예약, 교환, e-스티커 선물하기가 불가하며, 스타벅스 리워드 회원이 되면 가능합니다.</li>
													</ul>
												</div>
											</div>
										</div>
										<div class="ms_reward_mem_list user">
											<strong>e-프리퀀시 유의사항</strong> <!-- 210902 수정 -->
											<div class="ms_reward_mem_list_each">
												<!-- <figure><img alt="" src="//image.istarbucks.co.kr/common/img/util/efreq/icon_store_barcode.png"></figure> -->
												<div class="ml0">									
													<ul class="sticker_save_chk_list">														
														<li>e-프리퀀시 이벤트 기간 중 미션 음료 구매 시 미션 음료 e-스티커가, 일반 음료 구매 시 일반 음료 e-스티커가 적립됩니다.</li> <!-- 210827 수정 -->
														<li>e-스티커는 이벤트 기간 중 구매한 제조 음료에 한해 1잔당 1장 적립됩니다. (적립 제외 품목 : 생수, 요거트 병음료, 무료 음료를 포함한 쿠폰 사용 음료, e-Gift Item 구매 등)</li>
														<li>e-스티커는 결제 시 즉시 적립만 가능합니다.</li>
														<li>네이버 스마트 주문 시 e-스티커 적립은 불가합니다.</li>
														<li>삼성/신한 카드 오더의 경우 스타벅스 계정 로그인이 진행된 경우에만 e-스티커 적립이 가능합니다.</li>
														<li>2022년 7월 19일부터 사용하지 않은 완성된 e-프리퀀시, 적립된 e-스티커, e-프리퀀시 증정품 교환 e-쿠폰, 예약 확인증은 모두 소멸됩니다. 반드시 이벤트 기간 내 증정품을 예약하고 예약 수령을 선택한 일자에 지정한 매장에서 증정품을 수령하시기 바랍니다.</li> <!-- 220504 수정 -->
														<li>증정품은 한정 수량 제작되어 선착순으로 증정됩니다. 준비 수량 소진 시, 증정품은 대체될 수 있으며 자동으로 교환되지 않습니다. 반드시 이벤트 기간 내 대체 증정품으로 교환하시기 바랍니다.</li>
														<li>스타벅스 리워드 회원, 홈페이지 회원 간 e-스티커 선물하기가 가능하며, 선물 전송 이후 회수는 불가합니다.</li> <!-- 210902 수정-->
														<li>타인의 e-스티커를 무단으로 적립할 경우, 회원 서비스 제한 및 관계 법령에 따라 처벌될 수 있습니다.</li>
														<li>자세한 사항은 홈페이지 회원 약관 또는 게시판을 참고하시기 바랍니다.</li>
													</ul>
												</div>
											</div>
										</div>
...
<nav class="ms_nav" id="msRnb">					
	<ul>
		...
		<li class="msRnb_btn"><a href="../my/calendar.do.html" required="login">My 캘린더</a></li>
		...
		<li>
			<a href="../my/vocList.do.html" required="login">My 고객의 소리</a>
		</li>
		<!-- <li class="msRnb_btn"><a href="/my/order_status_list.do" required="login">케익 주문 현황</a></li> -->
		<li class="msRnb_btn"><a href="../my/eReceiptList.do.html" required="login">전자영수증</a></li>
		<li class="msRnb_btn"><a href="javascript:void(0);" onclick="fn_rewardTumblerMsrCheck();">개인컵 리워드 설정</a></li>
		<li class="msRnb_btn"><a href="../login/login.do.html" required="login">My DT Pass</a></li>
		<li>
...
// 					});
			...
			<script>
	            $(document).ready(function(){
	                $(".efreq_guide_type_dl dt a").bind("click", function(){
