		...
		<div id="topWrap">
			...
			<div class="layer_floating">
					...
					<div class="badge_cont1">
						<a href="whats_new/newsView.do.html?seq=4514">
					...
					<div class="badge_cont2">
						<a href="https://www.starbucks.co.kr/plcc/promotionView.do?eventCode=STH02">
...
<div class="main-visual_wrap">
    <div class="main-visual_inner">
        ...
        <div class="btn_slogan">
            <a href="whats_new/campaign_view.do.html?pro_seq=1992">자세히 보기</a>
        </div>
    </div>
</div>
				...
				<div class="new-rewards_inner">
					...
					<div class="new-rewards_conts">
						...
						<div class="gift-cont">
							...
							<div class="btn_egift">
								<a href="msr/sceGift/gift_step1.do.html">e-Gift Card 선물하기</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="line_msr_wrap msr_new"><!-- 20200120 class="msr_new" 추가 -->
					...
					<div class="user_level">
						...
						<div class="msr_info_area">
							...
							<p class="btn_reward_level"><a href="my/reward.do.html" title="마이 리워드" class="btn_reward">리워드 및 혜택</a></p>
						</div>
					...
					<div class="msr_lead" style="display:none;">
						<!-- s::20200120 페이스북 프로필 기능 삭제 관련 메인 수정 -->
						<a href="msr/msreward/level_benefit.do.html" title="회원 등급별 혜택">
						<p class="icon_msr_cup"></p>
						<div class="msr_info_area">
					...
					<div class="sb_card_regi">
						<!-- s::20200120 페이스북 프로필 기능 삭제 관련 메인 수정 -->
						<a href="my/mycard_info_input.do.html"><!-- 접근성_20171106 링크 href 변경 -->
						<p class="icon_add_card" onclick="location.href = '/my/mycard_info_input.do';"><img alt="카드등록 아이콘" src="common/img/common/icon_add_card.png"></p>
						<!-- 등록된 카드가 없는 경우 -->
						<p class="sb_card_regi_txt"><strong>스타벅스 카드 등록</strong><br>등록된 카드가 없습니다.<br>새로운 카드를 등록하세요.</p>
						</a>
						<a class="btn_main_card_regi" href="my/mycard_info_input.do.html" required="login">카드등록</a>
						<!-- 등록된 카드가 없는 경우 end -->
						<!-- e::20200120 페이스북 프로필 기능 삭제 관련 메인 수정 -->
					</div>
					<!-- 일반회원 end -->
    ...
    <div class="main-bean_inner">
        ...
        <div class="bean_txt_box" style="opacity: 1; right: 17.4988%;">
            ...
            <div class="btn_bean_detail">
                <a href="coffee/product_view.do.html?PRODUCT_CD=11104968">자세히 보기</a>
            </div> 		
        </div>
    </div>
</section>
    ...
    <div class="reserve_inner">
        ...
        <div class="reserve_detail-btn_wrap">					
            <div class="reserve_detail-btn">
                <a href="whats_new/newsView.do-1.html?seq=4496">자세히 보기</a>
            </div>
        </div>
    </div>
</section>
...
<section id="favWrap" class="winter_fav_bg">
    <div class="wrap_inner">
        ...
        <div class="btn_fav_prod"><a href="menu/index.do.html">자세히 보기</a></div>
    </div>
</section>
<!-- //e::Pick Your Favorite(20220406) -->
			...
			<section id="menuWrap">
				<div class="wrap_inner">
					...
					<div class="menu_btn"><a href="menu/index.do.html">자세히 보기</a></div>
			...
			<section class="reserve_magazine_wrap">
                <div class="reserve_inner">
                    ...
                    <div class="reserve_detail-btn_wrap">					
                        <div class="reserve_detail-btn">
                            <a href="coffee/reserve_magazine_list.do.html">자세히 보기</a>
                        </div>
                    </div>
                </div>
            </section>
			...
			<section id="storeWrap">
				<div class="wrap_inner">
					...
					<div class="store_btn"><a href="store/store_map.do.html">매장 찾기</a></div>
				</div>
			</section>
			<!-- 매장 end -->
