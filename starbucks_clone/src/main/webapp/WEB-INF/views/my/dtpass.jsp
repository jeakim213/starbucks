				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="My DT Pass" src="/common/img/util/dt_ttl.png"></h4> <!-- 20180413 수정 : 이미지 및 문구 -->
							<ul class="smap">
								...
								<li><img class="arrow" src="//image.istarbucks.co.kr/common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
								<li><a href="/edt/expressDtList.do">My DT Pass</a></li>
							</ul>
						</div>
					</div>
				</header>
									...
									<section class="dtInfoWrap">
										...
										<section class="dpAreaaWrap">
											...
											<div class="dt_area_check">
												<!-- 고객 자동차 등록번호 수집 이용동의 -->
												<div class="privacy_cont mCustomScrollbar _mCS_1 mCS_no_scrollbar" id="privacy_car_text"><div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0"><div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
													<div class="privacy_cont mCustomScrollbar _mCS_2"><div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0"><div id="mCSB_2_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr"> 
...
</div><div id="mCSB_2_scrollbar_vertical" class="mCSB_scrollTools mCSB_2_scrollbar mCS-light mCSB_scrollTools_vertical" style="display: block;"><div class="mCSB_draggerContainer"><div id="mCSB_2_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 33px; display: block; height: 44px; max-height: 110px;" oncontextmenu="return false;"><div class="mCSB_dragger_bar" style="line-height: 33px;"></div></div><div class="mCSB_draggerRail"></div></div></div></div></div>
												</div><div id="mCSB_1_scrollbar_vertical" class="mCSB_scrollTools mCSB_1_scrollbar mCS-light mCSB_scrollTools_vertical" style="display: none;"><div class="mCSB_draggerContainer"><div id="mCSB_1_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 33px; height: 0px; top: 0px;" oncontextmenu="return false;"><div class="mCSB_dragger_bar" style="line-height: 33px;"></div></div><div class="mCSB_draggerRail"></div></div></div></div></div>
												<!-- //고객 자동차 등록번호 수집 이용동의 -->
											</div>
										</section>
										<!-- //20181126 추가 -->
												...
												<div class="dtRegiTblWrap dtCon1 mdpCarInfo carAdd">
													<section class="dtRegiTbl">
														<dl class="dtRegiDl">
															...
															<dd>
																<input class="card_regi_input2" name="carNoMask" data-edityn="N" placeholder="약관에 동의해 주세요." type="text" disabled="disabled">
													...
													<div class="dtBtnWrap">
														...
														<a onclick="javascript:fn_deletePop(this);" class="dtBtn3 deleteBtn1 disable">삭제</a>
														<div class="clear"></div>
													</div>
												</div>
												
											
											<div class="dtBtnWrap carAdd">
												<a onclick="javascript:fn_addCarInfo(this);" class="dtBtn1 disable" style=""> 차량번호 추가등록</a> <!--등록차량 2 노출시 숨김처리-->
												<div class="clear"></div>
											</div>
										</div>
										<!-- e::차량번호 입력영역 -->
	
										<div class="dtGuideTxt">
											<ul>
												<li>· 차량번호 입력 후 ‘중복 확인’ 버튼을 선택해 주세요.</li>
												<li>· 차량은 총 2대까지 등록이 가능합니다.</li>
											</ul>
										</div>
	
										<div class="dtBtnWrap2">
											<a href="javascript:void(0);" id="save" class="dtBtn4">저장</a>
											<a href="javascript:fn_mdpEditCancel();" id="cancel" class="dtBtn5">취소</a>
											<div class="clear"></div>
										</div>
										
										<!-- s::20190405 결제수단 관리 추가영역 -->
										<div class="dtRegiTblWrap dtCon1 dtCardArea" style="display: none;">
											<section class="dtRegiTbl">
												<dl class="dtRegiDl">
													<dt><label>결제수단 관리</label></dt>
													<dd id="cardContens">
														<!-- 등록된 카드가 없을 경우 -->
														...
														<!-- 등록된 카드가 있을 경우-->
															...
															<div class="dtRegiCard">
																<ul>
																	
																		<li><!-- 주결제 수단일 경우 li class="cardChecked" -->
											...
											<div class="dtInfoTxt">
												<p>*스타벅스 어플리케이션을 설치하시면, 신용/체크 카드로 My DT Pass 이용이 가능합니다.</p><!--190423 jaeseok 수정: 텍스트-->
											</div>
										</div>
										<!-- e::20190405 결제수단 관리 추가영역 -->
...
// 					});
		...
		<!-- MY DT PASS 팝업 -->
		<div class="dtPop" id="commonPop" style="display: none; margin-top: -51px;">
			<div class="head">
				<p class="tt"></p>
				<p id="dtPopCommonCloseBtn" class="close dtPopClose"><a href="javascript:void(0)"></a></p> <!-- 팝업 닫힘 클래스 : dtPopClose -->
			</div>  
		...
		<div class="dtPop ownerPop" id="ownerPop" style="display: none; margin-top: -51px;">
			<div class="head">
			...
			<div class="dtPopInner">
				<div class="dpAreaaWrap">
					<div class="dtAgreeTitle">
						<p>이름 확인 후 ‘인증’ 버튼을 클릭해 주세요.</p>
					</div>
				</div>
				<div class="ownerNameArea">
					<input class="owner_regi_input" name="ownerName" type="text" value="조*은" maxlength="30" disabled="disabled">
				</div>
			</div>
	
			<div class="dtPopBtn">
				<a href="javascript:void(0)" class="dtPopBtn1 dtPopClose">인증</a><!-- 20190614 비활성화 class="disableBtn" 추가 -->
		...
		var carDelHtml		= "";
			...
			$(document).ready(function() {
				...
				fn_carNoAddBtnActive(carClauseFlag, $mdpCarInfo);
				
				
				carTagHtml = $(".mdpCarInfo").eq(0).clone().wrapAll("<div/>").parent()
							.find("input[name='carNoMask']").prop("disabled", false).attr("disabled", false).end()
							.find("input[name='carNoMask']").attr("placeholder", "12가1234").end()
							.find("input[name='carNoMask']").attr("data-edityn", "Y").end()
							.find("input[name='carNoMask']").attr("value", "").end()
							.find("input[name='carNoMask']").removeAttr("data-seq").end()
				...
				var carInfoEditFlag	= false;
				var carNoEmpty		= false;
				var notOverLabCheck	= false;
				var title			= "";
				var message			= "";
				var idx				= "";
				
				
				if(allCancelFlag || $(".mdpCarInfo").length == 0) {
					title	= "저장 확인";
					message	= "<p>입력하신 사항이 틀림 없으신가요?</p>";					
					fn_showMessage("confrm", title, message, "disagree");
					return false;
				}
				
				$("input[name='carNoMask']").each(function() {
					
					if($(this).attr("data-edityn") == "Y") {
						carInfoEditFlag = true;
					}
					
					
					if($(this).val().length == 0) {
						carNoEmpty = true;
						idx = $("input[name='carNoMask']").index(this);
					}
					
					
					if(!$(this).next().hasClass("disable") || $(this).val().length < 7){
						notOverLabCheck = true;
					}
				});
				
				
				if($.parseHTML(carDelHtml) != null) {
					carInfoEditFlag = true;
				}
				
				
				if(!$('#dt_agree_yes').prop("checked")) {
					title	= "약관 동의 확인";
					message	= "<p>약관 동의 및 차량번호를 입력하세요.</p>";					
					fn_showMessage("alrt", title, message, "alert");
					$("#dt_agree_yes").focus();
					return false;
				}
				...
				if(carNoEmpty) {
					title	= "차량번호 입력 확인";
					message	= "차량번호를 입력하세요.";
					fn_showMessage("alrt", title, message, "focus", idx);
					return false;
				}
				...
				if(notOverLabCheck) {
					title	= "차량번호 중복 확인 필요";
					message	= "<p>입력한 차량정보를 저장 하시려면<br />"
							+ "차량번호 중복확인을 진행 해야 합니다.<br />"
							+ "입력사항 확인 후, ‘중복확인’ 버튼을 선택<br />해주세요.</p>";					
					fn_showMessage("alrt", title, message, "alert");
					return false;
				}
				...
				title	= "저장 확인";
				message	= "<p>입력하신 사항이 틀림 없으신가요?</p>";					
				fn_showMessage("confrm", title, message, "save");
			});
			
			
			function fn_mdpInfoSave() {
				var agreeYn 	= "N";
				var carNoDelArr	= "";
				
				
				var carNoArr = $("input[name='carNoMask']").not("[data-edityn='N']").map( function() {
					var carNo		= $(this).val();
					var carSeq		= $(this).attr("data-seq") == null ? "N" : $(this).attr("data-seq");
					var ownerName 	= $(this).attr("data-owner-name") == null ? "N" : $(this).attr("data-owner-name");
					
					return carNo + ":" + carSeq + ":" + ownerName;
				}).get().join(",");
				
				
				if($.parseHTML(carDelHtml) != null) {
					carNoDelArr = $.map($.parseHTML(carDelHtml), function(el, i) {
						return $(el).attr("data-seq");
					}).join(",");
				}
				
				var param = { "carNoArr" : carNoArr, "carNoDelArr" : carNoDelArr, "agreeYn" : agreeYn };
				
				__ajaxCall("/edt/mdpCarInfoSaveAjax.do", param, true, "json", "post"
					, function (data) {
						...
						if(resultCode == "000") {
							title	= "저장 완료";
							message = "<p>입력한 정보가 저장되었습니다.</p>"
							
							fn_showMessage("alrt", title, message, "reload");
						
						
						} else if(resultCode == "9999") {
							title	= "입력시간 초과";
							message = "<p>입력시간이 초과되어 설정화면으로 돌아갑니다.<br/>다시 선택하여 입력해주세요.</p>";					
							fn_showMessage("alrt", title, message, "login");
						
						} else {
							title	= "기타 오류";
							message = "<p>" + resultMessage + "</p>";
							fn_showMessage("alrt", title, message, "alert");
						}
					}
			...
			function fn_focusCarNo(idx) {
				$("input[name='carNoMask']").eq(idx).focus();
			}
			
			
			function fn_carNoAddBtnActive(carClauseFlag, $mdpCarInfo) {
				if (carClauseFlag && $mdpCarInfo.length == 2) {
					$(".dtBtn1").addClass("disable").hide();
					
				} else if (carClauseFlag && $mdpCarInfo.length < 2) {
					$(".dtBtn1").removeClass("disable").show();
					
				} else {
					if ($mdpCarInfo.length == 2) {
						$(".dtBtn1").addClass("disable").hide();
						
					} else {
						$(".dtBtn1").addClass("disable").show();
					}
				}
			}
			
			
			function fn_addCarInfo(el) {
				if(!$(el).hasClass("disable")) {
					var $carTags = $(".mdpCarInfo");
					
					if ($carTags.length == 0) {
						$("#mdpCarInfoWrap").prepend(carTagHtml);
					} else {
						$carTags.after(carTagHtml);
					}
			...
			function fn_showMessage(msgType, title, message, gubun, idx){
				...
				if(msgType == "alrt"){
					if(gubun == "alert"){
						btnStr 	= "<a class='dtPopBtn2 dtPopClose'>확인</a>";
					} else if(gubun == "focus"){
						btnStr 	= "<a href='javascript:fn_focusCarNo(\"" + idx + "\");' class='dtPopBtn2 dtPopClose'>확인</a>";
					} else if(gubun == 'login'){
						btnStr 	= "<a href='/login/login.do?redirect_url=" + encodeURIComponent("/edt/expressDtList.do") + "'"
								+ "class='dtPopBtn2 dtPopClose'>확인</a>";
					} else if(gubun == "reload"){
						btnStr 	= "<a href='/edt/expressDtList.do' class='dtPopBtn2 dtPopClose'>확인</a>";
					}
					
				} else if(msgType == "confrm"){
					if(gubun == "auth"){
						btnStr 	= "<a href='javascript:fn_ownerAuthPop(\"" + idx + "\");' class='dtPopBtn1 dtPopClose'>인증</a>"
								+ " <a href='javascript:void(0);' class='dtPopBtn2 dtPopClose'>취소</a>";
					} else if(gubun == "agreeCancel"){
						btnStr 	= "<a href='javascript:fn_agreeCancel();' class='dtPopBtn1 dtPopClose'>확인</a>"
								+ " <a href='javascript:void(0);' class='dtPopBtn2 dtPopClose'>취소</a>";
					} else if(gubun == "cancel"){
						btnStr 	= "<a href='/edt/expressDtList.do' class='dtPopBtn1'>확인</a>"
								+ " <a href='javascript:void(0);' class='dtPopBtn2 dtPopClose'>취소</a>";
					} else if(gubun == "save"){
						btnStr 	= "<a href='javascript:fn_mdpInfoSave();' class='dtPopBtn1'>확인</a>"
								+ " <a href='javascript:void(0);' class='dtPopBtn2 dtPopClose'>취소</a>";
					} else if(gubun == "delete"){
						btnStr 	= "<a href='javascript:fn_mdpCarNoDelete(\""+ idx +"\");' class='dtPopBtn1'>확인</a>"
								+ " <a href='javascript:void(0);' class='dtPopBtn2 dtPopClose'>취소</a>";
					} else if(gubun == "edit"){
						btnStr 	= "<a href='javascript:fn_mdpCarNoEdit(\""+ idx +"\");' class='dtPopBtn1 dtPopClose'>확인</a>"
								+ " <a href='javascript:void(0);' class='dtPopBtn2 dtPopClose'>취소</a>";
					} else if(gubun == "disagree"){
						btnStr 	= "<a href='javascript:fn_mdpDisagree();' class='dtPopBtn1'>확인</a>"
								+ " <a href='javascript:void(0);' class='dtPopBtn2 dtPopClose'>취소</a>";
					}
				}
			...
			function fn_carNoOverLab(obj){
				if(!$(obj).hasClass("disable")){
					...
					if(pattern.test(carNo)){
						var tit = "차량번호 오류";
						var msg = "<p>사용할 수 없는 차량 번호입니다.</p>";
						fn_showMessage('alrt', tit, msg, 'alert');
						$(obj).prev().val("");
			...
			function fn_carNoOverlapCheck(obj, carNo){
				...
				__ajaxCall("/edt/isExistCarNoWeb.do", param, true, "json", "post"
					, function (data) {
						...
						if(resultCode == "000") {
							title	= "차량번호 등록 가능 안내";
							message = "<p>" + carNo + "은(는) 등록 가능합니다.</p>"
									+ "<span>차량번호를 잘못 입력할 경우,<br />"
									+ "다른 고객의 차량으로 결제가 될 수 있습니다.<br />"
									+ "차량번호를 올바르게 입력했는지 확인 후 이용하세요.</span>";
							...
							title	= "차량번호 중복 오류";
							message = "<p>이미 입력된 고객님 차량 정보가 있습니다.<br />"
									+ "차량번호를 다시 확인해 주세요.</p>";
							fn_showMessage("alrt", title, message, "alert");
							$(obj).prev().val("");
			...
			function fn_ownerAuth(idx, ownerName){
				...
				__ajaxCall("/edt/mdpOwnerAuthAjax.do", param, true, "json", "post"
					, function (data) {
						...
						if(resultCode == "000") {
							title	= "차량번호 등록";
							message = "<p>차량 소유주 인증이 완료 되었습니다.</p>"
									+ "<span>My DT Pass화면의 ‘저장’ 버튼을<br />"
									+ "선택해야 수정사항이 반영됩니다.</span>";
							...
							title	= "차량 소유주 미 확인 안내";
							message = "<p>입력한 차량번호는 고객님의 소유가<br/>"
									+ "아닌 것으로 확인됩니다.</p>"
									+ "<span>입력한 차량이 고객님의 소유일 경우<br />"
									+ "추가 확인을 위해 고객센터로 문의하시기 바랍니다.</span>"
									+ "<span>고객 센터 : 1522-3232</span>";					
							fn_showMessage("alrt", title, message, "alert");
			...
			function fn_mdpCarNoDelete(idx) {
				
				carDelHtml += $("input[name='carNoMask']").eq(idx).clone().wrapAll("<div/>").parent().html();
				
				$(".mdpCarInfo").eq(idx).remove();
				
				
				var $mdpCarInfo = $(".mdpCarInfo");
				fn_carNoAddBtnActive(carClauseFlag, $mdpCarInfo);
				
				var title	= "차량번호 삭제 완료";
				var message	= "<p>차량번호가 삭제 되었습니다.</p>"
							+ "<span>My DT Pass 화면의 ‘저장’ 버튼을 선택해야 수정사항이 반영됩니다.</span>";
				
				fn_showMessage("alrt", title, message, "alert");
			}
			
			
			function fn_mdpCarNoEdit(idx) {
				$("input[name='carNoMask']").eq(idx)
					.prop("disabled", false)
					.attr("disabled", false)
					.attr("data-edityn", "Y")
					.val("")
					.focus();
				$("a.dtBtn2").eq(idx).addClass("disable").hide();
			}
			
			
			function fn_mdpEditCancel() {
				var title	= "차량 등록 취소 안내";
				var message	= "<p>취소 하시겠습니까?</p>";
				
				fn_showMessage("confrm", title, message, "cancel");
			}
			
			
			function fn_editPop(el) {
				if(!$(el).hasClass("disable")) {
					var idx = $(el).parent().parent().index();
					var title	= "차량번호 수정 안내";
					var message	= "<p>입력한 내용이 초기화됩니다.<br />"
								+ "차량번호 수정을 진행하시겠어요?</p>";
					
					fn_showMessage("confrm", title, message, "edit", idx);
				}
			}
			
			
			function fn_deletePop(el) {
				if(!$(el).hasClass("disable")) {
					var idx = $(el).parent().parent().index();
					var title	= "차량번호 삭제 확인";
					var message	= "<p>선택한 항목을 삭제하시겠어요?</p>";
					
					fn_showMessage("confrm", title, message, "delete", idx);
				}
			}
			
			
			function fn_agreeCancel() {
				$("#dt_agree_yes").prop("checked", false);
				$("#dt_agree_yes").prop("disabled", true).attr("disabled", true);
				$(".mdpCarInfo").remove();
				$("#mdpCarInfoWrap").prepend(carTagHtml);
				$(".dtBtn1").addClass("disable").show();
				$(".card_regi_input2").prop("disabled", true).attr("disabled", true);
				$("#cardContens").empty().html("<p>등록된 결제수단이 없습니다.</p>");
				
				allCancelFlag = true;
			}
			
			
			function fn_mdpDisagree() {
				var param = {};
				
				__ajaxCall("/edt/mdpWithdrawalAjax.do", param, true, "json", "post"
					, function (data) {
						var resultCode 		= data.result_code;
						var resultMessage	= data.result_message;
						var title 			= "";
