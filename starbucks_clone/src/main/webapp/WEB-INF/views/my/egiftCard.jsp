			...
			<div id="top_MSR" class="eFreqTop"><!-- 20170510 수정 : 클래스 eFreqTop 추가 -->
				<div class="top_msr_wrap" style="display:none;">
					...
					<div class="msr_card_info w_card_pic">
						...
						<!-- 150924 - 다른카드보기버튼 추가 -->
						<p class="btn_other_more"><a href="mycard_index.do.html">다른 카드 보기</a></p>
				...
				<div class="top_msr_nologin">
					...
					<div class="top_msr_nologin_r">
						...
						<p class="btn_sbcard_regi">
							<a href="mycard_info_input.do.html">카드 등록</a>
						</p>
					</div>
					<!-- 160628 수정 -->
			...
			<div class="tablet_gnb_wrap">
				...
				<nav class="tablet_gnb_sep">
					<ul>
						...
						<li class="tablet_gnb02"><a href="index.do.html" required="login"><span class="a11y">마이스타벅스</span></a><!-- 접근성_20171106 span추가 --></li>
					...
					<nav class="mob_gnb_menus">
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="reward.do.html" required="login">리워드 및 혜택</a></li>
									<li><a href="reward_star_history.do.html" required="login">별 히스토리</a></li>
								</ul>
							</li>
							<li>
								<a role="button" href="javascript:void(0);">My 스타벅스 카드<span class="mob_gnb_arrow_down"></span></a><!-- 접근성_20171106 role 추가 -->
								<ul>
									<li><a href="mycard_index.do.html" required="login">보유 카드</a></li>
									<li><a href="mycard_info_input.do.html" required="login">카드 등록</a></li>
									<li><a href="mycard_charge.do.html" required="login">카드 충전</a></li>
									<li><a href="mycard_lost.do.html" required="login">분실신고/잔액이전</a></li>
								</ul>
							</li>
							<li>
								...
								<ul>
									...
									<li><a href="egiftCard.do.html" required="login">선물 내역</a></li>
									<li><a href="egiftCard_shopping_bag.do.html" required="login">장바구니 내역</a></li>
								</ul>
							</li>
							<li>
							...
							<li><a href="calendar.do.html" required="login">My 캘린더</a></li>
							...
							<li>
								...
								<ul>
									...
									<li><a href="vocList.do.html" required="login">My 고객의 소리</a></li>
							<li><a href="eReceiptList.do.html" required="login">전자영수증</a></li>
...
<ul>
	...
	<li class="util_nav02"><a href="index.do.html" required="login">My Starbucks</a></li>
