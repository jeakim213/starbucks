					...
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							...
							<ul class="smap">
								...
								<li><img class="arrow" src="//image.istarbucks.co.kr/common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
								<li><a href="/starbucks/my/mycard_index">My 스타벅스 카드</a></li>
								<li><img class="arrow" src="//image.istarbucks.co.kr/common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
								<!-- 160609 텍스트 수정 -->
								<li><a href="/starbucks/my/mycard_info_input">카드 등록</a></li>
								<!-- 160609 텍스트 수정 end -->
							</ul>
						</div>
					</div>
								...
								<section class="my_card_info_wrap">
									...
									<div class="my_card_info_inner">
										...
										<ul class="card_regi_btns">
											<li><button class="btn123" onclick="check()" style="border-radius:3px; color:#fff;display:block; font-size:12px;font-weight:bold;height:28px;line-height:28px; text-align:center; width:84px; background:#e2c383; border:1px solid #bb9f65 ;">결제하기</button></li>
