...
<script src="https://connect.facebook.net/ko_KR/sdk.js?hash=cd3aae011137442836396fdaaee1883b" async="" crossorigin="anonymous"></script><script id="facebook-jssdk" src="//connect.facebook.net/ko_KR/sdk.js"></script><script async="" src="//www.google-analytics.com/analytics.js"></script><script>
			...
			<div id="top_MSR" class="eFreqTop"><!-- 20170510 수정 : 클래스 eFreqTop 추가 -->
				<div class="top_msr_wrap" style="">
					...
					<div class="msr_card_zone m_card_pic">
						...
						<div class="mycard_one" style="transform: rotateY(325.468deg);">
							<!-- <div class="front"> -->
						...
						<ul>
							...
							<li style="display: none;">
								...
								<ul>
									...
									<li style="display: none;"><a href="/my/mycard_info_input.do">등록 및 조회</a></li>
                        ...
                        <div class="regular_user_index" style="display:none;">
                            ...
                            <section class="regu_user_info regu_info_add"><!-- 20200129 class="regu_info_add" 추가 -->
                                <article class="regu_user_info_center">
                                    <p><strong class="userName">옌<!-- 홍길동 --></strong> 님 안녕하세요.<br><span>(지금 스타벅스 카드를 등록하시면 <span class="en">Starbucks Rewards</span> 혜택을 받으실 수 있습니다.)</span></p> <!-- 스타벅스 리워드 수정 -->
                                    <!-- <a href="./myinfo_modify.do">개인정보 수정</a> -->
                                    <!-- 20160929 김민호 수정 -->
									<a href="./myinfo_modify_login.do">개인정보 수정</a>
									<a class="gray" href="./myinfo_modify_pwd.do">비밀번호 변경</a>
									<!-- 20160929 김민호 수정 end -->
                        ...
                        <div class="msr_user_index">
                            ...
                            <section class="ms_user_info ms_user_add"><!-- 20200123 class="ms_user_add" 추가 -->
                                ...
                                <article class="ms_user_info_left">
                                	...
                                	<p class="ms_user_stat mo_block">
                                		<span><strong class="userName">옌<!-- 홍길동 --></strong> 님은</span><br>
                                		<span>현재 <strong class="en userGrade t_bd9b60">Gold Level</strong>이십니다.</span>
                                	</p>
                                	<!-- 20200805 PLCC 추가 -->
                               		<div class="plcc-logo" style="display:none;">
                               			<img src="/common/img/util/plcc-logo.png" alt="Hyundai Card + STARBUCKS">
                               		</div>
                                	<figure class="en ms_user_starbg"><span class="totalStar">8</span></figure>
                                    <p class="ms_user_stat_notice"><strong>25</strong>개의 별★이 더 모이면<br><strong class="en t_bd9b60">Gold Level</strong>을 1년 더 유지할 수 있습니다!</p>
                                </article>
                                <article class="ms_user_info_right">
                                    <p class="ms_user_stat"><span><strong class="userName">옌<!-- 홍길동 --></strong> 님은</span> <span>현재 <strong class="en userGrade t_bd9b60">Gold Level</strong>이십니다.</span></p>
                                    <!-- 20200805 PLCC 추가 -->
                               		<div class="plcc-logo" style="display:none;">
                               			<img src="/common/img/util/plcc-logo.png" alt="Hyundai Card + STARBUCKS">
                               		</div>
							...
							<section class="have_no_ms_card" style="display:none;">
								...
								<div class="nocard_btns">
									<ul>
										<li class="nocard_btn1"><a href="/msr/scard/about.do">스타벅스 카드 보기</a></li>
										<li class="nocard_btn2"><a href="/msr/sceGift/gift_step1.do">스타벅스 e-Gift Card 구매</a></li>
									</ul>
								</div>
							</section>
							<!-- 등록된 카드 없음 end -->
                            ...
                            <section class="my_ms_card">
                                <div class="my_ms_card_inner">
                                    <header>
                                        ...
                                        <!-- 160125 김민호 시작 -->
										<i class="card_list_btn1"><a href="/my/mycard_list.do"><img src="//image.istarbucks.co.kr/common/img/util/card_list_btn1.png" alt="보유카드 상세정보"><!-- 접근성_20171201 alt 수정 --></a></i>
										<!-- 160125 김민호 end -->
                                    </header>
                                    <div class="my_ms_card_cont">
                                        <div class="bx-wrapper" style="max-width: 100%; margin: 0px auto;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 191px;"><ul class="slider" style="width: 315%; position: relative; transition-duration: 0s; transform: translate3d(-770px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; width: 770px;" class="bx-clone">             <figure>                            <!-- 160125 김민호 시작 -->              <!-- 접근성_20171201 aria 추가 -->               <i class="representative_icon" aria-hidden="true"></i>              <!-- 160125 김민호 end -->                            <img alt="옌" src="https://image.istarbucks.co.kr/cardImg/20161118/001909.png" onerror="this.src='https://image.istarbucks.co.kr/upload/common/img/icon/card_672x423.png';">             </figure>                                                 <div class="my_ms_card_info">                                                                    <p class="my_ms_card_id">                                                         <span>옌</span>                <!-- 접근성_20171201 title 추가 -->                         <a href="javascript:void(0);" class="icon_pencil" data-cardstatus="R" data-cardnickname="옌" title=" 카드명 수정">정보수정</a>                  </p>               <p class="my_ms_card_id_modify" style="display:none;">               <label class="a11y" for="cardName_">카드명</label><!-- 접근성_20171201 label 추가 -->                <input class="my_nick_modify_input" id="cardName_" type="text" maxlength="20" value="옌"><!-- 접근성_20171201 id 추가 -->                <a class="my_nick_modify" href="javascript:void(0);" data-cardregnumber="28066108" role="button" title="카드명 수정">수정</a><!-- 접근성_20171201 role, title 추가 -->                <a class="my_nick_cancel" href="javascript:void(0);" role="button">취소</a><!-- 접근성_20171201 role 추가 -->               </p>                                           <p class="my_ms_card_price"><span class="a11y">잔여금액</span><!-- 접근성_20171201 span 추가 --><strong class="en t_0d5f34">5,200</strong>원</p>                                                      <p class="my_ms_card_date">최종 사용일 : <span class="en">2022-05-07 14:48:30</span></p>                                                      <div class="my_ms_card_btns">                                                                           <p class="my_ms_card_btn1"><a href="javascript:void(0);" data-type="MANAGEMENT" data-cardregnumber="28066108">카드 관리</a></p>                                                           <p class="my_ms_card_btn2"><a href="javascript:void(0);" data-type="CHARGE" data-cardregnumber="28066108">충전하기</a></p>                                                                      </div>                                                               </div>                                             </li><li style="float: left; list-style: none; position: relative; width: 770px;">             <figure>                            <!-- 160125 김민호 시작 -->              <!-- 접근성_20171201 aria 추가 -->               <i class="representative_icon" aria-hidden="true"></i>              <!-- 160125 김민호 end -->                            <img alt="옌" src="https://image.istarbucks.co.kr/cardImg/20161118/001909.png" onerror="this.src='https://image.istarbucks.co.kr/upload/common/img/icon/card_672x423.png';">             </figure>                                                 <div class="my_ms_card_info">                                                                    <p class="my_ms_card_id">                                                         <span>옌</span>                <!-- 접근성_20171201 title 추가 -->                         <a href="javascript:void(0);" class="icon_pencil" data-cardstatus="R" data-cardnickname="옌" title=" 카드명 수정">정보수정</a>                  </p>               <p class="my_ms_card_id_modify" style="display:none;">               <label class="a11y" for="cardName_">카드명</label><!-- 접근성_20171201 label 추가 -->                <input class="my_nick_modify_input" id="cardName_" type="text" maxlength="20" value="옌"><!-- 접근성_20171201 id 추가 -->                <a class="my_nick_modify" href="javascript:void(0);" data-cardregnumber="28066108" role="button" title="카드명 수정">수정</a><!-- 접근성_20171201 role, title 추가 -->                <a class="my_nick_cancel" href="javascript:void(0);" role="button">취소</a><!-- 접근성_20171201 role 추가 -->               </p>                                           <p class="my_ms_card_price"><span class="a11y">잔여금액</span><!-- 접근성_20171201 span 추가 --><strong class="en t_0d5f34">5,200</strong>원</p>                                                      <p class="my_ms_card_date">최종 사용일 : <span class="en">2022-05-07 14:48:30</span></p>                                                      <div class="my_ms_card_btns">                                                                           <p class="my_ms_card_btn1"><a href="javascript:void(0);" data-type="MANAGEMENT" data-cardregnumber="28066108">카드 관리</a></p>                                                           <p class="my_ms_card_btn2"><a href="javascript:void(0);" data-type="CHARGE" data-cardregnumber="28066108">충전하기</a></p>                                                                      </div>                                                               </div>                                             </li><li style="float: left; list-style: none; position: relative; width: 770px;" class="bx-clone">             <figure>                            <!-- 160125 김민호 시작 -->              <!-- 접근성_20171201 aria 추가 -->               <i class="representative_icon" aria-hidden="true"></i>              <!-- 160125 김민호 end -->                            <img alt="옌" src="https://image.istarbucks.co.kr/cardImg/20161118/001909.png" onerror="this.src='https://image.istarbucks.co.kr/upload/common/img/icon/card_672x423.png';">             </figure>                                                 <div class="my_ms_card_info">                                                                    <p class="my_ms_card_id">                                                         <span>옌</span>                <!-- 접근성_20171201 title 추가 -->                         <a href="javascript:void(0);" class="icon_pencil" data-cardstatus="R" data-cardnickname="옌" title=" 카드명 수정">정보수정</a>                  </p>               <p class="my_ms_card_id_modify" style="display:none;">               <label class="a11y" for="cardName_">카드명</label><!-- 접근성_20171201 label 추가 -->                <input class="my_nick_modify_input" id="cardName_" type="text" maxlength="20" value="옌"><!-- 접근성_20171201 id 추가 -->                <a class="my_nick_modify" href="javascript:void(0);" data-cardregnumber="28066108" role="button" title="카드명 수정">수정</a><!-- 접근성_20171201 role, title 추가 -->                <a class="my_nick_cancel" href="javascript:void(0);" role="button">취소</a><!-- 접근성_20171201 role 추가 -->               </p>                                           <p class="my_ms_card_price"><span class="a11y">잔여금액</span><!-- 접근성_20171201 span 추가 --><strong class="en t_0d5f34">5,200</strong>원</p>                                                      <p class="my_ms_card_date">최종 사용일 : <span class="en">2022-05-07 14:48:30</span></p>                                                      <div class="my_ms_card_btns">                                                                           <p class="my_ms_card_btn1"><a href="javascript:void(0);" data-type="MANAGEMENT" data-cardregnumber="28066108">카드 관리</a></p>                                                           <p class="my_ms_card_btn2"><a href="javascript:void(0);" data-type="CHARGE" data-cardregnumber="28066108">충전하기</a></p>                                                                      </div>                                                               </div>                                             </li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev disabled" href="">Prev</a><a class="bx-next disabled" href="">Next</a></div></div></div>
                            ...
                            <section class="recent_bev_bg" style="">
                                <p class="recent_bev">가장 최근 2022년 5월 7일에 <strong>영등포시장교차로점</strong>에서 <strong class="t_0d5f34">(G)아이스 스타벅스 돌체 라떼</strong>를 마셨습니다.</p>
                                ...
                                <fieldset>
                                    ...
                                    <article class="my_ms_rank_wrap">
                                        <div class="my_ms_rank_each my_ms_rank_each1">
                                            <div class="bx-wrapper" style="max-width: 100%; margin: 0px auto;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 317px;"><ul class="edw1" style="width: 1115%; position: relative; transition-duration: 0s; transform: translate3d(-245px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; width: 245px;" class="bx-clone">	<header>부문별 음료 판매 순위<br><strong>콜드 브루</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="9200000000487"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[9200000000487]_20210430112319040.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="9200000000487">바닐라 크림 콜드 브루</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000000038">콜드 브루</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000002081">돌체 콜드 브루</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 음료 판매 순위<br><strong>에스프레소</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="110563"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[110563]_20210426095937808.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="110563">아이스 카페 아메리카노</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="110569">아이스 카페 라떼</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="94">카페 아메리카노</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 음료 판매 순위<br><strong>프라푸치노</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="9200000003999"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2022/05/[9200000003999]_20220520153341089.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="9200000003999">커피 드로잉 말차 프라푸치노</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="168016">P 자바 칩 프라푸치노</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000002760">더블 에스프레소 칩 프라푸치노</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 음료 판매 순위<br><strong>블렌디드</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="9200000003276"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[9200000003276]_20210416154001403.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="9200000003276">딸기 딜라이트 요거트 블렌디드</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000004002">퍼플 사워 블렌디드</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000003991">펀치 그래피티 블렌디드</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 음료 판매 순위<br><strong>기타 제조 음료</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="110621"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[110621]_20210415140901611.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="110621">아이스 시그니처 초콜릿</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="72">시그니처 핫 초콜릿</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000001302">아이스 제주 까망 라떼</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 음료 판매 순위<br><strong>브루드 커피</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="106509"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[106509]_20210430111852870.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="106509">아이스 커피</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="2">오늘의 커피</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 음료 판매 순위<br><strong>스타벅스 피지오</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="107051"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[107051]_20210419112151972.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="107051">쿨 라임 피지오</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000004121">유자 패션 피지오</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="107031">패션 탱고 티 레모네이드 피지오</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 음료 판매 순위<br><strong>스타벅스 주스(병음료)</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="5210008070"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[5210008070]_20210426095034991.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="5210008070">딸기주스 190M</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="5210008072">케일 사과주스 190M</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9300000003775">딸기 가득 요거트 190M</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 음료 판매 순위<br><strong>티</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="9200000000190"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[9200000000190]_20210419131723532.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="9200000000190">쉐이큰 자몽허니 블랙티</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000002959">아이스 유자 민트 티</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000003994">포멜로 플로우 그린 티</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 음료 판매 순위<br><strong>콜드 브루</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="9200000000487"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[9200000000487]_20210430112319040.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="9200000000487">바닐라 크림 콜드 브루</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000000038">콜드 브루</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="9200000002081">돌체 콜드 브루</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;" class="bx-clone">	<header>부문별 음료 판매 순위<br><strong>에스프레소</strong></header>	<figure><a href="javascript:void(0);" class="goDrink" data-sku="110563"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[110563]_20210426095937808.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goDrink" data-sku="110563">아이스 카페 아메리카노</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="110569">아이스 카페 라떼</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goDrink" data-sku="94">카페 아메리카노</a></span>	</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev" href="">Prev</a><a class="bx-next" href="">Next</a></div></div></div>
                                        </div>
                                        <div class="my_ms_rank_each my_ms_rank_each2">
                                            <div class="bx-wrapper" style="max-width: 100%; margin: 0px auto;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 317px;"><ul class="edw2" style="width: 1115%; position: relative; transition-duration: 0s; transform: translate3d(-245px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; width: 245px;" class="bx-clone">	<header>부문별 푸드 판매 순위<br><strong>브런치유어웨이</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="5110003062"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[5110003062]_20210421162339549.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="5110003062">바비큐 치킨 치즈 치아바타</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000002178">베이컨 치즈 토스트</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000001777">햄 루꼴라 올리브 샌드위치</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 푸드 판매 순위<br><strong>브레드</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="9300000003223"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/03/[9300000003223]_20210315170846073.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="9300000003223">바질 토마토 크림치즈 베이글</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="5110006070">하트 파이</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000004026">티라미수 크림 데니쉬</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 푸드 판매 순위<br><strong>케이크</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="5110007181"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[5110007181]_20210421164728509.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="5110007181">부드러운 생크림 카스텔라</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000004174">크런치 쿠키 마스카포네 케이크</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000004034">딸기 쏙 생크림 케이크</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 푸드 판매 순위<br><strong>샌드위치&amp;샐러드</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="5110003062"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[5110003062]_20210421162339549.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="5110003062">바비큐 치킨 치즈 치아바타</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000002178">베이컨 치즈 토스트</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000001777">햄 루꼴라 올리브 샌드위치</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 푸드 판매 순위<br><strong>따뜻한 푸드</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="9900000000680"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[9900000000680]_20210426103936780.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="9900000000680">판매트러플 머쉬룸 수프</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9900000001201">판매 토마토 로제 수프</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9900000001200">판매 단호박 크림 수프</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 푸드 판매 순위<br><strong>과일&amp;요거트</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="5110009051"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[5110009051]_20210422111651003.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="5110009051">하루 한 컵 레드</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000002619">20 밀크 푸딩</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000003232">오가닉 프로틴 그릭 요거트   그래놀라</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 푸드 판매 순위<br><strong>스낵&amp;미니디저트</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="9300000002517"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[9300000002517]_20210421163620436.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="9300000002517">더블 치즈 베이글 칩</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000004212">22 EW 한 입에 쏙 고구마</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000004045">리얼 두부칩</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 푸드 판매 순위<br><strong>아이스크림</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="9900000000031"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[9900000000031]_20210421162214091.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="9900000000031">바닐라 아포가토볼</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="5110009050">유기농 아이스크림 바닐라볼</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000000810">유기농 아이스크림 초콜릿볼</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 푸드 판매 순위<br><strong>프리미어 푸드</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="9300000001785"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[9300000001785]_20210422124351504.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="9300000001785">리저브초콜릿 월넛 돔 쿠키</a></p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 푸드 판매 순위<br><strong>브런치유어웨이</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="5110003062"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[5110003062]_20210421162339549.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="5110003062">바비큐 치킨 치즈 치아바타</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000002178">베이컨 치즈 토스트</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000001777">햄 루꼴라 올리브 샌드위치</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;" class="bx-clone">	<header>부문별 푸드 판매 순위<br><strong>브레드</strong></header>	<figure><a href="javascript:void(0);" class="goFood" data-sku="9300000003223"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/03/[9300000003223]_20210315170846073.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goFood" data-sku="9300000003223">바질 토마토 크림치즈 베이글</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="5110006070">하트 파이</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goFood" data-sku="9300000004026">티라미수 크림 데니쉬</a></span>	</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev" href="">Prev</a><a class="bx-next" href="">Next</a></div></div></div>
                                        </div>
                                        <div class="my_ms_rank_each my_ms_rank_each3">
                                            <div class="bx-wrapper" style="max-width: 100%; margin: 0px auto;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 317px;"><ul class="edw3" style="width: 515%; position: relative; transition-duration: 0s; transform: translate3d(-245px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; width: 245px;" class="bx-clone">	<header>부문별 원두 판매 순위<br><strong>스타벅스 비아</strong></header>	<figure><a href="javascript:void(0);" class="goCoffee" data-sku="11089092"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2019/05/[11089092]_20190527140748520.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goCoffee" data-sku="11089092">비아 아이스 커피 5개입</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11037708">비아 하우스 블렌드 12개입</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11037745">비아 파이크 플레이스 로스트 12개입</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 원두 판매 순위<br><strong>스타벅스 원두</strong></header>	<figure><a href="javascript:void(0);" class="goCoffee" data-sku="11017024"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2015/07/[11017024]_20150722231935988.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goCoffee" data-sku="11017024">에스프레소 로스트 250</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11125179">페루 춘키 블론드 로스트 250</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11017015">하우스 블렌드 250</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 원두 판매 순위<br><strong>리저브 원두</strong></header>	<figure><a href="javascript:void(0);" class="goCoffee" data-sku="11133545"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2022/03/[11133545]_20220324145738445.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goCoffee" data-sku="11133545">Reserve 브라질 파젠다 카탄두바 250</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11115491">Reserve 인도네시아 웨스트 자바 250</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11133775">Reserve SD 콜롬비아 핀카 250</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;">	<header>부문별 원두 판매 순위<br><strong>스타벅스 비아</strong></header>	<figure><a href="javascript:void(0);" class="goCoffee" data-sku="11089092"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2019/05/[11089092]_20190527140748520.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goCoffee" data-sku="11089092">비아 아이스 커피 5개입</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11037708">비아 하우스 블렌드 12개입</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11037745">비아 파이크 플레이스 로스트 12개입</a></span>	</p></li><li style="float: left; list-style: none; position: relative; width: 245px;" class="bx-clone">	<header>부문별 원두 판매 순위<br><strong>스타벅스 원두</strong></header>	<figure><a href="javascript:void(0);" class="goCoffee" data-sku="11017024"><img alt="" src="https://image.istarbucks.co.kr/upload/store/skuimg/2015/07/[11017024]_20150722231935988.jpg"></a></figure>	<p class="first_bev">1위</p>	<p class="coffee_name"><a href="javascript:void(0);" class="goCoffee" data-sku="11017024">에스프레소 로스트 250</a></p>	<p class="second_rank">		<span class="left"><strong>2위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11125179">페루 춘키 블론드 로스트 250</a></span>	</p>	<p class="third_rank">		<span class="left"><strong>3위</strong></span>		<span class="right"><a href="javascript:void(0);" class="goCoffee" data-sku="11017015">하우스 블렌드 250</a></span>	</p></li></ul></div><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev" href="">Prev</a><a class="bx-next" href="">Next</a></div></div></div>
                                        </div>
                                    </article>
                                </fieldset>
                            </form>
	...
	<ul>
		...
		<li>
			...
			<ul>
				...
				<li><a href="javascript:void(0);" required="login" data-href="/eFreq/status.do?promoSeq=172">· 이용현황</a></li>
			</ul>
		</li>
			...
			<footer id="footer"> 
				...
				<div class="footer_util_btn">
					<ul>
						...
						<li class="last" style="display: none;"><a href="/mem/join1.do">Join Us</a></li>
					</ul>
				</div>
				<!-- 수상내역 -->
...
// 					});
            ...
            <script>
                ...
                var $userBirth  = "1994-07-14";
                var $userGender = "F";
                
                if (new Date() < new Date(2016, 1 - 1, 1, 0, 0, 0)) {
                	$(".my_ms_evbnr").prepend('<a href="/eFreq/index.do" required="login"><img alt="" src="//image.istarbucks.co.kr/common/img/util/ms_efreq_bn.jpg"></a><br /><br />');
                }                
            </script>
