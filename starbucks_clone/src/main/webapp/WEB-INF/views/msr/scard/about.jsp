				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="about.do.html" class="this">스타벅스 카드 소개</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
					...
					<div class="scard_buy_inner">
								...
								<li class="last">
									<dl>
										...
										<dd>
											...
											<p class="g_btn"><a href="../sceGift/gift_step1.do.html" required="login">바로가기</a></p>
										</dd>
									</dl>
								</li>
							</ul>
						...
						<div class="soConArea"><!-- 20190304 태그 추가 -->
							...
							<ul class="info mb30">
								...
								<li>방법 : B2B 발주시스템을 통하여 접수<br><span>(단체 및 기업구매 안내&nbsp;<a class="newBtn" href="../../footer/co_sales/index.do.html" target="_blank">바로가기</a>)</span></li><!-- 20210913 수정 -->
							</ul>	
						</div>
						<!-- //20190304 수정 -->
					</div>
