...
var eFrequencyPlannerYn = 'Y';
	...
	<body>
        ...
        <div class="myMsrCard">
            <p class="close"><a href="javascript:void(0)">팝업 닫기</a></p>
            <p><img src="../../common/img/msr/card_pop_obj.png" alt=""></p>
        </div>
		<div id="wrap">
					...
					<nav class="mob_gnb_menus">
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="about.do.html">스타벅스 카드 소개</a></li>
									<li><a href="scard_gallery.do.html">스타벅스 카드 갤러리</a></li>
									<li><a href="register_inquiry.do.html">등록 및 조회</a></li>
									<li><a href="charge_information.do.html">충전 및 이용안내</a></li>
									<li><a href="lost_report.do.html">분실신고/환불신청</a></li>
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../../common/img/msr/scard/tit2.jpg" alt="스타벅스 카드 갤러리"></h2>
						<ul class="smap">
							...
							<li class="en"><a href="../index.do.html" class="subHeadMnu1">Starbucks Rewards</a></li> <!-- 스타벅스 리워드 수정 -->
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="about.do.html">스타벅스 카드</a></li>
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="scard_gallery.do.html" class="this">스타벅스 카드 갤러리</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
...
// 					});
		...
		<script>
			$(document).ready(function(){
                ...
                var option = {};
                __ajaxCall('/msr/getCardList.do', option , true, "JSON", "POST", 
                function(data) {
                    if(data.list.length > 0) {
                        ...
                        $.each(data.list , function(x,y) {
                            ...
                            tmpStr = '';
                            tmpStr += '<dt>'+y.card_YEAR+'년 스타벅스 출시 카드</dt>';
                            tmpStr += '<dd>';
                            tmpStr += '    <div class="scardWrap">';
                            tmpStr += '    </div>';
                            tmpStr += '</dd>';
                            $('.scard_display').append(tmpStr);
                            
                            product_cd                = y.product_CD.split('@');
                            product_nm               = y.product_NM.split('@');
                            web_image_webview   = y.web_IMAGE_WEBVIEW.split('@');
                            web_image_tabview    = y.web_IMAGE_TABVIEW.split('@');
                            web_image_mobview   = y.web_IMAGE_MOBVIEW.split('@');
                            card_month               = y.card_MONTH.split('@');
                            msr_seq                    = y.msr_SEQ2.split('@');
                            
                            for( var k = 0; k <= product_cd.length - 1; k++) {
                                tmpStr2 = '';
                                tmpStr2 += '<div class="scardObj">';
                                tmpStr2 += '    <p class="no">'+card_month[k]+'월 출시</p>';
                                tmpStr2 += '    <dl class="scard_name">';
                                tmpStr2 += '        <dt><img src="'+ y.img_UPLOAD_PATH + web_image_webview[k]+'" alt="'+product_nm[k]+'" seq="'+msr_seq[k]+'" onerror="this.src=\'https://image.istarbucks.co.kr/upload/common/img/icon/card_672x423.png\';" /></dt>';
                                tmpStr2 += '        <dd>'+product_nm[k]+'</dd>';
                                tmpStr2 += '    </dl>';
                                tmpStr2 += '</div>';
                                
                                $('.scardWrap').last().append(tmpStr2);
                            }
                            
                        });

                        /* 150605 성연욱 - 스타벅스 카드 갤러리 스크롤 */
                        $(".scardWrap").mCustomScrollbar({
                            // autoDraggerLength: 0,
                            axis:"x",
                            advanced:{autoExpandHorizontalScroll:true}
                        });
                        /* 150605 성연욱 - 스타벅스 카드 갤러리 스크롤 end */
                        
                        /* $('.scard_name img').bind('click', function() {
                        	seq = $(this).attr('seq');
                        	form = document.cForm;
                        	form.action = "/menu/card_view.do";
                        	form.seq.value = seq;
                        	form.submit();
                        }); */

                        $('.scard_display div.scardObj dl.scard_name dt img').bind('click', function(){
                            $('.myDimm').show();
                            var wt = $(window).scrollTop();
                            var wh = $(window).height();
                            var dh = $('.myMsrCard').height();
                            
                            $('.myMsrCard').find('img').attr('src', $(this).attr('src'));
                            $('.myMsrCard').css('top', ((wh - dh) / 2) + (dh / 2) + wt);
                            $('.myMsrCard').fadeIn();
                        });

                        $('.myDimm, .myMsrCard p.close').bind('click', function(){
                            $('.myDimm').hide();
                            $('.myMsrCard').fadeOut();
                        });
                    }
