				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="charge_information.do.html" class="this">충전 및 이용안내</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="msr_cont">
					...
					<section class="chargeInformation_bar">
						<article class="chargeInformation_bar_inner">
							...
							<map name="charge_pic_info" id="charge_pic_info">
							    <area shape="rect" coords="403,133,458,151" href="../../my/mycard_charge.do.html" alt="일반충전">
							    <area shape="rect" coords="478,133,533,153" href="../../my/mycard_charge.do.html" alt="자동충전">
							</map>
						</article>
					</section>
					<p class="m_scard_txt">스타벅스 홈페이지와 모바일 애플리케이션을 통해 언제 어디서나 편리하게 이용하세요. <br>온라인에서는 <a href="../../my/mycard_charge.do.html"><span>일반충전</span></a>과 <a href="../../my/mycard_charge.do.html"><span>자동충전</span></a> 두 가지 방식으로 충전하실 수 있습니다.</p><!-- 20210914 수정 --><!-- jsp2 추가 - p 태그 추가 -->
					<!-- (충전 및 이용안내) bar end -->
					<div class="charge_cont_area">
						...
						<article class="charge_cont charge_cont_first">
							...
							<div class="card_info">
								<ul>
									...
									<li>홈페이지 충전은 My Starbucks > My 스타벅스 카드 > <a href="../../my/mycard_charge.do.html" required="login">충전하기</a>에서 가능합니다. </li>
									<!-- 150904 수정 -->
							...
							<p class="btn_charge_basic"><a href="../../my/mycard_charge.do.html">일반충전 하러가기</a></p>
						</article>
						...
						<article class="charge_cont">
							...
							<p class="btn_charge_basic"><a href="../../my/mycard_charge.do-1.html?TYPE=1">자동충전 하러가기</a></p>
						</article>
					</div>		
				</div>
				<div class="charge_gray_area">
					<div class="charge_info">
						...
						<div class="scard_term_area">
							...
							<p class="btn"><a href="../../footer/etc/rules_msr.do.html"><img src="../../common/img/msr/mycard_btn.png" alt="스타벅스 카드 이용약관 보기"></a></p>
						</div>
					</div>
				</div>
			</div>
