				...
				<div class="msr_cont">
					...
					<section class="registerInquiry_barIink">
						<article class="registerInquiry_barIink_inner">
							...
							<p class="btn_barIink"><a href="footer/etc/rules_msr"><img src="img/event/2020/20_btn_barIink_more.png" alt="스타벅스 리워드 이용약관 보기"></a></p> <!-- 스타벅스 리워드 수정 -->
						</article>
					</section>
					<!-- (등록 및 조회) barIink end -->

					<p class="m_btn_barIink"><a href="footer/etc/rules_msr"><img src="img/event/2020/20_btn_barIink_more.png" alt="스타벅스 리워드 이용약관 보기"></a></p> <!-- 스타벅스 리워드 수정 -->
