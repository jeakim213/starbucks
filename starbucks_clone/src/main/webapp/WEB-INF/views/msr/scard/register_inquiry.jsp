				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="register_inquiry.do.html" class="this">등록 및 조회</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="msr_cont">
					...
					<div class="registerInquiry_info">
						...
						<section class="registerInquiry_info1">
							<article class="registerInquiry_info1_inner">
								...
								<p class="btn_info1"><a href="/mem/join.do">가입하기</a></p>
							</article>
						</section>
						<!-- (등록 및 조회) info1 end -->
						...
						<section class="registerInquiry_info2">
							<article class="registerInquiry_info2_inner">
								...
								<ul>
									<li class="btn_card_regi"><a href="../../my/mycard_info_input.do.html">스타벅스 카드 등록</a></li>
									<li class="btn_to_home"><a href="../sceGift/gift_step1.do.html">e-Gift 선물하기</a></li>
								</ul>
						...
						<section class="registerInquiry_info3">
							<article class="registerInquiry_info3_inner">
								...
								<p class="btn_info3"><a href="../../my/mycard.do.html" required="login">My 카드 관리</a></p>
							</article>
						</section>
						<!-- (등록 및 조회) info3 end -->
					</div>
					...
					<section class="registerInquiry_barIink">
						<article class="registerInquiry_barIink_inner">
							...
							<p class="btn_barIink"><a href="../../footer/etc/rules_msr.do.html"><img src="../../img/event/2020/20_btn_barIink_more.png" alt="스타벅스 리워드 이용약관 보기"></a></p> <!-- 스타벅스 리워드 수정 -->
						</article>
					</section>
					<!-- (등록 및 조회) barIink end -->

					<p class="m_btn_barIink"><a href="../../footer/etc/rules_msr.do.html"><img src="../../img/event/2020/20_btn_barIink_more.png" alt="스타벅스 리워드 이용약관 보기"></a></p> <!-- 스타벅스 리워드 수정 -->
