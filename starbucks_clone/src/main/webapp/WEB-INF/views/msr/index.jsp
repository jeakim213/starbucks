			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li class="en"><a href="index" class="this">Starbucks Rewards</a></li>  
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				...
				<div class="msr_main_section">
					<div class="msr_bn_inner">
						...
						<div class="msr_btn_wrap02">
							<ul>
								<li><a href="msreward/about">스타벅스 리워드 소개</a></li>  
								<li><a href="my/reward" required="login">My 리워드 확인</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="msr_bn_inner">
						...
						<div class="msr_btn_wrap01">
							<ul>
								...
								<li><a href="scard/register_inquiry">등록 및 조회</a></li>
								<li><a href="scard/charge_information">충전 및 이용안내</a></li>
								<li><a href="my/mycard" required="login">My 스타벅스 카드 확인</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="msr_bn2_section">
					<div class="msr_bn_inner">
						...
						<div class="msr_btn_wrap02">
							<ul>
								<li class="li1"><a href="sceGift/egift_information">스타벅스 e-Gift Card 소개</a></li>
								<li class="li2"><a href="sceGift/msr_useguide">이용안내</a></li>
								<li class="li3"><a href="sceGift/gift_step1" required="login">선물하기</a></li>
							</ul>
						</div>
					</div>
				</div>
