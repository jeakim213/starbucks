...
<!-- MSR 영역 -->
			...
			<div id="top_MSR" class="eFreqTop"><!-- 20170510 수정 : 클래스 eFreqTop 추가 -->
				<div class="top_msr_wrap" style="display:none;">
					...
					<!-- 일반회원 -->
					<div class="msr_lead">
						<a href="msreward/level_benefit.do.html">
				...
				<div class="top_msr_nologin">
					...
					<div class="top_msr_nologin_b">
						...
						<p class="btn_egift_regi">
							<a href="sceGift/gift_step1.do.html">e-Gift 선물하기</a>
						</p>
					</div>
					<!-- 160628 수정 end -->
				</div>
					...
					<nav class="mob_gnb_menus">
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="sceGift/gift_step1.do.html" required="login">선물하기</a></li>
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="msreward/about.do.html">스타벅스 리워드 소개</a></li> <!-- 스타벅스 리워드 수정 -->
									<li><a href="msreward/level_benefit.do.html">등급 및 혜택</a></li>
									<li><a href="msreward/star.do.html">스타벅스 별</a></li>
							...
							<li>
								...
								<ul>
									<li><a href="scard/about.do.html">스타벅스 카드 소개</a></li>
									<li><a href="scard/scard_gallery.do.html">스타벅스 카드 갤러리</a></li>
									<li><a href="scard/register_inquiry.do.html">등록 및 조회</a></li>
									<li><a href="scard/charge_information.do.html">충전 및 이용안내</a></li>
									<li><a href="scard/lost_report.do.html">분실신고/환불신청</a></li>
							...
							<li>
								...
								<ul>
									<li><a href="sceGift/egift_information.do.html">스타벅스 e-Gift Card 소개</a></li>
									<li><a href="sceGift/msr_useguide.do.html">이용안내</a></li>
									<li><a href="sceGift/gift_step1.do.html" required="login">선물하기</a></li>
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../img/event/2020/14_msr_tit.png" alt="STARBUCKS REWARDS"></h2> 
						<ul class="smap">
							...
							<li class="en"><a href="index.do.html" class="this">Starbucks Rewards</a></li>  
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				...
				<div class="msr_main_section">
					<div class="msr_bn_inner">
						<img class="m_pic" src="../common/img/msr/m_msr_main.jpg" alt="">
						<div class="msr_bn2_txt01">
							<img class="w_pic" src="../img/event/2020/14_msr_bn_txt1.png" alt="스타벅스만의 특별한 혜택, 스타벅스 리워드를 만나보세요. 스타벅스를 사랑해주시는 고객님을 위해 별을 적립하여 혜택으로 돌려드리는 특별한 리워드 서비스입니다.">  
							<img class="m_pic" src="../img/event/2020/14_m_msr_mtxt.png" alt="스타벅스만의 특별한 혜택, 스타벅스 리워드를 만나보세요. 스타벅스를 사랑해주시는 고객님을 위해 별을 적립하여 혜택으로 돌려드리는 특별한 리워드 서비스입니다.">  
						</div>
						<div class="msr_btn_wrap02">
							<ul>
								<li><a href="msreward/about.do.html">스타벅스 리워드 소개</a></li>  
								<li><a href="../my/reward.do.html" required="login">My 리워드 확인</a></li>
							</ul>
						</div>
					</div>
				</div>
                        ...
                        <div class="newsArea_bgl">
                            <dl>
								<dt>
									...
									<img class="m_pic" src="../common/img/common/icon_board_speaker-1.png" alt="보도자료">
								</dt>
								<dd>
				...
				<!-- news end -->
				<!-- 프로모션 & 이벤트 -->
				<div class="msr_bn1_section">
					<div class="msr_bn_inner">
						<img class="m_pic" src="../common/img/msr/m_msr_bimg1.jpg" alt="">
						<div class="msr_bn1_txt01">
							<img class="w_pic" src="../common/img/msr/msr_main_txt1.png" alt="스타벅스만의 특별함, 스타벅스 카드를 소개합니다. 스타벅스 카드는 기본적인 Free Extra 혜택을 드리며, 카드 고객 대상으로 다양한 이벤트를 지속적으로 진행하고 있습니다.">
							<img class="m_pic" src="../common/img/msr/m_msr_btxt1.png" alt="스타벅스만의 특별함, 스타벅스 카드를 소개합니다. 스타벅스 카드는 기본적인 Free Extra 혜택을 드리며, 카드 고객 대상으로 다양한 이벤트를 지속적으로 진행하고 있습니다.">
						</div>
						<!-- div class="msr_bn1_btn01"><a href="javascript:void(0)">자세히 보기</a></div -->
						<div class="msr_btn_wrap01">
							<ul>
								<li><a href="scard/about.do.html">스타벅스 카드 소개</a></li>
								<li><a href="scard/register_inquiry.do.html">등록 및 조회</a></li>
								<li><a href="scard/charge_information.do.html">충전 및 이용안내</a></li>
								<li><a href="../my/mycard.do.html" required="login">My 스타벅스 카드 확인</a></li>
							</ul>
						</div>
					</div>
				</div>
				<!-- 프로모션 & 이벤트 end -->
				<!-- 새소식 -->
				<div class="msr_bn2_section">
					<div class="msr_bn_inner">
						<img class="m_pic" src="../common/img/msr/m_msr_bimg2.jpg" alt="">
						<div class="msr_bn2_txt01">
							<img class="w_pic" src="../common/img/msr/msr_main_txt_20170823.png" alt="쉽고 빠르게 스타벅스 카드를 구매하는 방법, 스타벅스 e-Gift Card를 이용해 보세요. 매장 방문 없이 웹사이트와 모바일 앱에서 스타벅스 e-Gift Card를 손쉽게 구매하여 사용해보세요.">
							<img class="m_pic" src="../common/img/msr/m_msr_main_txt_20170823.png" alt="쉽고 빠르게 스타벅스 카드를 구매하는 방법, 스타벅스 e-Gift Card를 이용해 보세요. 매장 방문 없이 웹사이트와 모바일 앱에서 스타벅스 e-Gift Card를 손쉽게 구매하여 사용해보세요."></div>
						<div class="msr_btn_wrap02">
							<ul>
								<li class="li1"><a href="sceGift/egift_information.do.html">스타벅스 e-Gift Card 소개</a></li>
								<li class="li2"><a href="sceGift/msr_useguide.do.html">이용안내</a></li>
								<li class="li3"><a href="sceGift/gift_step1.do.html" required="login">선물하기</a></li>
							</ul>
						</div>
					</div>
				</div>
