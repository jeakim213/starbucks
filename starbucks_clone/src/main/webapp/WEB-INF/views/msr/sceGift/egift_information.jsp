			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="egift_information.do.html" class="this">스타벅스 <span class="en">e-Gift Card</span> 소개</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
						...
						<article class="eInformation_info1_inner">
							...
							<h3>스타벅스 <span class="en">e-Gift Card</span>란?
								<p class="ttl_sub_content">(개인 전용)<br class="for_mob">
									<a class="ml5" href="../../footer/co_sales/sbcard_egift.do.html">[단체/법인 구매하러가기]</a>
								</p>
							</h3>
							<!-- 170203 수정 end -->
							<!-- 160510 김민호 추가 -->
							<p class="s_titl">스타벅스 홈페이지 회원이라면 홈페이지, 모바일 애플리케이션을 통해 스타벅스 카드 <span><a class="t_006633 en" href="gift_step1.do.html" required="login">[e-Gift Card 구매·선물]</a></span>이 가능합니다.</p>
							<!-- 160510 김민호 추가 end -->
							<ul class="egift_info">
								<li>
									<dl class="info_01">
				...
				<section class="eInformation_use">
					<article class="eInformation_use_inner">
						...
						<p class="s_titl">스타벅스 <span class="en">e-Gift Card</span>는 회원가입 없이도 즉시 사용할 수 있습니다.<br>스타벅스 회원이라면 <span class="btn_cardIink"><a href="../../my/mycard_info_input.do.html" required="login">[카드 등록]</a></span>후, 더욱 편리하게 사용하세요.</p>
						<ul class="egift_use">
							<li>
								<dl class="use_01">
									<dt>휴대폰 MMS 제시</dt>
							...
							<li>
								<dl>
									...
									<dd>
										...
										<!-- 160509 링크 추가 -->
										<p class="btn"><a href="../../my/mycard_charge.do.html" required="login">바로가기</a></p>
										<!-- 160509 링크 추가 end -->
									</dd>
								</dl>
							</li>
							<li>
								<dl>
									...
									<dd>
										...
										<p class="btn"><a href="../../my/mycard_info_input.do.html" required="login">바로가기</a></p>
									</dd>
								</dl>
							</li>
							<li class="last">
								<dl>
									...
									<dd>
										...
										<p class="g_btn"><a href="gift_step1.do.html" required="login">바로가기</a></p>
									</dd>
								</dl>
							</li>
						</ul>
