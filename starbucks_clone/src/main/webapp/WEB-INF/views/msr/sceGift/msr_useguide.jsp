				...
				<div class="top_msr_nologin">
					...
					<div class="top_msr_nologin_b">
						...
						<p class="btn_egift_regi">
							<a href="gift_step1.do.html">e-Gift 선물하기</a>
						</p>
					</div>
					<!-- 160628 수정 end -->
				</div>
					...
					<nav class="mob_gnb_menus">
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="gift_step1.do.html" required="login">선물하기</a></li>
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="egift_information.do.html">스타벅스 e-Gift Card 소개</a></li>
									<li><a href="msr_useguide.do.html">이용안내</a></li>
									<li><a href="gift_step1.do.html" required="login">선물하기</a></li>
				...
				<header class="msr_sub_ttl_wrap">
					<div class="msr_sub_ttl_inner">
						...
						<ul class="smap">
							...
							<li class="en"><a href="../index.do.html">Starbucks Rewards</a></li> <!-- 스타벅스 리워드 수정 -->
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="egift_information.do.html">스타벅스 <span class="en">e-Gift Card</span></a></li>
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="msr_useguide.do.html">이용안내</a></li>
						</ul>
					</div>
						...
						<article>
								...
								<dl class="useguide_type_dl utd2">
									...
									<dd>
										<ol class="step_ol">
											...
											<li><span class="en">Step 1.</span> Home &gt; Starbucks Rewards &gt; 스타벅스 e-Gift Card &gt; <a href="gift_step1.do.html" required="login">선물하기</a> 로 이동</li> <!-- 스타벅스 리워드 수정 -->
											...
											<li><span class="en">Step 5.</span> 결제완료. <a href="../../my/egiftCard.do.html" required="login">[선물내역]</a>에서 확인하실 수 있습니다.</li>
											<!-- // 150627 성연욱 - DOM 수정 - 각 li에 span 추가 -->
										</ol>
							...
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd3">
									...
									<dd>
										...
										<ul class="bullet_ul">
											<li>스타벅스 e-Gift Card를 선물하실 경우 발신자의 정보는 스타벅스 웹회원 정보에 등록된 휴대폰 번호 또는 e-Mail 주소로 자동 설정되어 있습니다.<br>회원 정보를 수정하시려면 <a href="/my/myinfo_modify_login.do" required="login">개인정보 확인 및 수정</a>을 클릭해 주세요.</li>
											<li>구매 가능한 최소 금액 단위는 5천원이며, 1만원 이상부터는 1만원 단위로 최대 50만원까지, 1회 당 최대 10개의 휴대폰 또는 e-Mail로 보내실 수 있습니다.<br>또한, 바로 결제하여 즉시 구매하시거나 <a href="../../my/egiftCard_shopping_bag.do.html" required="login">장바구니 내역</a>에 담아두었다가 추후에 결제하실 수도 있습니다.</li>
											<li>
							...
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd5">
									...
									<dd>
										<p>선물한 메시지, 수신인, 결제금액 등 지인에게 선물하신 상세내역은  Home &gt; Starbucks Rewards &gt; 스타벅스 e-Gift Card &gt; <a href="../../my/egiftCard.do.html" required="login">선물내역</a>에서 확인 하실 수 있습니다.</p> <!-- 스타벅스 리워드 수정 -->
									</dd>
								</dl>
							</section> 
								...
								<dl class="useguide_type_dl utd6">
									...
									<dd>
										...
										<div class="btn_chk_gift">
											<a href="../../my/egiftCard.do.html" required="login">선물내역 확인하러 가기</a>
										</div>
									</dd>
								</dl>
							</section> 
							...
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd7">
									...
									<dd>
										...
										<ul class="bullet_ul">
											<li><a href="../../my/egiftCard.do.html" required="login">선물내역</a>에서 다시 선물하고자 하는 주문내역을 선택하세요.</li>
						...
						<article>
							...
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd12">
									...
									<dd>
										<p class="black">스타벅스 e-Gift Card를 <a href="../../my/mycard_index.do.html" required="login">My 카드</a>에 <a href="../../my/mycard_info_input.do.html" required="login">카드 등록</a> 후 이용하시면, 다양한 혜택을 누리실 수 있습니다.</p><!-- 150627 성연욱 - DOM 수정 - p태그에 클래스 추가 -->
										<ul class="bullet_ul">
							...
							<section class="useguide_type2">
								<dl class="useguide_type_dl utd13">
									...
									<dd>
										<p class="black">스타벅스 e-Gift Card를 <a href="../../my/mycard_index.do.html" required="login">My 카드</a>에 <a href="../../my/mycard_info_input.do.html" required="login">카드 등록</a>하시면 스타벅스 리워드 회원이 됩니다.<br>생일 무료 음료 쿠폰, New Beverage BOGO e-쿠폰 등 다양한 혜택을 누리실 수 있습니다.</p><!-- 150627 성연욱 - DOM 수정 - p태그에 클래스 및 a태그 추가 --> <!-- 스타벅스 리워드 수정 -->
										<ul class="bullet_ul">
											...
											<li>매번 충전하기 번거로우셨다면, <a href="../../my/mycard_charge.do-2.html?autoReloadType=2" required="login">자동충전</a> 기능을 이용하시면 보다 편리하게 이용하실 수 있습니다.</li>
										</ul>
									</dd>
								</dl>
							</section>
