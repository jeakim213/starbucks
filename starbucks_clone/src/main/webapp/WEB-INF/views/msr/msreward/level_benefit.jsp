					...
					<nav class="mob_gnb_menus">
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="about.do.html">스타벅스 리워드 소개</a></li> <!-- 스타벅스 리워드 수정 -->
									<li><a href="level_benefit.do.html">등급 및 혜택</a></li>
									<li><a href="star.do.html">스타벅스 별</a></li>
	...
	<li class="util_nav04"><a href="../../store/store_map.do.html">Find a Store</a></li>
		...
		<!-- 서브 gnb end -->
			...
			<div id="container">	
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li class="en"><a href="../index.do.html">Starbucks Rewards</a></li>
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="about.do.html">스타벅스 리워드</a></li>
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="level_benefit.do.html" class="this">등급 및 혜택</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
					...
					<section class="levelBenefit01_info1">
						<article class="levelBenefit01_info1_inner">
							...
							<ul class="levelBenefit01_info">
								...
								<li class="l_info2">
									...
									<ul class="text">
										...
										<li>- 스타벅스 리저브™ 원두 구매 시, 스타벅스 리저브™<br>&nbsp;음료 or 카페 아메리카노(Hot/Iced) e-쿠폰 제공<br class="show_mob"><span class="ls">※단, 결제수단 변경 및 교환 거래, 임직원 할인 또는 e-Gift Item 구매 시 미제공</span><br class="show_mob"><span class="ls">※카페 아메리카노 (Hot/Iced) e-쿠폰은 디카페인, ½ 디카페인, 블론드 원두로도 변경하여 사용 가능</span></li> <!-- 20211124 수정 -->
										<li>- 250g 원두 or 12개입 VIA 구매 시,<br>&nbsp;카페 아메리카노(Hot/Iced) e-쿠폰 제공<br class="show_mob"><span class="ls">※단, 결제수단 변경 및 교환 거래, 임직원 할인 또는 e-Gift Item 구매 시 미제공</span><br class="show_mob"><span class="ls">※카페 아메리카노 (Hot/Iced) e-쿠폰은 디카페인, ½ 디카페인, 블론드 원두로도 변경하여 사용 가능</span></li> <!-- 20211124 수정 -->
										<li>- 티바나 패키지 티 구매 시, 풀 리프 티(Hot/Iced) e-쿠폰 제공<br class="show_mob"><span class="ls">※ 단, 결제수단 변경 및 교환 거래, 임직원 할인 또는 e-Gift Item 구매 시 미제공</span></li> <!-- 20210504 수정 -->
										<li>- Beverage BOGO e-쿠폰(이벤트 진행 시 발급)</li> <!-- 20210202 수정 -->
										<li>- 회원 전용 이벤트</li>
										<!-- //20181205 수정 -->
									</ul>
							...
							<ul class="l_info1_text">
								<li class="mb5">My DT Pass 서비스 이용 : 차량번호를 사전에 등록하시면, DT 매장에서 주문 후 결제 단계 없이 상품을 빠르게 수령하실 수 있습니다. <a href="../../login/login.do.html">차량번호 등록하기</a></li>
								<li class="mb5">스타벅스 카드 등록은 e-Gift Card &gt; 선물하기 &gt; 받는사람 &gt; 나에게 선물하기를 통해서 편리하게 카드 구매 후, 등록하실 수 있습니다.
								<a href="../sceGift/gift_step1.do.html">e-Gift Card 선물하기</a>
								</li>
								...
								<li class="mb5">자동 충전이란? 카드 별로 ‘원하는 날짜’에 또는 ‘잔액이 설정한 기준 금액보다 낮을 경우’ 선택한 금액이 자동으로 충전되도록 하는 편리한 충전 서비스입니다.<br>(5만원 이상 자동 충전 설정 후, 자동 충전 발생 시마다 익일 BOGO e-쿠폰을 발급해 드립니다.)<br><a href="../../my/mycard_charge.do-1.html?TYPE=1">자동충전 설정 바로가기</a></li><!-- 20210914 수정 -->
							</ul>
							<!-- 160628 수정 end -->
						</article>
					</section>
				...
				<!-- 150625 DOM 변경 - 문진욱 -->
				<!-- 150709 구명준 수정  -->
				<section class="levelBenefit01_info2 levelMoUi"><!-- 20190703 이지나 class="levelMoUi" 추가 -->
					<article class="levelBenefit01_info2_inner" id="showcase">
						...
						<ul class="note_list">
							...
							<li class="card_flip card_flip1">
								...
								<div class="grade_card_add grade_card03_add"><!-- 20191216 class="grade_card09_add" 삭제 -->
									<!-- 161115 문진욱 수정 -->
									<div class="grade_card_add_inner">	
								...
								<div class="grade_card_add grade_card05_add">
									<div class="grade_card_add_inner">	
										...
										<ul>
											...
											<li>디카페인 또는 ½ 디카페인 또는 블론드 아메리카노 이용 가능합니다.</li> <!-- 20211213 수정 -->
											<!-- <li>블론드 아메리카노는 적용 불가합니다.</li> --> <!-- 20211124 삭제 -->
											<li>결제수단 변경 및 교환 거래, 임직원 할인 또는 e-Gift Item 구매 시에는 e-쿠폰이 발행되지 않습니다.</li>
										</ul>
										<!-- //20200803 수정 -->
										<p class="grade_card_add_close"><a href="javascript:void(0);">닫기</a></p>
									</div>
							...
							<li class="card_flip card_flip2">
								...
								<div class="grade_card_add grade_card14_add">
									<div class="grade_card_add_inner">	
										<strong>티바나 패키지 티 구매 시, 풀 리프 티 e-쿠폰 발행!</strong> <!-- 20210504 수정 -->
										<ul>
											<li>Tall Size 풀 리프 티 음료 (Hot/Iced 중 선택 가능) e-쿠폰이 발행됩니다.</li>
											<li>결제수단 변경 및 교환거래, 임직원 할인 또는 e-Gift Item 구매 시에는 e-쿠폰이 발행되지 않습니다.</li>
										</ul>
										<p class="grade_card_add_close"><a href="javascript:void(0);">닫기</a></p>
									</div>
								</div>
							...
							<!-- 3 -->
							<!-- 20210416 마크업 위치 변경 -->
							<li class="card_flip card_flip3"> <!-- 20210416 클래스명 수정 -->
								<div class="front">
									<i class="card_back_logo"></i>
								</div>
								<div class="back grade_card13"><!-- 20181205 class="grade_card13" 수정 -->
									<p class="icon_level">
								...
								<div class="grade_card_add grade_card13_add">
									<div class="grade_card_add_inner">	
										...
										<ul>
											...
											<li>방문별이 적립되는 첫 구매 후, 익일 쿠폰이 발행됩니다.</li><!-- 20200904 수정 -->
											<li>파트너가 제조하는 Tall Size 음료로 교환 가능하며, 유효기간은 30일 입니다.</li>
											<li>신규 회원에게 1회만 발행되며, 회원 탈퇴 후 재가입 시 재 발행되지 않습니다.</li>
										</ul>
										<!-- //20181205 수정 -->
										<p class="grade_card_add_close btClose"><a href="javascript:void(0);">닫기</a></p><!-- 20181205 class="btClose" -->
									</div>
								</div>
							</li>
							<!-- //20181205 영역추가 -->
							...
							<li class="card_flip card_flip3">
								...
								<div class="back grade_card12">
									<p class="btn_more2"><a href="../../my/mycard_charge.do.html">카드충전 바로가기</a></p>
								</div>
							</li>
							<!-- 3 -->
						</ul>
