				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="product_list.do.html" class="this">상품</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
...
// 					});
		...
		<script>
			var $PREVIEW = "";
			var $CATE_CD = "product_accessories";
            	...
            	$('.product_select_wrap input[type=checkbox]').each(function() {
                    ...
                    if(cngCateCode != "") {
	                    if(chk_idx == 0) {
	                    	...
	                    	if(cate_chk_stat) {
                                if( $.trim($('#product_view_tab01 .product_list > dl > dd').eq(chk_idx - 1).find('ul').html()) != "" ) {
