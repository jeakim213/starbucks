					...
					<nav class="mob_gnb_menus">
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="drink_list.do.html">전체보기</a></li>
									<li><a href="drink_list.do-1.html?CATE_CD=product_cold_brew">콜드 브루</a></li>
									<li><a href="drink_list.do-2.html?CATE_CD=product_brood">브루드 커피</a></li>
									<li><a href="drink_list.do-3.html?CATE_CD=product_espresso">에스프레소</a></li>
									<li><a href="drink_list.do-4.html?CATE_CD=product_frappuccino">프라푸치노</a></li>
									<li><a href="drink_list.do-5.html?CATE_CD=product_blended">블렌디드</a></li>
									<li><a href="drink_list.do-6.html?CATE_CD=product_fizzo">스타벅스 피지오</a></li>
									<li><a href="drink_list.do-7.html?CATE_CD=product_tea">티(티바나)</a></li>
									<li><a href="drink_list.do-8.html?CATE_CD=product_etc">기타 제조 음료</a></li>
									<li><a href="drink_list.do-9.html?CATE_CD=product_juice">스타벅스 주스(병음료)</a></li>
								</ul>
							</li>
							<li>
								<a role="button" href="javascript:void(0);">푸드<span class="mob_gnb_arrow_down"></span></a><!-- 접근성_20171106 role 추가 -->
								<ul>
									<li><a href="food_list.do.html">전체보기</a></li>
									<li><a href="food_list.do-1.html?CATE_CD=product_bakery">브레드</a></li>
									<li><a href="food_list.do-2.html?CATE_CD=product_cake">케이크</a></li>
									<li><a href="food_list.do-3.html?CATE_CD=product_sandwich">샌드위치 &amp; 샐러드</a></li>
									<li><a href="food_list.do-4.html?CATE_CD=product_wram_food">따뜻한 푸드</a></li>
									<li><a href="food_list.do-5.html?CATE_CD=product_fruit_yogurt">과일 &amp; 요거트</a></li>
									<li><a href="food_list.do-6.html?CATE_CD=product_snack">스낵 &amp; 미니 디저트</a></li>
									<li><a href="food_list.do-7.html?CATE_CD=product_icecream">아이스크림</a></li>
							...
							<li>
								...
								<ul>
									<li><a href="product_list.do.html">전체보기</a></li>
									<li><a href="product_list.do-1.html?CATE_CD=product_mug">머그</a></li>
									<li><a href="product_list.do-2.html?CATE_CD=product_glass">글라스</a></li>
									<li><a href="product_list.do-3.html?CATE_CD=product_plastic">플라스틱 텀블러</a></li>
									<li><a href="product_list.do-4.html?CATE_CD=product_stainless">스테인리스 텀블러</a></li>
									<li><a href="product_list.do-5.html?CATE_CD=product_vacuum">보온병</a></li>
									<li><a href="product_list.do-6.html?CATE_CD=product_accessories">액세서리</a></li>
									<li><a href="product_list.do-7.html?CATE_CD=product_present">선물세트</a></li>
									<li><a href="product_list.do-8.html?CATE_CD=product_coffee">커피 용품</a></li>
									<li><a href="product_list.do-9.html?CATE_CD=product_teaPackage">패키지 티(티바나)</a></li>
							...
							<li>
								...
								<ul>
									<li><a href="card_list.do.html">전체보기</a></li>
									<li><a href="card_list.do-1.html?CATE_CD=product_offline">실물카드</a></li>
									<li><a href="card_list.do-2.html?CATE_CD=product_egift">e-Gift 카드</a></li>
								</ul>
							</li>
							<!-- <li>
            ...
            <div id="container">
                ...
                <div class="sub_tit_wrap">
                    <div class="sub_tit_inner">
                        ...
                        <ul class="smap">
                            ...
                            <li class="en"><a href="index.do.html" class="this">MENU</a></li>
                        </ul>
                    </div>
                </div>
                <!-- 서브 타이틀 end -->
                ...
                <div class="menuSlideArea">
                    <div class="bxslide-main">
                        ...
                        <div class="menu_slider_control_pager">
                            <div class="menu_slider_controls"></div>
                            <div class="menu_slider_pagers"></div>
                        </div>
                    </div>
                   <!-- 150708 DOM 수정 - 투명한 버튼으로 수정 -->
					<p id="prevBtn">
						<a href="javascript:void(0)" role="button" title="이전 콘텐츠 보기"><!-- 접근성_20171201 role, title 추가 -->
							...
							<img alt="이전" class="arrow_on" src="../common/img/util/mscard_arrow_l_on.png"><!-- 접근성_20171201 alt 추가 -->
						</a>
					</p>
					<p id="nextBtn">
						<a href="javascript:void(0)" role="button" title="다음 콘텐츠 보기"><!-- 접근성_20171201 role, title 추가 -->
							...
							<img alt="다음" class="arrow_on" src="../common/img/util/mscard_arrow_r_on.png"><!-- 접근성_20171201 alt 추가 -->
						</a>
					</p>
					<!-- 150708 DOM 수정 - 투명한 버튼으로 수정 -->
                ...
                <div class="newsArea">
                    ...
                    <div class="newsArea_bg">
                        <div class="newsArea_bgl">
                            ...
                            <p class="btn"><a href="../footer/company/news_list.do.html"><img src="../common/img/coffee/icon_coffee_notice_more.png" alt="보도자료 바로가기"></a></p>
                        </div>
                        <div class="newsArea_bgr">
							...
							<p class="btn"><a href="../util/web_tip.do.html"><img src="../common/img/coffee/icon_coffee_notice_more.png" alt="새로워진 스타벅스 웹사이트 이용안내 바로가기"></a></p>
						</div>
                    </div>
                </div>
                <!-- news end -->
				...
				<div class="menu_drink_section">
					<div class="menu_section_inner">
						...
						<div class="menu_drink_btn01"><a href="drink_list.do.html" title="스타벅스 음료 자세히 보기">자세히 보기</a></div><!-- 접근성_20171201 title 추가 -->
					</div>
				</div>
				<!-- 음료 end -->
				<!-- 푸드 -->
				<div class="menu_food_section">
					<div class="menu_section_inner">
						...
						<div class="menu_food_btn01"><a href="food_list.do.html" title="스타벅스 푸드 자세히 보기">자세히 보기</a></div><!-- 접근성_20171201 title 추가 -->
					</div>
				</div>
				<!-- 푸드 end -->
				<!-- 상품 -->
				<div class="menu_product_section">
					<div class="menu_section_inner">
						...
						<div class="menu_product_btn01"><a href="product_list.do.html" title="스타벅스 상품 자세히 보기">자세히 보기</a><!-- 접근성_20171201 title 추가 --></div>
					</div>
				</div>
				<!-- 상품 end -->
				<!-- 카드 -->
				<div class="menu_card_section">
					<div class="menu_section_inner">
						...
						<div class="menu_card_btn01"><a href="card_list.do.html" title="스타벅스 카드 자세히 보기">자세히 보기</a><!-- 접근성_20171201 title 추가 --></div>
					</div>
				</div>
				<!-- 카드 end -->
				<!-- 온라인 케익 예약 -->
				<div class="menu_reserve_section">
					<div class="menu_section_inner">
						...
						<div class="menu_reserve_btn01"><a href="../wholecake/reserve_cake01.do.html" title="온라인 케익 예약 자세히 보기">자세히 보기</a><!-- 접근성_20171201 title 추가 --></div>
					</div>
				</div>
				<!-- 온라인 케익 예약 end -->
				<!-- 20160905 티바나 관련 추가 -->
				<div class="menu_teavana_section">
					<div class="menu_section_inner">
						...
						<div class="menu_teavana_btn01"><a href="../menuStory/teavana.do.html" title="콜드브루와 티바나 자세히 보기">자세히 보기</a><!-- 접근성_20171201 title 추가 --></div>
					</div>
				</div>
