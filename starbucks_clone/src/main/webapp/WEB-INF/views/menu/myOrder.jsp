...
<title id="titleJoin">음료 | Starbucks Korea</title> <!-- 220117 수정 -->
			...
			<div id="container">
				...
				<div class="content">
					<div class="order_wrap">
						<div class="order_pay">
							<h3>결제수단</h3><br>
							<input type="button" value="스타벅스 카드"><input type="button" value="카카오페이"><br>
						</div>
						<div class="order_coupon&disc">
							<h3>쿠폰 및 할인</h3><br>
							<input type="button" value="쿠폰"><input type="button" value="할인"><br>
						</div>
						<div class="order_cash_receipt">
							<h3>현금 영수증</h3><br>
							<input type="radio" id="person" name="person">개인&nbsp;&nbsp;<input type="radio" value="company">사업자<br>
							<input type="text" id="cash_num" name="cash_num">
						</div>
						<div class="order_orderConfirm">
							<h3>주문내역 확인</h3><br>
							<img src="#">
							<input type="button" value="쿠폰"><input type="button" value="할인"><br>
						</div>
						<div class="order_finalConfirm">
							<h3>최종 결제 금액</h3>	 <label class="">4500</label>
						</div>
						<div class="order_orderbtn">
							<h3>결제화면</h3>
						</div>
					</div>
				</div>
