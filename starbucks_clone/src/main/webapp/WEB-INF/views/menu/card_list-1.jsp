                ...
                <div class="sub_tit_wrap">
                    <div class="sub_tit_inner">
                        ...
                        <ul class="smap">
                            ...
                            <li><img class="arrow" src="common/img/common/icon_arrow.png" alt="하위메뉴"></li>
                            <li><a href="card_list" class="this">카드</a></li>
                        </ul>
                    </div>
                </div>
                <!-- 서브 타이틀 end -->
...
// 					});
        ...
        var dataCnt = 0; // 160928 상세검색 결과 값
            ...
            $(document).ready(function(){
                ...
                __ajaxCall('/menu/productCardListAjax', option , true, "JSON", "POST", 
                function(data) {
...
// 				$('input[type=checkbox]').ezMark();
                ...
                $(document).on('click', 'a.goEgiftView', function() {
                    if (confirm("e-Gift Card 선물하기로 이동하시겠습니까?")) {
                    	...
                    	goWithPostData(arrKeyAndValues, "msr/sceGift/gift_step2"); */
                    	...
                    	__ajaxCall("interface/checkLogin", {}, true, "json", "post"
               				,function (_response) {
	                    		var url  = "msr/sceGift/gift_step2";
            ...
            function showProductList() {
                $('.product_select_wrap input[type=checkbox]').each(function() {
                    ...
                    if(chk_idx == 0) {
                        if(cate_chk_stat) {
                        	if($.trim($('.product_list_card:eq(0) ul')()) != "") {
                                $('.product_list_card:eq(0) ul').show();
                                $('.product_list_card:eq(0)').prev().show();
                        	} else {
                                $('.product_list_card:eq(0) ul').hide();
                            ...
                            if($.trim($('.product_list_card:eq(1) ul')()) != "") {
                                $('.product_list_card:eq(1) ul').show();
                                $('.product_list_card:eq(1)').prev().show();
                            } else {
                                $('.product_list_card:eq(1) ul').hide();
                        ...
                        if(cate_chk_stat) {
                            if( $.trim($('.product_list_card').eq(chk_idx - 1).find('ul')()) != "" ) {
