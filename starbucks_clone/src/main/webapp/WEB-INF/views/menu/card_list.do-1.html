            ...
            <div id="container">
                ...
                <div class="sub_tit_wrap">
                    <div class="sub_tit_inner">
                        <h2><img src="../common/img/menu/menu_tit5.jpg" alt="카드"></h2>
                        <ul class="smap">
                            ...
                            <li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
                            <li><a href="card_list.do.html" class="this">카드</a></li>
                        </ul>
                    </div>
                </div>
                <!-- 서브 타이틀 end -->
                <div class="content">
					...
					<div class="product_kind_wrap">
						<p class="tit">분류 보기</p>
						<div class="product_kind_btn"><a href="javascript:void(0)"><img src="../common/img/menu/list_up_btn.png" alt=""></a></div>
						<div class="product_toggle_wrap">
							<dl class="product_kind_tab card_product_kind_tab">
                                <dt class="dt1"><a href="javascript:void(0)" id="categoryTab" class="selected">카테고리</a></dt>
								<dd>
										...
										<form action="" method="post">
											<fieldset>
												...
												<ul class="cate_list"><!-- jsp 수정 : class 추가 -->
													...
													<li><input type="checkbox" name="product_offline" id="product_offline"> <label for="product_offline">실물카드</label></li>
													<li><input type="checkbox" name="product_egift" id="product_egift"> <label for="product_egift">e-Gift 카드</label></li>
												</ul>
											</fieldset>
										</form>
									</div>
								</dd>
								<dt class="dt2"><a href="javascript:void(0)" id="themeTab" style='cursor:default;'>테마</a></dt><!-- 150819 성연욱 수정 -->
								<dd>
									<ul class="service_bn">
                                                        ...
                                                        <li><a href="javascript:void(0);" egift_img_catg_code="01"><img src="../upload/banner/themebnr/card_bn01.png" alt="축하" style="width: 335px; height: 90px"></a></li>
                                                        ...
                                                        <li><a href="javascript:void(0);" egift_img_catg_code="02"><img src="../upload/banner/themebnr/card_bn02.png" alt="응원" style="width: 335px; height: 90px"></a></li>
                                                        ...
                                                        <li><a href="javascript:void(0);" egift_img_catg_code="03"><img src="../upload/banner/themebnr/card_bn03.png" alt="감사" style="width: 335px; height: 90px"></a></li>
                                                        ...
                                                        <li><a href="javascript:void(0);" egift_img_catg_code="04"><img src="../upload/banner/themebnr/card_bn04.png" alt="Coffee Favorite" style="width: 335px; height: 90px"></a></li>
                                                        ...
                                                        <li><a href="javascript:void(0);" egift_img_catg_code="05"><img src="../upload/banner/themebnr/card_bn05.png" alt="사랑" style="width: 335px; height: 90px"></a></li>
                                                        ...
                                                        <li><a href="javascript:void(0);" egift_img_catg_code="06"><img src="../upload/banner/themebnr/card_bn06.png" alt="시즌" style="width: 335px; height: 90px"></a></li>
                    ...
                    <div class="product_result_wrap product_result_wrap01">
                        <div class="product_view_tab_wrap">
                            <dl class="product_view_tab product_view_tab01">
                                ...
                                <dd>
                                    <h3>실물카드</h3>
                                    <div class="product_list product_list_card">
                                        <dl>
                                            <dd>
                                                <ul class="product_offline">
                                                </ul>
                                            </dd>
                                        </dl>
                                    </div>
...
// 					});
            ...
            <form name="cardListForm" method="get">
        ...
        var dataCnt = 0; // 160928 상세검색 결과 값
            ...
            $(document).ready(function(){
            	...
            	$('dl.product_kind_tab > dt > a').bind('click', function(){
            		...
            		var nIdx = $('dl.product_kind_tab > dt > a').index(this);
            		if (nIdx == 0) {
            			$("#card_cf_select_wrap").show();
                        $('.product_list_card:eq(0)').prev().show();
            			$('.product_list_card:eq(0) ul').show();
                        $('.product_list_card:eq(1)').prev().show();
            			$('.product_list_card:eq(1) ul').show();
                        //$('.product_list_card:eq(2)').prev().hide();
            			$('.product_list_card:eq(2) ul').hide();
            		} else {
            			$("#card_cf_select_wrap").hide();
                        $('.product_list_card:eq(0)').prev().hide();
            			$('.product_list_card:eq(0) ul').hide();
                        $('.product_list_card:eq(1)').prev().hide();
            			$('.product_list_card:eq(1) ul').hide();
                        //$('.product_list_card:eq(2)').prev().show();
            			$('.product_list_card:eq(2) ul').show();
            		}
                ...
                __ajaxCall('/menu/productCardListAjax.do', option , true, "JSON", "POST", 
                function(data) {
                    if(data.list.length > 0) {
                        $('.product_list > dl > dd > ul').eq(0).empty('');
                        $('#tpl_cardList').tmpl(data.list).appendTo($('.product_list_card:eq(0) ul'));
                        
                        $('a.goCardView').unbind('click').bind('click', function() {
                            seq = $(this).attr('seq');
                            f = document.cardListForm;
                            f.action = "/menu/card_view.do";
                            f.seq.value = ~~seq;
                            f.submit();
                        });
                    } else {
                ...
                function(data) {
                    if(data.list.length > 0) {
                        $('.product_list > dl > dd > ul').eq(1).empty('');
                        $('#tpl_cardList2').tmpl(data.list).appendTo($('.product_list_card:eq(1) ul'));
                    } else {
                    	$('.product_list_card:eq(1)').prev().hide();
                    	$('.product_list_card:eq(1) ul').hide();
                    }
                ...
                $('ul.cate_list, ul.service_bn').mCustomScrollbar();
                
	            $("#card_cf_select_wrap .opt").hide();
	
				//셀렉트바를 클릭했을 때
				$("#card_cf_select_wrap .select, #card_cf_select_wrap p span").bind("click",function(){
		           $("#card_cf_select_wrap .opt").toggle();
				})
	
				 //마우스가 셀렉트 영역을 벗어났을 때
				$("#card_cf_select_wrap").bind("mouseleave",function(){
				   $("#card_cf_select_wrap .opt").hide();
				})
					
	
				  //옵션 목차를 클릭했을 때
				$("#card_cf_select_wrap .opt label").bind("click",function(e){
...
// 				$('input[type=checkbox]').ezMark();
                    ...
                    $('.cate_list input[type=checkbox]').each(function() {
                        if($(this).is(':checked')) {
                            if($(this).attr('id') == "product_all") {
                                showMenuDetail(chkTmp, "product_offline");
                                showMenuDetail(chkTmp, "product_egift");
                            } else {
                ...
                //[160728] 카드 클릭 시, 선물하기 페이지로 이동시킴
                $(document).on('click', 'a.goEgiftView', function() {
                    if (confirm("e-Gift Card 선물하기로 이동하시겠습니까?")) {
                    	/* var arrKeyAndValues = new Array(
                    		 { "KEY" : "egiftImgMngSeq" ,"VALUE" : $(this).data("egiftimgmngseq") }
                    		,{ "KEY" : "cardImgUrl"     ,"VALUE" : $(this).data("cardimgurl")     }
                    		,{ "KEY" : "cardName"       ,"VALUE" : $(this).data("cardname")       }
                    	);

                    	goWithPostData(arrKeyAndValues, "/msr/sceGift/gift_step2.do"); */
                    	
                    	var egiftImgMngSeq = $(this).data("egiftimgmngseq");
                    	var cardImgUrl     = $(this).find("img").attr("src");
                    	var cardName       = $(this).data("cardname");
                    	
                    	__ajaxCall("/interface/checkLogin.do", {}, true, "json", "post"
               				,function (_response) {
	                    		var url  = "/msr/sceGift/gift_step2.do";
		                    		url += "?egiftImgMngSeq=" + encodeURIComponent( egiftImgMngSeq );
		                    		url += "&cardImgUrl=" + encodeURIComponent( cardImgUrl );
		                    		
		                    		url += "&cardName=" + encodeURIComponent(encodeURIComponent( cardName ));
              	...
              	//[160728] 테마 별 카드 리스트 획득
                $('.service_bn a').on("click", function() {

                    var cateCd = $(this).attr('egift_img_catg_code');
                    var href = $(this).attr('href');

                    // 노출유형 '없음' 처리
                    if(typeof cateCd == "undefined" && href == "javascript:void(0);"){
                        return false;
                    }
                	...
                	var option = {
                           EGIFT_CARD_YN       : "Y" 
                          ,SOLD_OUT            : ''
                          ,EGIFT_IMG_CATG_CODE : cateCd
                    };
                	
                    __ajaxCall('/menu/productCardListAjax.do', option , true, "JSON", "POST", 
	                    function(data) {
	                        if(data.list.length > 0) {
	                            $('.product_list > dl > dd > ul').eq(2).empty();
	                            $('#tpl_cardList2').tmpl(data.list).appendTo($('.product_list_card:eq(2) ul'));
	                        } else {
	                        	//$('.product_list_card:eq(2)').prev().hide();
	                        	$('.product_list_card:eq(2) ul').hide();
	                        }
                ...
                $('.service_bn a').eq(0).trigger("click");
            	//$('.product_list_card:eq(2)').prev().hide();
                $('.product_list_card:eq(2) ul').hide();
            ...
            function showProductList() {
                $('.product_select_wrap input[type=checkbox]').each(function() {
                    ...
                    if(chk_idx == 0) {
                        if(cate_chk_stat) {
                        	if($.trim($('.product_list_card:eq(0) ul').html()) != "") {
                                $('.product_list_card:eq(0) ul').show();
                                $('.product_list_card:eq(0)').prev().show();
                        	} else {
                                $('.product_list_card:eq(0) ul').hide();
                            ...
                            if($.trim($('.product_list_card:eq(1) ul').html()) != "") {
                                $('.product_list_card:eq(1) ul').show();
                                $('.product_list_card:eq(1)').prev().show();
                            } else {
                                $('.product_list_card:eq(1) ul').hide();
                        ...
                        if(cate_chk_stat) {
                            if( $.trim($('.product_list_card').eq(chk_idx - 1).find('ul').html()) != "" ) {
                                $('.product_list_card').eq(chk_idx - 1).find('ul').show();
                                $('.product_list_card').eq(chk_idx - 1).prev().show();
                            }
                        } else {
                            $('.product_list_card').eq(chk_idx - 1).find('ul').hide();
                            $('.product_list_card').eq(chk_idx - 1).prev().hide();
                        }
                    }
                });
            }
            ...
            function showMenuDetail(chkTmp, cls) {
                ...
                if(showChk) {
                	$sel.children('.menuDataSet').parent().parent().parent().parent().prev().show();
                } else {
                	$sel.children('.menuDataSet').parent().parent().parent().parent().prev().hide();
                }
            }
        </script>
        <script type="text/x-jquery-tmpl" id="tpl_cardList">
            <li class="menuDataSet" new="${newicon}" sell="${sell_CAT}" recomm="${recomm}">
                <dl>
                    <dt>
                        <a href="javascript:void(0)" class="goCardView" seq="${msr_SEQ}"><img src="${img_UPLOAD_PATH}${web_IMAGE_WEBVIEW}" alt="${product_NM}" onerror="this.src='https://image.istarbucks.co.kr/upload/common/img/icon/card_672x423.png';" /></a>
                        {{if newicon == 'Y' || sell_CAT == 'B' || recomm != '0' || sold_OUT == 'Y'}}
                        <ul>
                            {{if newicon == 'Y'}}
        ...
        <script type="text/x-jquery-tmpl" id="tpl_cardList2">
            <li class="menuDataSet" new="${newicon}" sell="${sell_CAT}" recomm="${recomm}">
                <dl>
                    <dt>
                        <a href="javascript:void(0)" class="goEgiftView" data-egiftImgMngSeq="${product_CD}" data-cardName="${product_NM}"><img src="${img_UPLOAD_PATH}${web_IMAGE_WEBVIEW}" alt="${product_NM}" onerror="this.src='https://image.istarbucks.co.kr/upload/common/img/icon/card_672x423.png';" /></a>
                    </dt>
                    <dd>${product_NM}</dd>
                </dl>
            </li>
