			...
			<div id="top_MSR" class="eFreqTop"><!-- 20170510 수정 : 클래스 eFreqTop 추가 -->
				<div class="top_msr_wrap" style="">
					...
					<div class="msr_card_zone m_card_pic">
						...
						<div class="mycard_one" style="transform: rotateY(-337.853deg);">
							<!-- <div class="front"> -->
...
<!-- 150902 DOM 수정 -->
<div class="only_my_dimm" style="display: block;" aria-hidden="true" tabindex="0"></div>
<div class="only_my_drink" style="display: block;" role="dialog" aria-hidden="false" tabindex="0"><!-- 접근성_20171123 role, aria 추가 -->
	...
	<!-- Step 2 -->
	<div class="only_my_cont my_drink_step2" style="">
		<dl class="my_sel_drink">
			<dt><img alt="" class="skuImgUrl" src="https://image.istarbucks.co.kr/skuImg/[9200000002487]_20210426091744949.jpg"></dt>
			<dd>
				<p class="t1">나이트로 바닐라 크림<br><span>Nitro Vanilla Cream</span></p>
				<div class="select_box">
					<label for="delegateHotYn" class="a11y">Iced</label><!-- 접근성_20171123 label, class 값 변경 -->
		...
		<div class="personal_opt">
			<div class="select_box">
				<label for="delegateSize" class="a11y">Short / 237ml(8fl oz)</label><!-- 접근성_20171123 label, class 값 변경 -->
				<select id="delegateSize"><option value="10" data-skuno="9200000002486">Short / 237ml(8fl oz)</option><option value="20" data-skuno="9200000002487">Tall / 355ml(12fl oz)</option><option value="30" data-skuno="9200000002488">Grande / 473ml(16fl oz)</option></select>
			</div>
			<div class="select_box">
				<label class="a11y" for="cupType">일회용컵</label><!-- 접근성_20171123 label, class 값 변경 -->
				<select title="컵 구분" id="cupType"><option value="1">일회용컵</option><option value="0">머그컵</option><option value="2">개인컵</option></select>
			</div>
			<p class="btn_ps_opt" style="display: block;"><a href="javascript:void(0)" role="button">퍼스널 옵션&nbsp;&nbsp;<!-- 접근성_20171123 role 추가 --><img src="common/img/menu/ps_opt_arrow.png" alt=""></a></p>
		</div>
		<ul class="btn_list">
	...
	<!-- 퍼스널 옵션 설정 영역 -->
	<div class="only_my_tit personal_option_detail">
		<p class="tt">퍼스널 옵션</p>
...
<!-- Step 3 -->
<!-- 150915 구명준 -->
<div class="only_my_drink2" style="display:none;" role="dialog" aria-hidden="true" tabindex="0"><!-- 접근성_20171123 role, aria 추가 -->
	<div class="only_my_head">
