...
<ul>
	...
	<!-- 							<tr>
									<td>10</td>
									<td class="t_left"><a href="privacy_board_view.html">스타벅스 코리아 홈페이지 회원 개인정보 이용내역 발송을 위한 고객정보 제공</a></td>
									<td>마케팅팀</td>
...
// 					});
		...
		<script>
			...
			function pageView2(seq){
				...
				$("#menu_cd").val("STB2711");
				document.viewFrm.action = "/footer/etc/privacy_board_view.do";
				document.viewFrm.submit();
			}
			
			function getList(par){
				
				__ajaxCall("/footer/etc/getPrivacy_board_list.do", par, true, "json", "post",
						function(data){
