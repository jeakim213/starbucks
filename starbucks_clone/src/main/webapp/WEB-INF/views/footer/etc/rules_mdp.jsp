					...
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							...
							<ul class="smap">
								...
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="rules_mdp">My DT Pass 서비스 이용약관</a></li> <!-- 20200914 mdp 수정 -->
							</ul>
						</div>
					</div>
				</header>
						...
						<div class="privacy_select_wrap">
							<form action="form">
								<div class="select_box">
									...
									<select title="이전 MDP 이용약관 보기" id="use_term_select" name="jump"><option value="">이전 MDP 이용약관 보기</option></select>
								</div>
							</form>
						</div>
...
<div class="privacy_cont">
	<p class="tit">My DT(Drive Thru) Pass 서비스 이용약관</p>

	<p class="sub_tit">1. 목적</p>
	<p class="mb40">본 약관은 스타벅스 코리아를 운영하는 주식회사 에스씨케이컴퍼니(이하 “회사”라 합니다)의 Drive thru 매장 (이하 “DT매장”)에서 제공하는 서비스를 이용함에 있어 필요한 조건, 절차 및 당사자간의 권리, 의무 등 기본적인 사항을 규정하는 것을 목적으로 합니다.</p>

	<p class="sub_tit">2. 용어의 정의</p>
	<ol class="pri_con mb40">
		<li>가. “고객” 이란 본 약관에 동의하고 “회사”와 서비스이용계약을 체결하고 “회사”의 “DT매장”을 이용하며 “회사”가 제공하는 “서비스”를 이용하는 자를 말합니다.</li>
		<li>나. ‘My DT Pass 서비스’(이하’ ‘서비스’)란 회원이 회사의 모바일 어플리케이션 및 홈페이지를 통해 차량번호와 자동 결제수단을 등록하면, Drive Thru 매장(이하 “DT매장”) 진입 시 고객을 자동으로 인식하여 별도의 결제수단을 제공하지 않아도 기 등록된 고객의 대표 Starbucks card 또는 신용/체크카드로 자동 결제할 수 있도록 하여 보다 빠르고 편리하게 DT매장을 이용할 수 있도록 회사가 제공하는 관련 서비스를 말합니다.</li>
		<li>다. ‘MDP 신용카드 자동결제’ 서비스란, 고객이 본인의 신용/체크 카드를 스타벅스 어플리케이션 내에서 제공되는 삼성카드의 간편 결제 플랫폼에 사전에 등록하여, My DT Pass를 신용/체크 카드를 직접 제시하지 않고도 등록된 자동 결제수단으로 이용할 수 있게 하는 서비스를 말합니다. </li>
		<li>라. 서비스 운영방침은 회사의 정책변경 등 따라 변경될 수 있으며, 상세 내용은 홈페이지 및 모바일 App을 통하여 사전에 안내드립니다.</li>
	</ol>

	<p class="sub_tit">3. 적용의 범위</p>
	<ol class="pri_con mb40">
		<li>가. 본 약관은 서비스를 이용하고자 하는 모든 고객에게 적용됩니다.</li>
		<li>나. 본 약관의 내용은 서비스 화면에 게시하거나 기타의 방법으로 이용자에게 공지되고, 이에 동의한 이용자가 서비스를 이용할 때 효력이 발생합니다.</li>
		<li>다. 회사는 경영환경의 변화 또는 영업정책에 따라 본 약관의 일부를 변경할 수 있으며 변경된 약관은 고객에게 화면을 통한 안내 등의 방법으로 공지함으로써 변경에 대한 효력이 발생합니다.</li>
		<li>라. 변경된 약관에 동의하지 않는 고객은 회사에 “서비스” 이용 중단을 요청하거나 직접 회사의 모바일 어플리케이션 및 홈페이지를 통해 서비스를 중단시킬 수 있습니다.</li>
		<li>마. 약관 변경의 경우, 약관 변경 발효일까지 별도의 거부 의사를 표시하지 않으면 약관의 변경에 동의한 것으로 간주한다는 내용을 공지 또는 통지하였음에도 불구하고 이용자가 명시적으로 약관 변경에 대한 거부 의사를 표시하지 않을 경우 변경 약관에 동의한 것으로 간주합니다.</li>
		<li>바. 회사는 약관을 변경할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 홈페이지 및 모바일 App에 그 적용일의 7일전부터 공시합니다. 다만, 고객에게 불리한 내용으로 약관을 개정하는 경우에는 적용일로부터 30일전까지 공시하고, 변경된 약관은 공시하거나 고지된 적용일부터 효력이 발생합니다.</li>
	</ol>

	<p class="sub_tit">4. 서비스 이용에 대한 총칙</p>
	<ol class="pri_con mb40">
		<li>
			가. 이용의 제한
			<ol>
				<li>① ‘My DT Pass’ 서비스는 WEB회원, SR회원이 이용할 수 있으며, 차량번호 및 결제수단을 등록한 경우에 한하여 서비스를 제공받을 수 있습니다.</li>
				<li>② My DT Pass 서비스는 고객당 2대의 차량 번호 등록이 가능합니다.</li>
				<li>③ My DT Pass를 신용/체크 카드로 이용 시, 본인 명의의 신용/체크 카드만 등록이 가능합니다. </li>
				<li>④ 회사는 다음 각 호에 해당하는 경우 이용자에게 My DT Pass 사용을 제한하거나 중단할 수 있습니다.
					<ol>
						<li>(ㄱ) 설비의 장애 및 보수, 정전, 천재지변, 이용량 폭주 등 기술상의 문제 또는 불가항력적인 사유로 서비스를 제공할 수 없는 경우</li>
						<li>(ㄴ) 이용자가 타인의 개인 정보 및 차량번호 등으로 서비스를 이용하는 경우</li>
						<li>(ㄷ) 회사의 서비스 정책 또는 본 이용약관을 위반하여 서비스를 이용하는 경우</li>
						<li>(ㄹ) 서비스 시스템을 무단으로 침범하거나 이용자의 고의 및 과실로 인해 본래의 이용 목적이나 비정상적인 방법으로 이용하는 경우 </li>
						<li>(ㅁ) 기타 회사가 정한 요건을 충족하지 않은 경우</li>
						<li>(ㅂ) 여신전문금융업법 등 관계 법령을 위반하여 불법적 환전 및 대출 등을 목적으로 한 비정상적인 거래행위 및 이러한 사용으로 의심되는 경우</li>
						<li>(ㅅ) 회사의 정당한 영업 행위를 상당히 방해하는 거래행위 또는 서비스의 오•남용의 경우</li>
					</ol>
				</li>
				<li>⑤ 본 조에 따라 서비스 제한이나 중단이 있을 때에는 회사는 최대한 신속하게 이용자에게 해당 내용을 통지합니다. 다만, 회사가 통제할 수 없는 사유로 서비스가 중단(회사의 고의, 과실이 없는 디스크 장애, 시스템 다운 등)되는 등 미리 통지할 수 없는 불가피한 상황이 발생했을 때에는 이러한 상황이 종료된 후 합리적인 기한 내에 통지할 수 있습니다.</li>
			</ol>
		</li>
		<li>
			나. 고객에 대한 통지
			<ol>
				<li>① 회사는 고객의 서비스 이용에 필요한 권리와 의무 등에 관한 사항을 고객이 지정한 이메일(E-mail), 문자메시지(SMS), 애플리케이션 알림(PUSH) 등으로 통지할 수 있습니다.</li>
				<li>② 회사가 불특정 다수 고객에게 통지할 때는 홈페이지 및 애플리케이션에 게시하는 것으로 개별 통지를 대체할 수 있습니다.</li>
				<li>③ 회사는 고객이 ‘My DT Pass’ 이용 시 다음 사항을 표시합니다.
					<ol>
						<li>(ㄱ) My DT Pass 거래 구분 (영수증)</li>
						<li>(ㄴ) My DT Pass 결제 여부 (애플리케이션 알림(PUSH))</li>
					</ol>
				</li>
			</ol>
		</li>
		<li>
			다. 서비스의 이용시간
			<ol>
				<li>① 서비스의 이용은 고객이 이용하는 “DT 매장”의 “Drive Thru 영업시간”을 원칙으로 하며, 각 매장별 “Drive Thru” 영업시간은 상이할 수 있으니, 보다 자세한 사항은 회사의 홈페이지를 참고하시기 바랍니다.</li>
				<li>② 서비스는 회사의 업무나 기술상의 이유로 서비스가 일시 중지될 수 있고, 운영상의 목적으로 회사가 정한 기간에는 서비스가 일시 중지될 수 있습니다. 이와 관련하여 회사는 해당 내용을 사전에 공지하며, 합리적인 사유가 있는 경우에는 사후에 통보할 수 있습니다.</li>
				<li>③ 회사는 서비스를 My DT Pass 운영에 따라 이용할 수 있는 시간을 정할 수 있으며, 이 경우 그 내용을 회사의 홈페이지 또는 모바일 어플리케이션에 공지합니다.</li>
			</ol>
		</li>
		<li>
			라. 고객의 의무
			<ol>
				<li>① 고객은 본인이 소유하거나 사용하고 있는 차량번호를 사실에 부합하고, 관련 정보를 정확히 등록하여야 합니다. </li>
				<li>② 등록된 차량번호에 대하여 다른 고객으로부터 중복 등록요청(이하 “중복등록”)이 있을 경우 회사는 고객에게 본인 소유 차량임을 확인할 수 있는 자료 등을 요청할 수 있고, 고객은 합리적인 사유가 없는 한 이에 응하여야 합니다.</li>
				<li>③ 회사는 상기 중복 등록 발견 시 고객이 전항에 따른 자료를 제출하지 않거나 중복등록의 문제가 해결되지 않는 경우, 서비스 사용을 합리적인 기간 동안 제한하거나 영구히 중단할 수 있습니다. 단, 잘못된 정보가 정정되거나 본인 소유의 차량임이 확인되는 등 등록 오류가 시정되면 회사는 서비스를 다시 제공합니다.</li>
			</ol>
		</li>
		<li>
			마. 회사의 면책
			<ol>
				<li>① 회사는 다음 각 호에서 예시하는 바와 같이 고객이 불법 또는 부정한 방법으로 서비스를 이용하거나 고객의 과실로 인하여 고객 상호 간 또는 고객과 제3자 간에 분쟁이 발생하였을 때 이에 어떠한 책임도 부담하지 아니하며 회사에 직간접 손해가 발생하는 경우에는 고객이 일체의 책임을 부담하고, 회사를 면책시켜야 합니다.
					<ol>
						<li>(ㄱ) 고객이 차량 번호를 잘못 등록하는 경우</li>
						<li>(ㄴ) 고객의 등록된 차량 정보의 오류로 고객 정보 누출 및 손해가 발생한 경우</li>
						<li>(ㄷ) 소유주 변경 후 적시에 관련 정보 수정을 하지 않아 거래상 오류가 발생하거나 회사 또는 제3자에게 손해가 발생한 경우</li>
						<li>(ㄹ) 상기 열거된 예시 외에도 동항으로 인하여 회사 또는 제3자에게 손해가 발생한 경우</li>
					</ol>
				</li>
				<li>② 회사는 상기 사항 외에도 고객의 귀책사유로 인한 서비스의 이용 장애에 대하여는 책임을 부담하지 않습니다.</li>
				<li>③ 회사는 천재지변 또는 불가항력으로 인하여 사실상 서비스를 제공할 수 없는 경우에는 서비스 관련하여 책임이 면제됩니다.</li>
				<li>④ 기타 회사가 정상적으로 서비스를 제공하여, 이행책임을 다하였다면 고객 및 제3자 간 민•형사상의 책임은 고객이 부담하여야 합니다.</li>
				<li>⑤ My DT Pass에 등록된 차량 및 결제 정보의 삭제와 이용 해지 등의 관리 책임 과 당해 의무는 고객에게 있습니다. 따라서, 부정확한 정보 삭제 및 이용 해지를 적시 이행하지 않은 상태에서 고객이 등록한 차량을 타 고객이 사용하여 발생하는 금전적 손실 등에 대한 책임은 고객에게 있습니다.</li><li>
				</li><li>⑥ 고객이 등록한 차량이 타 고객의 차량으로 확인될 경우, 본인이 등록한 차량 정보는 자동 삭제될 수 있습니다. </li>
				<li>⑦ 등록된 차량번호 정보 및 차량번호판 사진은 주문 및 결제 서비스 등의 원활한 제공 및 서비스 개선 등을 목적으로 회사의 관련시스템에 보관 및 이용될 수 있습니다. </li>
			</ol>
		</li>
	</ol>

	<p class="sub_tit">5. 약관 및 손해배상</p>
	<p class="mb40">
		본 약관에 명시되지 않은 사항은 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’, ‘전기통신기본법’, ‘전기통신사업법’ 및 기타 관련 법령의 규정에 의합니다.
		<br>
		회사는 또한 ‘약관의 규제 등에 관한 법률’, ‘전자거래기본법’, ‘전자서명법’, ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’에 따릅니다.
		<br>
		이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 정부가 제정한 ‘전자거래 소비자보호지침’ 및 관계법령 또는 전자상거래 상 관례에 따릅니다.
		<br>
		회사는 천재지변 기타 불가항력으로 인하여 서비스를 제공할 수 없거나 회사의 귀책사유가 없는 경우에는 책임을 부담하지 않습니다. 또한 회사는 서비스 이용과 관련하여 고객의 고의 또는 과실로 인하여 발생한 손해에 관하여도 책임을 지지 않습니다. 만일 서비스 이용으로 발생한 분쟁에 대하여 소송이 제기될 경우 회사의 주사무소 소재지를 관할하는 법원을 관할법원으로 합니다.
	</p>
...
$(document).ready(function(){
	...
	$("#use_term_select")("<option value=''>이전 MDP 이용약관 보기</option>");
