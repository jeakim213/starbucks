			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="이용약관" src="../../common/img/footer/etc/tit_mdp.png"></h4> <!-- 20200914 mdp 수정 -->
							<ul class="smap">
								...
								<li><img class="arrow" src="../../common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="rules_mdp.do.html">My DT Pass 서비스 이용약관</a></li> <!-- 20200914 mdp 수정 -->
							</ul>
						</div>
					</div>
				</header>
				...
				<div class="ms_cont_wrap">
					<div class="ms_cont">
						<div class="privacy_select_wrap">
							<form action="form">
								<div class="select_box">
									<label class="value" for="use_term_select">이전 MDP 이용약관 보기</label>
									<select title="이전 MDP 이용약관 보기" id="use_term_select" name="jump">
									</select>
								</div>
							</form>
						</div>
						...
						<!-- 202101 수정 -->
						<div class="mdp_text" id="mdp_text">
						</div>
					</div>
...
$(document).ready(function(){
	...
	// 약관 불러오기
	var clauseType = "STB4003";
	$("#use_term_select").html("<option value=''>이전 MDP 이용약관 보기</option>");
	setClause("use_term_select", "mdp_text", clauseType);
