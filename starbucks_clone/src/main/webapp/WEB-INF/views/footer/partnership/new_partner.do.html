					...
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							...
							<ul class="smap">
								...
								<li><a href="new_partner.do.html"><span class="en">PARTNERSHIP</span></a></li>
								<li><img class="arrow" src="../../common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="new_partner.do.html">신규 입점 제의</a></li>
							</ul>
						</div>
					</div>
				</header>
...
<nav class="ms_nav" id="msRnb">
	<ul>
		<li class="msRnb_btn">
			<a href="new_partner.do.html">신규 입점 제의</a>
		</li>
		<li class="msRnb_btn">
			<!-- <a href="/footer/partnership/portal_systems.do">협력사 포털 시스템</a> -->
			<a href="/srm/login.do">협력 고객사 등록신청</a>
		</li>
	</ul>
</nav>
					<!-- //네비 -->
			...
			<footer id="footer"> 
				...
				<aside class="copyright">
					...
					<a class="btned_link" href="new_partner.do.html">신규입점제의</a>
