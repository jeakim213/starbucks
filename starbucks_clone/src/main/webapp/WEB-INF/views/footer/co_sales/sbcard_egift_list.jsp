                ...
                <div class="ms_sub_tit_bg">
                    <div class="co_sales_ttl_inner">
                        ...
                        <ul class="smap">
                            ...
                            <li><a href="index.do.html"><span class="en">CORPORATE SALES</span></a></li>
                            <li><img class="arrow" src="../../common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
                            <li><a href="sbcard_egift.do.html"><span class="kor">스타벅스 e-Gift Card</span></a></li>
                        </ul>
                    </div>
                </div>
            </header>
            ...
            <div class="ms_cont_wrap">
                ...
                <div class="ms_cont">
                    ...
                    <div class="cosales_help_btns">
                        ...
                        <a class="cosales_help_btn2" href="../../community/faq.do-2.html?menu_cd=STB2703&cate=F22">자주하는 질문</a>
                    </div>
                    ...
                    <form id="frmUpload" method="post" enctype="multipart/form-data">
                        ...
                        <section class="sbcard_egift_wrap">
                                    ...
                                    <section class="e-gift_type1 e-gift_type">
                                        <dl>
                                            ...
                                            <dd>
                                                <ul class="excel_upload_dotlist">
                                                    <li>스타벅스 e-Gift Card는 회원가입 없이도 즉시 사용할 수 있습니다.</li>
                                                    <li>스타벅스 회원이라면 <a class="add_card_btn" href="../../my/mycard_info_input.do.html">[카드 등록]</a>후, 더욱 편리하게 사용하세요.</li>
                                                </ul>
                                                <ul class="e-gift_use">
                                                    <li>
                                                        <dl class="use_01">
                            ...
                            <h5 class="sbcard_buy_regi">
                                <a href="sbcard_egift.do.html" required="login">스타벅스 e-Gift Card 구매 신청</a>
                            </h5>
                            <article>
                            </article>
                            <h5 class="sbcard_buy_list">
                                <a href="sbcard_egift.do.html" required="login">스타벅스 e-Gift Card 구매 내역</a>
                            </h5>
                            <article>
                            </article>
                        </section>
                ...
                <nav class="ms_nav" id="msRnb">
                    <ul>
                        <li><a href="index.do.html">단체 및 기업 구매 안내</a></li>
                        <!-- <li><a href="/footer/co_sales/sbcard_egift.do">스타벅스 e-Gift Card</a></li> -->
                        <!-- <li><a required="login" href="/footer/co_sales/sbcard.do">스타벅스 카드</a></li> -->
                        <!-- <li><a href="/footer/co_sales/co-branded.do">스타벅스 Co-branded 카드</a></li> -->
                        <!-- <li><a required="login" href="/footer/co_sales/sb_product.do">스타벅스 상품</a></li> -->
                        <!-- <li><a required="login" href="/footer/co_sales/sbgift_certificate.do">스타벅스 상품권</a></li> -->
                    </ul>
                </nav>
            </div>
            <!-- 내용 end -->
...
$.phoneCertLib = {
                ...
                $(".btn_pre_regi a").on("click", function () {
                    if ($.phoneCertLib.getPhoneNumber() == "") {
                        if (confirm("보내는 사람의 전화번호는 개인정보확인 및 수정 페이지에서 등록 가능합니다.\n바로 이동 하시겠습니까?")) {
                            location.href = "/my/myinfo_modify_login.do";
                        }
                    }
            ...
            if ($(".phone_cert_step_1").is(":visible")) {   // 인증 1단계인가?
                ...
                if ($.phoneCertLib.certInfo.isCert) {   // 인증 되어 있으면 완료 처리..
                    if ($.phoneCertLib.param.phone_type == "H") {   // 휴대전화인가?
                        $.phoneCertLib.doCompletePhoneCert();
                    } else {
                        //$.phoneCertLib.doCompletePhoneCertTypeTel();
                        if (confirm(cfmMsg)) {
                            $.phoneCertLib.hideLayerPhoneCert();
                        }
                    }
        ...
        switch ($.phoneCertLib.getContentType()) {
            case "MYINFO_MODIFY":
                ...
                if ( !change_phone_mask ) {
                    ___ajaxCall("/interface/updateMemberChangeInfo.do", {}, false, "json", "post", function (_response) {
    ...
    ,showLayerPhoneCert : function () {
        ...
        if ($.phoneCertLib.getContentType() == "SBCARD_EGIFT") { //b2b 페이지
            ...
            if($.phoneCertLib.certInfo.isCert || $.phoneCertLib.certInfoTel.isCert){ //핸드폰번호 or 유선전화번호 하나라도 인증 되어있으면 문구 변경
                $(".phone_cert_step_1 span.txt_change").html( "추가 인증하는 연락처로 " );
            } else {
                $(".phone_cert_step_1 span.txt_change").html( "" );
            }
    ...
    ,getCurrentUserId : function () {
        ___ajaxCall("/interface/getCurrentUserId.do", {}, false, "json", "post"
            ,function (_response) {
                if (_response.result_code == "SUCCESS") {
    ...
    ,getCurrentUserPhone : function () {
        ...
        ___ajaxCall("/interface/getCurrentUserPhone.do", {}, false, "json", "post"
            ,function (_response) {
                if (_response.result_code == "SUCCESS") {
    ...
    ,getCurrentPhoneCertInfo : function (_phoneType) {
        ...
        ___ajaxCall("/interface/getCurrentPhoneCertInfo.do", objParam, false, "json", "post"
            ,function (_response) {
                if (_response.result_code == "SUCCESS") {
    ...
    ,callPhoneCert : function () {
        ...
        var url = "/interface/callPhoneCert.do";
        /*
        if (location.href.indexOf("dev") > -1) {
            url = "/interface/getTestXml.do";
        }
        */
...
//                      $.phoneCertLib.setPhoneCertCallLog();
    ...
    /* ,setPhoneCertCallLog : function () {
        ___ajaxCall("/interface/setPhoneCertCallLog.do", $.phoneCertLib.param, false, "json", "post"
            ,function (_response) {
                if (_response.result_code == "SUCCESS") {
                    $(".phone_cert_step_1 , .phone_cert_info").hide();
                    $(".phone_cert_step_2").show();
    ...
    ,doCompletePhoneCert : function () {
        ___ajaxCall("/interface/getPhoneCertResult.do", $.phoneCertLib.param, false, "json", "post"
            ,function (_response) {
                if (_response.result_code == "SUCCESS") {
    ...
    ,doCompletePhoneCertTypeTel : function () {
        ...
        ___ajaxCall("/interface/setPhoneCertResponseLogTel.do", objParam, false, "json", "post"
            ,function (_response) {
                if (_response.result_code == "SUCCESS") {
    ...
    ,cancelPhoneCert : function () {
        ___ajaxCall("/interface/cancelPhoneCert.do", $.phoneCertLib.param, false, "json", "post"
            ,function (_response) {
            }
        );
    }
