                ...
                <div class="popup_contents">
                    ...
                    <ul class="noti">
                     ...
                     <div class="popup_btn_wrap">
                          ...
                          <!-- <a href="/footer/co_sales/sbcard_egift.do" class="btn black popup_btn_login" required="login">구매 신청</a> -->
                          <a href="sbcard_egift.do.html" class="btn black btn_buy_popup">구매 신청</a>
                    ...
                    <div class="ms_sub_tit_bg">
                        <div class="co_sales_ttl_inner">
                            ...
                            <ul class="smap">
                                ...
                                <li><img class="arrow" src="../../common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
                                <li><a href="index.do.html"><span class="kor">스타벅스 e-Gift Card</span></a></li>
                            </ul>
                        </div>
                    </div>
                </header>
                                    ...
                                    <ul class="info">
                                        <li>
                                            ...
                                            <div class="txt">
                                                ...
                                                <div class="btn_wrap">
                                                    <!-- <a href="/footer/co_sales/sbcard_egift.do" class="btn" required="login">구매 신청</a> --> <!-- 20210303 팝업 수정 -->
                                                    <a href="sbcard_egift.do.html" class="btn btn_pop">구매 신청</a>
                                                    <a href="sbcard_egift_list.do.html" class="btn" required="login">구매 내역 조회</a>
