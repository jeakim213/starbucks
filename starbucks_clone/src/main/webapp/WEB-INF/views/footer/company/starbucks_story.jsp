								...
								<div class="cp_storyInfo_inner">
									...
									<div class="cp_st_popUp cp_st_popUp01">
										...
										<div class="cont">
											...
											<p class="btn_zone"><a href="news_list">보도자료 바로가기</a></p>
										</div>
									</div>
									<!-- 경험 팝업 end -->
									...
									<!-- 사명 팝업 -->
										<div class="cp_st_popUp cp_st_popUp02">
											...
											<div class="cont">
												...
												<p class="btn_zone"><a href="mission">스타벅스 사명 바로가기 </a></p>
											</div>
										</div>
										<!-- 사명 팝업 end -->
									...
									<div class="cp_st_popUp cp_st_popUp03">
										...
										<div class="cont">
											...
											<p class="btn_zone"><a href="coffee/index"><span class="en">COFFEE</span> 바로가기 </a></p>
										</div>
									</div>
									<!-- 커피 팝업 end -->
									...
									<div class="cp_st_popUp cp_st_popUp05">
										...
										<div class="cont">
											...
											<p class="btn_zone"><a href="responsibility/index">사회공헌 바로가기</a></p>											
										</div>
									</div>
									<!-- 사회적 책임 팝업 end -->
									...
									<div class="cp_st_popUp cp_st_popUp06">
										...
										<div class="cont">
											...
											<p class="btn_zone w_h180"><a href="responsibility/hope_delivery">지역사회 참여활동 바로가기</a></p>											
										</div>
									</div>
									<!-- 지역사회 참여 팝업 end -->
									...
									<div class="cp_st_popUp cp_st_popUp07">
										...
										<div class="cont">
											...
											<p class="btn_zone"><a href="responsibility/ethically_sourcing">윤리구매 바로가기</a></p>											
										</div>
									</div>
									<!-- 윤리 구매 팝업 end -->
									...
									<div class="cp_st_popUp cp_st_popUp08">
										...
										<div class="cont">
											...
											<p class="btn_zone"><a href="responsibility/environment">환경보호 활동 바로가기</a></p>										
										</div>
									</div>
									<!-- 환경 보호 팝업 end -->
								</div>
