				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="higher_enjoy.do.html">최상의 커피를 즐기는 법</a></li>
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="higher_enjoy.do.html" class="this ">커피 프레스</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
						...
						<dd class="panel">
							...
							<div class="coffee_content">
								<div class="cloverExtraction_ber">
									...
									<p class="btn_cloverExtraction"><a href="../store/store_reserve.do.html"><img src="../common/img/coffee/cf_more_btnR2.png" alt="리저브 매장 보기"></a></p>
								</div>
							</div>
						</dd>
						<!-- 5번 끝 -->
