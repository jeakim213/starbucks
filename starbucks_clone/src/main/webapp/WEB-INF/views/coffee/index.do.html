			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li class="en"><a href="index.do.html" class="this ">COFFEE</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				...
				<section class="coffee_choice_wrap">
					<div class="coffee_wrap_inner">
						...
						<div class="coffee_choice_btn"><a href="productFinder.do.html">자세히 보기</a></div>
					</div>
				</section>
				<!-- 나와 어울리는 커피 찾기 end -->
				...
				<section class="coffee_reserve_wrap">
					<div class="coffee_wrap_inner">
						...
						<div class="coffee_reserve_btn"><a href="reserve_info.do.html">자세히 보기</a></div>
					</div>
				</section>
				<!-- 스타벅스 리저브 end -->
				...
				<section class="coffee_espresso_wrap">
					<div class="coffee_wrap_inner">
						...
						<div class="coffee_espresso_btn"><a href="espresso.do.html">자세히 보기</a></div>
					</div>
				</section>
				<!-- 에스프레소 음료 end -->
				...
				<section class="coffee_best_wrap">
					<div class="coffee_wrap_inner">
						...
						<div class="coffee_best_btn"><a href="higher_enjoy.do.html">자세히 보기</a></div>
					</div>
				</section>
				<!-- 최상의 커피를 즐기는 법 end -->
				...
				<section class="coffee_hs_wrap">
					<div class="coffee_wrap_inner">
						...
						<div class="coffee_hs_btn"><a href="story.do.html">자세히 보기</a></div>
					</div>
				</section>
				<!-- 커피 이야기  end -->
					...
					<div class="bxslide-main">
						<ul class="coffee_bottom_slider">
							<li class="slide-main_01">
								...
								<div class="btn_text"><a href="/coffee/story.do">자세히 보기</a></div>
							</li>
							<li class="slide-main_02">
								...
								<div class="btn_text"><a href="/coffee/reserve_info.do">자세히 보기</a></div>
							</li>
							<li class="slide-main_03">
								...
								<div class="btn_text"><a href="/coffee/espresso.do">자세히 보기</a></div>
							</li>
						</ul>
