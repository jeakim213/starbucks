			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/coffee/sb_bean_ttl.png" alt="스타벅스 원두"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="javascript:void(0);" class="roast"></a></li>
                            <li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
                            <li><a href="javascript:void(0);" class="productName"></a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="coffee_productView">
					<section class="content_beans">
						<div class="coffee_content">
							<!-- 제품 상세보기 -->
							<div class="product_view_wrap1">
								<div class="product_view_pic">
									<div class="product_big_pic">
										<p><a href="javascript:void(0);"><img class="zoomImg" src="" data-zoom-image="" alt=""></a></p>
										<p class="more_btn"><a href="javascript:void(0);"><img src="../common/img/coffee/more.png" alt=""></a></p>
									</div>
								...
								<div class="product_view_detail">
									<div class="myAssignZone"> 
                                        ...
                                        <!-- 160816 DOM 추가 -->
										<div class="myDrink"><a href="javascript:void(0)">나만의 상품으로 등록</a></div>
										<!-- 160816 DOM 추가 end -->
                                                                                
                                        <!-- 라인업 팝업 -->
										<div class="lineup_pop_wrap">
											<div class="lineup_pop_ttl en">
										...
										<!-- 라인업 팝업 end -->
										<p class="t001"></p>
                                        <p class="coffee_taste icon_blond" style="display: none;"><img alt="" src="../common/img/coffee/icon_blond.png"><strong>블론드 로스트</strong><span class="info">은은하고 부드러운 맛 Subtle & Mellow</span></p>
                                        <p class="coffee_taste icon_medium" style="display: none;"><img alt="" src="../common/img/coffee/icon_medium.png"><strong>미디엄 로스트</strong><span class="info">균형잡힌 부드러움 Balance & Mellow</span></p>
                                        <p class="coffee_taste icon_dark" style="display: none;"><img alt="" src="../common/img/coffee/icon_dark.png"><strong>다크 로스트</strong><span class="info">강렬하고 강인한 맛 Strong & Powerful</span></p>
                                        <p class="coffee_taste icon_flavor" style="display: none;"><img alt="" src="../common/img/coffee/icon_flavor.png"><strong>플레이버 로스트</strong><span class="info">산뜻한 맛과 햡 Fresh flavor & Taste</span></p>
									</div>
                                    <div class="m_view_slide">
                                        ...
                                        <p id="prevBtn"><a href="javascript:void(0)">이전 버튼</a></p>
                                        <p id="nextBtn"><a href="javascript:void(0)">다음 버튼</a></p>
                                    </div>
									<div class="product_view_info">									
										...
										<div class="product_investigate">
											...
											<ul class="product_investigate_list">
												<li class="investigate_list01">
													<a href="story.do.html">
														<p class="product_investigate_img">
															<img src="../common/img/coffee/product_investigate_img01.jpg" alt="커피의 속성 알아보기">
														</p>													
													</a>
												</li>

												<li class="investigate_list02">
													<a href="higher_enjoy.do.html">
														<p class="product_investigate_img">
															<img src="../common/img/coffee/product_investigate_img02.jpg" alt="커피 추출방법 알아보기">
														</p>													
													</a>
												</li>										
											</ul>
										...
										<div class="product_sns_wrap">
											<ul class="product_sns">
											 	...
											 	<li data-sns="F"><a href="javascript:void(0);"><img src="../common/img/coffee/sns_f.png" alt="페이스북"></a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="product_view_wrap2">
								<div class="productInvestigate_left">
									...
									<ul>
										<li class="lu_01">
											<p><img src="../common/img/coffee/productInvestigate_img01.jpg" alt=""></p>
											<dl>
												<dt>디자인 스토리</dt>
												<dd class="dg_story"></dd>
											</dl>
										</li>
										<li>
											<p><img src="../common/img/coffee/productInvestigate_img02.jpg" alt=""></p>
											<dl>
												<dt>커피 테이스팅 노트</dt>
												<dd class="coffee_note"></dd>
											</dl>
										</li>
									</ul>
								</div>
								<div class="productInvestigate_right">
									<dl>
										<dt>Tasting Notes</dt>
										<dd class="tasting_notes"></dd>
										<dt>Enjoy with</dt>
										<dd class="enjoy_with"></dd>
										<dt>Origin</dt>
										<dd class="last">아프리카/아라비아 
											<p><img src="../common/img/coffee/map_%20world_img01.jpg" alt="아프리카/아라비아"></p>
										</dd>
									</dl>
								</div>
							</div>
						...
						<div class="productView_footmenu_inner">						
							<div class="productView_top">
								<div class="productView_top_left">
									...
									<ul>
										<li><a href="javascript:void(0)">해당 상품과 관련된 진행 중인 프로모션이 없습니다.</a></li>
									</ul>
									<p class="more"><a href="javascript:void(0)"><img src="../common/img/menu/news_more.png" alt="프로모션 새소식 더보기"></a></p>
								</div>
								<div class="productView_top_right">
									<dl>
										<dt>
											<p class="sirenOrder"><a href="../util/app_tip.do.html"><img src="../common/img/menu/sirenOrder_img_171109.png" alt=""></a></p>
										</dt>
										<dd>
...
// 					});
		...
		<script>
            ...
            var $PRODUCT_CD = "11104968";
            
            if(!($PRODUCT_CD) || $PRODUCT_CD == "") {
                alert("정상적인 접근이 아닙니다.");
                location.href = "/coffee/product_list.do";
            }
            ...
            function getDataInfo() {
                ...
                __ajaxCall('/coffee/productViewAjax.do', option , true, "JSON", "POST", 
                function(data) {
                    $('div.myAssignZone h4').html(data.view.product_NM + '<br /><span></span>');
                    $('div.myAssignZone h4 > span').text(data.view.product_ENGNM);
                    $('div.myAssignZone .t001').html(data.view.content.replace(/\n/gi, '<br />'));
                    $('.productInvestigate_left > .text').html(data.view.recommend.replace(/\n/gi, '<br />'));
                    $('.dg_story').text(data.view.dg_STORY);
                    $('.coffee_note').text(data.view.coff_TASTING_NOTES);
                    
                    if(data.view.roast_KIND == '10') {
                    	$('.icon_dark').show();
                        $('.smap .roast').text('다크 로스트');
                    } else if(data.view.roast_KIND == '20') {
                        $('.icon_medium').show();
                        $('.smap .roast').text('미디엄 로스트');
                    } else if(data.view.roast_KIND == '30') {
                        $('.icon_blond').show();
                        $('.smap .roast').text('블론드 로스트');
                    } else {
                        $('.smap .roast').parent().prev().remove();
                        $('.smap .roast').parent().remove();
                    }
                    $('.smap .productName').text(data.view.product_NM);
                    
                    if(data.view.tasting_NOTES == "") {
                    	$('.tasting_notes').prev().hide();
                    	$('.tasting_notes').hide();
                    } else {
                        $('.tasting_notes').text(data.view.tasting_NOTES);
                    }
                    
                    if(data.view.enjoy_WITH == "") {
                        $('.enjoy_with').prev().hide();
                        $('.enjoy_with').hide();
                    } else {
                        $('.enjoy_with').text(data.view.enjoy_WITH);
                    }
                    $('p.gram').text(data.view.md_SIZE);
                    
                    if(data.view.original_TEXT == "") {
                    	$('dd.last').prev().hide();
                    	$('dd.last').hide();
                    } else {
                        $('dd.last').html(data.view.original_TEXT + '<p><img src="//image.istarbucks.co.kr/common/img/coffee/map_ world_img01.jpg" alt="아프리카/아라비아"></p>');
                    }
                    ...
                    $('.product_sns_wrap li').on('click', function() {
                        ...
                        if(snsType == 'T') {
                            var $param = {
                                ...
                                description : data.view.product_NM + "\n" + m_domain_http + "/coffee/product_view.do?PRODUCT_CD=" + $PRODUCT_CD
                            };
                            twitterShare( $param );
                        } else if(snsType == 'F') {
                            ...
                            var $param = {
                                ...
                                link: m_domain_http + "/coffee/product_view.do?PRODUCT_CD=" + $PRODUCT_CD,
                                image: $('.product_thum li:eq(0) img').attr('src'),
                                caption: '스타벅스 코리아',
            ...
            function getFileInfo() {
                ...
                __ajaxCall('/coffee/productFileAjax.do', option , true, "JSON", "POST", 
                function(data) {
					...
					*/
                    ...
                    $('.zoomImg').attr('src', $config.imgUploadPath + data.file[0].file_PATH);
                    $('.zoomImg').attr('data-zoom-image', $config.imgUploadPath + data.file[0].file_PATH);
            ...
            function getPairInfo() {
                ...
                __ajaxCall('/coffee/productPairAjax.do', option , true, "JSON", "POST", 
                function(data) {
                    if(data.pair.length > 0) {
                        ...
                        $('div.productView_bottom > div.productRel_wrap > ul a').unbind('click').bind('click', function() {
                            var product_cd = $(this).attr('prod');
                            var f_cate_cd = $(this).attr('cate');
                            var f = document.pairForm;
                            
                            var	input_product_cd = '<input type="hidden" name="product_cd" value="' + product_cd + '">';
                            var input_product_cd2 = '<input type="hidden" name="PRODUCT_CD" value="' + product_cd + '">';
                            
                            if(f_cate_cd == "W0000001") {
                                f.action = "/menu/drink_view.do";
                                $(f).html(input_product_cd);
        ...
        <script type="text/x-jquery-tmpl" id="tpl_productFileLi">
            <li><a href="javascript:void(0)" data-image="${img_UPLOAD_PATH.replace("www", "image")}${file_PATH}" data-zoom-image="${img_UPLOAD_PATH.replace("www", "image")}${file_PATH}" class="elevatezoom-gallery"><img src="${img_UPLOAD_PATH.replace("www", "image")}${file_PATH}" alt=""></a></li>
        </script>
            ...
            <li>
                <dl>
                    ...
                    <dd>
                        ...
                        <p class="more_btn"><a href="javascript:void(0)" prod="${product_CD}" cate="${f_CATE_CD}"><img src="//image.istarbucks.co.kr/common/img/common/detail_view.png" alt="자세히 보기" /></a></p>
                    </dd>
                </dl>
            </li>
        </script>
...
<div class="only_my_drink" style="display:none;" aria-labelledby="tit_my_food" role="dialog" aria-hidden="true"><!-- 접근성_20171123 aria, role 추가 -->
	<div class="only_my_head">
		...
		<p class="close"><a href="javascript:void(0)" class="btn_close" role="button"><img src="../common/img/util/btn_closesa-1.png" alt="팝업 닫기"></a><!-- 접근성_20171123 role 추가 --></p>
	</div>
	<!-- Step 1 -->
...
<div class="only_my_drink2" style="display:none;" role="dialog" aria-hidden="true"><!-- 접근성_20171123 aria, role 추가 -->
	<div class="only_my_head">
		...
		<p class="close"><a href="javascript:void(0)" class="btn_close" role="button"><img src="../common/img/util/btn_closesa-1.png" alt="팝업 닫기"><!-- 접근성_20171123 role 추가 --></a></p>
	</div>
...
<script>
	...
	$(document).ready(function () {
		...
		if (location.href.indexOf("coffee") > -1 && location.href.indexOf("product") > -1 ) {
			m_categoryType = "05";
			m_cateTypeText   = "원두";
			coffee_url = "/coffee/product_view.do?PRODUCT_CD=";
		}else if(location.href.indexOf("coffee") > -1 && location.href.indexOf("reserve") > -1 ){
			m_categoryType = "05";
			m_cateTypeText   = "리저브™";
			coffee_url = "/coffee/reserve_view.do?PRODUCT_CD=";
		}
       		...
       		__ajaxCall("/interface/checkLogin.do", {}, true, "json", "post"
       			,function (_response) {
       				if (_response.result_code == "SUCCESS") {
       					...
       					var strHref = "/menu/food_view.do?product_cd=" + $PRODUCT_CD;
       					if (m_categoryType == "05") {
       						strHref = coffee_url + $PRODUCT_CD;
       					}
       					location.href = "/login/login.do?redirect_url=" + encodeURIComponent(m_domain_http + strHref);
       				}
       			}
       			,function (_error) {
       			}
    ...
    function showPopMyDrink(_categoryType, _drink_title) {
		...
		var objParam = {
       	...
       	___ajaxCall("/menu/getMsrXoCategoryListV2.do", objParam, false, "json", "post"
        	,function(_response) { 
       			if (_response.result_code == "SUCCESS") {
	...
	function getSkuListV2(_categoryType, _categoryCode) {
		...
		return __ajaxCall("/menu/getMsrXoSkuListV2.do", objParam, false, "json", "post"); 
	}
	...
	function goMyDrinkStep2() {
		...
		$(".my_sel_drink dd").html('<p class="t1">' + objDelegateSku.skuName + '<br /><span>' + objDelegateSku.engSkuName + '</span></p>');	// 대표 SKU 명
