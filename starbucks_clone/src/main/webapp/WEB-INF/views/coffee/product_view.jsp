						...
						<div class="productView_footmenu_inner">						
							<div class="productView_top">
								...
								<div class="productView_top_right">
									<dl>
										<dt>
											<p class="sirenOrder"><a href="util/app_tip"><img src="common/img/menu/sirenOrder_img_171109.png" alt=""></a></p>
										</dt>
										<dd>
...
// 					});
		...
		<script>
            ...
            if(!($PRODUCT_CD) || $PRODUCT_CD == "") {
                alert("정상적인 접근이 아닙니다.");
                location.href = "coffee/product_list";
            }
            ...
            function getDataInfo() {
                ...
                __ajaxCall('/coffee/productViewAjax', option , true, "JSON", "POST", 
                function(data) {
                    $('div.myAssignZone h4')(data.view.product_NM + '<br /><span></span>');
                    $('div.myAssignZone h4 > span').text(data.view.product_ENGNM);
                    $('div.myAssignZone .t001')(data.view.content.replace(/\n/gi, '<br />'));
                    $('.productInvestigate_left > .text')(data.view.recommend.replace(/\n/gi, '<br />'));
                    ...
                    if(data.view.original_TEXT == "") {
                        ...
                        $('dd.last')(data.view.original_TEXT + '<p><img src="//image.istarbucks.co.kr/common/img/coffee/map_ world_img01.jpg" alt="아프리카/아라비아"></p>');
                    }
                    ...
                    $('.product_sns_wrap li').on('click', function() {
                        ...
                        if(snsType == 'T') {
                            var $param = {
                                ...
                                description : data.view.product_NM + "\n" + m_domain_http + "coffee/product_view?PRODUCT_CD=" + $PRODUCT_CD
                            };
                            twitterShare( $param );
                        } else if(snsType == 'F') {
                            ...
                            var $param = {
                                ...
                                link: m_domain_http + "coffee/product_view?PRODUCT_CD=" + $PRODUCT_CD,
                                image: $('.product_thum li:eq(0) img').attr('src'),
                                caption: '스타벅스 코리아',
            ...
            function getFileInfo() {
                ...
                __ajaxCall('/coffee/productFileAjax', option , true, "JSON", "POST", 
                function(data) {
            ...
            function getPairInfo() {
                ...
                __ajaxCall('/coffee/productPairAjax', option , true, "JSON", "POST", 
                function(data) {
