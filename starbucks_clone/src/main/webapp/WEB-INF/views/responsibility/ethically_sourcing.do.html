			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit11.jpg" alt="윤리 구매 방식"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="ethically_sourcing.do.html">윤리 구매</a></li>
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="ethically_sourcing.do.html" class="this">윤리적 원두 구매</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="respon_wrap">
					<section class="respon_section">
						<dl class="ethic_intro">
							<dt><img src="../common/img/responsibility/ethically_img1.jpg" alt=""></dt>
							<dd>
								<p class="et1">커피 농가들과 함께하는 미래: 100% 윤리적 원두 구매를 위하여</p>								
								<p class="et3">“스타벅스는 커피 농가 지원, 경제/사회/환경적 기준 설립 및 준수, 산업적 협력 및 지역사회 개발 프로그램을 통해 폭넓은 방식으로  <br> 윤리적 원두 구매를 실천하고 있습니다.”</p><!-- 20210914 수정 -->
								<p class="et2">이러한 접근의 토대에는 <span class="en"> C.A.F.E (Coffee and Farmer Equity) Practice </span> 가 있으며, 이는 커피 업계 최초의 제3자를 통해 인증된 지속가능성 기준 중 하나입니다. </p> 
								<p class="et4"> 국제 환경 보전 단체인 <span class="en"> Conservation International</span>과의 협업을 통해 개발된 <span class="en"> C.A.F.E Practice</span>를 통해, 스타벅스는 고품질의 커피를 장기적이고 안정적으로 공급받을 수 있게 되었으며 <br>   커피 농부들은 그들의 삶과 생계 그리고 지역사회에 긍정적인 변화를 경험하게 되었습니다. <br>   <span class="en">C.A.F.E Practice</span>는 원두의 품질, 거래 투명성, 사회적 책임 그리고 환경 보호와 같은 네 가지 핵심 영역에 대한 기준을 포함하고 있습니다. 이러한 기준을 준수함으로써, <br>   커피 농가들이 인류와 환경 모두에게 유익한 방법으로 커피를 재배할 수 있도록 돕습니다. </p>
							</dd>
						</dl>
					</section>
					<section class="respon_gray_section">
						<div class="respon_inner">
							<p class="et_txt1">윤리적 거래 운영 방식</p>
							<dl class="et_condition">
								<dt class="dt1">필수 충족 조건</dt>
								<dd>
									<div class="et_cond et_cond1">
										<p class="m_et_txt_bg"><img src="../common/img/responsibility/m_et_txt_bg1.png" alt=""></p>
										<div class="et_txt_wrap">
											<p class="p1">원두 품질</p>
											<p class="p2"><span class="en">C.A.F.E Practice</span>로 구매하는 원두는<br>스타벅스의 높은 품질 기준을 충족해야 합니다.</p>
										</div>
									</div>
									<div class="et_cond et_cond2">
										<p class="m_et_txt_bg"><img src="../common/img/responsibility/m_et_txt_bg2.png" alt=""></p>
										<div class="et_txt_wrap">
											<p class="p1">거래 투명성</p>
											<p class="p2"><span class="en">C.A.F.E Practice</span>참여자는 커피 농가 및<br>중간 업체에 지불하는 가격을 공개해야 합니다.</p>
										</div>
									</div>
									<p class="et_plus"><img src="../common/img/responsibility/et_plus_bg.png" alt=""></p>
								</dd>
							</dl>
							<dl class="et_condition">
								<dt class="dt2">제 3자 기관이 평가</dt>
								<dd>
									<div class="et_cond et_cond3">
										<p class="m_et_txt_bg"><img src="../common/img/responsibility/m_et_txt_bg3.png" alt=""></p>
										<div class="et_txt_wrap">
											<p class="p1">사회적 책임</p>
											<p class="p2"><span class="en">C.A.F.E Practice</span> 참여자는 커피 농부의 권리 보호<br>및 최저 생활 보장, 최저 임금제, 아동 노동 금지, <br> 강제 노동 금지, 차별 금지의 원칙을 지켜야 합니다.</p>
										</div>
									</div>
									<div class="et_cond et_cond4">
										<p class="m_et_txt_bg"><img src="../common/img/responsibility/m_et_txt_bg4.png" alt=""></p>
										<div class="et_txt_wrap">
											<p class="p1">환경 보호</p>
											<p class="p2">커피 재배 및 가공 처리에 있어 폐기물 발생 억제, <br> 수질보호, 에너지 절약, 생태계 보호, 화학비료 사용 억제 등 <br> 친환경적 재배 원칙을 지켜야 합니다.</p>
										</div>
									</div>
								</dd>
							</dl>
					...
					<section class="respon_section">						
						<dl class="et_intro1">							
							<dd>
								<p class="p1"><span class="en">C.A.F.E Practice</span></p>
								<p class="m_dtImg"><img src="../common/img/responsibility/ethically_img2.jpg" alt=""></p>
								<p class="p2">스타벅스는 투명하고 윤리적인 커피 원두 구매에 있어서 전 세계 커피 산업을 선도하며, <br> 그동안 친환경, 윤리적 커피 원두 구매 방식을 구축해 왔습니다. <br> 1998년 국제 환경 보호 단체 <span class="en"> (Conservation International)</span>와 협약을 통해 <br> 커피 원두 구매 방식에 환경 보호 원칙을 결합시켰으며, 사회적 · 환경적 책임을 다하는 <br> 이러한 노력의 바탕으로 스타벅스의 윤리적 커피 원두 구매 프로그램인 <br> <span class="en"> C.A.F.E (Coffee and Farmer Equity) Practice</span>가 탄생될 수 있었습니다.</p>
								<p class="p3">2004년 정식으로 출범한 스타벅스  <span class="en"> C.A.F.E Practice</span>는 최상급 커피 원두 재배, <br> 윤리적 책임 완수를 원칙으로 하며, 소규모 농가에서부터 대규모 농장에 이르기까지 <br> 모든 커피 농가가 참여할 수 있도록 운영되고 있습니다.</p><!-- 20210914 수정 -->
							</dd>
							<dt class="w_dtImg"><img src="../common/img/responsibility/ethically_img2.jpg" alt=""></dt>
						</dl>
						<dl class="et_intro2">
							<dt><img src="../common/img/responsibility/ethically_img3.jpg" alt=""></dt>
							<dd>
								<p class="p1">“스타벅스에서 제공되는 제3자 인증의 윤리 구매 원두는 <br> C.A.F.E Practice의 원두 품질, 거래 투명성, 사회적 책임, <br> 환경 보호 등 총 4개 기준의 200여 절차를 모두 충족하고 있습니다.”</p>
								<p class="p2">2009년 9월부터는 한국을 포함한 아시아 태평양 9개국에서 <br> 100% 친환경 재배 및 윤리적 거래 원두임을 제3자가 인증하는 제품 판매를 시작했습니다. <br> 현재 스타벅스 코리아는 전국 매장에서 고객들이 가장 많이 찾는 <br> 카페 아메리카노, 카페 라떼, 카페 모카 등의 에스프레소 음료와 에스프레소 로스트, <br> 하우스 블렌드 등의 원두를 윤리 구매 인증을 받아 제공하고 있습니다.</p> <!-- 220112 수정 -->
								<!-- <p class="view"><a href="https://www.starbucks.com/responsibility/global-report" target="_blank" ><img src="//image.istarbucks.co.kr/common/img/responsibility/res_btn7.png" alt="스타벅스 윤리 구매 리포트 보기"></a></p> 20210914 삭제 -->
							</dd>
						</dl>
						<p class="et_tit1">농가 지원 센터</p>
						<dl class="ethic_intro">
							<dt class="w_ethicImg"><img src="../common/img/responsibility/ethically_img4.jpg" alt=""></dt>
							<dt class="m_ethicImg"><img src="../common/img/responsibility/m_ethically_img4.jpg" alt=""></dt>
							<dd>
								<p class="ng">스타벅스는 커피 농가들로 하여금 생산 비용을 저감하고 농약 및 질병을 감소시키며 커피의 품질을 향상시키고 프리미엄 커피 산출량을 증가시킬 수 있도록 돕는 자원과 <br> 전문지식을 현지 농장들에 제공하기 위해서 핵심 커피 재배 지역에 농가 지원 센터를 설립했습니다. <br> 스타벅스의  커피농가 지원 센터는 고품질의 아라비카 커피 재배를 지원하기 위해 농장들과 직접적으로 협업하는 농학자 및 품질 전문가들이 일하는 곳입니다. <br> 농부들은 토양 관리, 농작물 생산 및 제분공정에 대한 교육을 통해 수확물의 품질과 크기를 향상시킬 수 있습니다.</p>
								<p class="view"><a href="https://www.starbucks.com/responsibility/community/farmer-support" target="_blank"><img src="../common/img/responsibility/res_btn8.png" alt="커피 농가 이야기 보기"></a></p>
							</dd>
						</dl>
					</section>
				</div>
