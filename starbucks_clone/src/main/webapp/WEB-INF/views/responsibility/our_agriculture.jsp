			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit6.jpg" alt="우리 농산물 사랑 캠페인"></h2>
						<ul class="smap">
							<li><a href="../index.htm"><img src="../common/img/common/icon_home.png" alt="홈으로"></a></li><!-- 202107 홈 링크 추가 -->
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="our_agriculture.do.html" class="this">우리 농산물 사랑 캠페인</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<section class="respon_section">
					...
					<div class="youthSlideArea">
						<!-- 202107 이미지가 한개일 경우 영역 -->
						<!-- <img src="https://image.istarbucks.co.kr/common/img/responsibility/m_agriculture_top_img1.png" class="img_m" alt=""> --%><!-- 202107 모바일 이미지 추가 -->
						<!-- //202107 이미지가 한개일 경우 영역 -->
						<div class="bxslide-main">
							<ul class="youth_slider">
								<li><img src="../common/img/responsibility/agriculture_top_img1.png" alt=""></li><!-- 202107 이미지 추가 -->
								<li><img src="../common/img/responsibility/agriculture_slide_img1.jpg" alt=""></li>
							</ul>
					...
					<!-- 사회공헌 대표 슬라이드 영역 end -->
					<p class="res_gt2">“우리 농산물 사랑 캠페인을 통해 스타벅스는 <br>농가의 소득증진 및 자원 재활용의 부가가치 창출과 지역사회와의 동반성장을 실현하고자 노력하고 있습니다. ”</p><!-- 20210914 수정 -->
					<!-- 202107 내용 변경 -->
					<p class="agri_txt1">2015년 3월, 스타벅스는 우리 농산물 소비촉진과 자원 재활용을 위한 ‘농업인 · 스타벅스 · 경기도 3자 간 상생 협약’을 체결하고, 전국 스타벅스 매장에서 판매되는 경기도 농산물을 원재료로 한 5개 푸드 상품 판매 시마다 수익금의 일부를 적립해 총 1억 원의 기금을 마련, 국내 농가를 지원하는 우리 농산물 사랑 캠페인을 진행하였습니다. <br><br>지난 2019년 4월에는 평택시, 자원순환사회연대, 미듬영농조합법인과 함께 평택 농가에 친환경 커피 퇴비를 지원하고 해당 지역의 농산물을 활용한 다양한 상품을 개발 및 판매함으로써, 우리 농가에 새로운 부가가치를 창출하고 자원선순환 체계를 구축하는 MOU 상생 협약을 체결했습니다.</p> <!-- 20210914 수정 --><!-- 20210730 수정 -->
					<p class="agri_txt2">친환경 퇴비로 재배한 농산물은 푸드 상품의 재료로 사용되어 다시 스타벅스 매장에서 판매되는 자원선순환 활동으로 연결되어 있으며, 현재까지 우리 농산물을 활용한 ‘라이스 칩’, ‘버터 가득 라이스 쿠키’, ‘우리 미 카스텔라’ 등의 다양한 제품을 선보이며, 우리 농가와 긴밀하게 협력 및 새로운 상생모델로서 자리매김하고 있다는 평가를 받고 있습니다.<br><br>향후에도 스타벅스는 친환경 커피 퇴비 지원을 통한 자원선순환 활동을 비롯해 우리 농산물을 활용한 다양한 상품을 적극적으로 개발하며, 우리 농가와의 지속적인 상생활동을 이어나갈 예정입니다.</p> <!-- 20210914 수정 --><!-- 20210802 수정 -->
					<!-- //202107 내용 변경 -->
				</section>
				<section class="respon_gray_section3">
					<div class="respon_agri_wrap">
						<p class="agri_tit"><img src="../common/img/responsibility/agri_tit.png" alt="스타벅스 농가지원 선순환 모델"></p>
						<div class="agri_obj agri_obj1">
							<p class="en">STARBUCKS</p>
						</div>
						<div class="agri_obj agri_obj2">
							<p><img src="../common/img/responsibility/agri_tt.png" alt="경기도 퇴비업체"></p>
						</div>
						<div class="agri_obj agri_obj3">
							<p class="en">STARBUCKS</p>
						</div>
						<div class="agri_obj agri_obj4"></div>
						<dl class="agri_il agri_il1">
							<dt><img src="../common/img/responsibility/agri_il1.png" alt=""></dt>
							<dd><img src="../common/img/responsibility/agri_txt1.png?v=210721" alt="우리 농산물 5종"></dd>
						</dl>
						<dl class="agri_il agri_il2">
							<dt><img src="../common/img/responsibility/agri_il2.png" alt=""></dt>
							<dd><img src="../common/img/responsibility/agri_txt2.png?v=210721" alt="커피박 20톤"></dd>
						</dl>
						<dl class="agri_il agri_il3">
							<dt><img src="../common/img/responsibility/agri_il3.png" alt=""></dt>
							<dd><img src="../common/img/responsibility/agri_txt3.png?v=210721" alt="농가 지원 300,000평"></dd>
						</dl>
						<dl class="agri_il agri_il4">
							<dt><img src="../common/img/responsibility/agri_il4.png" alt=""></dt>
							<dd><img src="../common/img/responsibility/agri_txt4.png?v=210721" alt="퇴비 판매 10,000 포대"></dd>
						</dl>
					</div>
					<div class="m_respon_agri_wrap">
						<img src="../common/img/responsibility/m_agriculture_bg.jpg?v=210721" alt="스타벅스 농가지원 선순환 모델에 관한 설명">
					</div>
				</section>
			</section></div>
			<!-- container end -->
