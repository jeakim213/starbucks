			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit16.jpg" alt="윤리경영 보고서"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="sp_ethical_management.do.html">글로벌 사회공헌</a></li>
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="sp_ethical_management.do.html" class="this">윤리경영 보고서</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<!-- 150728 수정 - 구명준  -->
				<section class="sp_report_section">
					<div class="spr_bar">
						<p><img src="../common/img/responsibility/sp_main_bg.jpg" alt=""></p>
					</div>
					<!-- 150721 DOM 수정 구명준 텍스트 추가  -->
					<!-- 150722 DOM 수정 구명준 텍스트   -->
					<!-- <div class="sprTitle">
						<p class="sprTitle_t">윤리구매란?</p>
						<p class="sprTitle_c">“C.A.F.E Practice나 공정무역인증 또는 외부감사기간 등 제3자가 인증하고 검증하는 구매제도를 뜻합니다.”</p>
					</div> -->
					<!-- 150722 DOM 수정 구명준 텍스트 삭제  -->
					<!-- 150721 DOM 수정 구명준 텍스트 추가 end -->
					<!-- 170201 탭 수정 -->
					<dl class="sp_report">
						<dt class="box_bg"></dt><!-- jsp 추가 - 모바일 용 디자인 셀렉트 박스 추가 -->
						<dt class="dt1"><a href="javascript:void(0)" class="on">2015년 윤리경영 보고서</a></dt>
						<dd class="on">
							<div class="sp_inner">
								<p class="tit">스타벅스 2015 전 세계 윤리경영 보고서 발간</p>
								<!-- <p class="main_pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/sp_main_bg.jpg" alt=""></p> -->
								<ul class="intro">
									<li class="li1">
										<!-- 150721 DOM 수정 구명준 텍스트 변경  -->
										<!-- 150722 DOM 수정 구명준 텍스트 변경  -->
										<p class="p1">목표</p>
										<!-- 150722 DOM 수정 구명준 텍스트 변경 end -->
										<!-- 150721 DOM 수정 구명준 텍스트 변경 end -->
										<p class="p2">2015년까지 원두 100% 윤리구매</p>
										<p class="p1">실적</p>
										<p class="p2">
										2015년 99% 원두가 <span class="en">C.A.F.E. Practice</span>와 공정무역, 기타 외부 감사 <br>
										시스템을 통해 윤리적으로 구매되었으며, 우리의 목표에 근접하였습니다.<br>스타벅스는 원두구매 방식을 지속적으로 개선함과 동시에 더 많은 기회를<br><!-- 20210914 수정 -->
										농부들에게 제공하며 남은 1%를 향해 끊임없이 노력하겠습니다.</p>
										<!-- 150722 DOM 수정 구명준 추가  -->
										<dl class="z_sp_point">
											<dt>* 윤리구매란 :</dt>
											<dd>C.A.F.E Practice나 공정무역인증 또는 외부감사기간 등 제3자가 인증하고 검증하는 구매제도를 뜻합니다.</dd>
										</dl>
										<!-- 150722 DOM 수정 구명준 추가 end -->
									</li>
									<!-- 150714 DOM 수정 -->
									<li class="li2">
										<p class="rpc_img"><img src="../common/img/responsibility/sp2015_img1.png" alt=""></p>
										<p class="rmb_img"><img src="../common/img/responsibility/m_sp2015_img1.png" alt=""></p>
									</li>
									<!-- 150714 DOM 수정 end -->
								</ul>
							</div>
							<!-- 150722 DOM 수정 구명준 전체 추가  -->
							<section class="sp_report_section2">
								<div class="sp_inner">
									<ul class="intro">
										<li class="li1">
											<p class="p1">목표</p>
											<p class="p2">2015년까지 고객과 직원 자원 봉사 활동 시간 연간 100만 시간 달성</p>
											<p class="p1">실적</p>
											<p class="p2">
											비록 목표에는 미치지 못하지만 2015년에는 33만 2885 시간의 봉사시간을 기록하였습니다.<br>우리는 파트너들과 고객들이 실제 자원 봉사한 시간은 
											기록된 것 보다 훨씬 많다고 생각합니다.<br>그리고 우리는 파트너와 고객이 함께 봉사활동에 참여하는 것을 중요하게 생각하며<br> 
											이렇게 많은 시간의 봉사활동을 고객이 함께 참여하는 것은 업계에서 드문 일입니다.
											</p>
										</li>
										<!-- 150714 DOM 수정 -->
										<li class="li2">
											<p class="rpc_img"><img src="../common/img/responsibility/sp2015_img2.png" alt=""></p>
											<p class="rmb_img"><img src="../common/img/responsibility/m_sp2015_img2.png" alt=""></p>
										</li>
										<!-- 150714 DOM 수정 end -->
									</ul>
								</div>
							</section>	
							<section class="sp_report_section3">
								<div class="sp_inner">
									<ul class="intro">
										<li class="li1">
											<p class="p1">목표</p>
											<p class="p2">LEED 인증을 획득하기 위한 새로운 형태의 매장 설계</p>
											<p class="p1">실적</p>
											<p class="p2">19개국의 500개가 넘는 스타벅스 매장이 LEED® 인증을 획득했으며, <br>이는 다른 모든 유통 업체보다 가장 많은 숫자입니다.</p>
										</li>
										<!-- 150714 DOM 수정 -->
										<li class="li2">
											<p class="rpc_img"><img src="../common/img/responsibility/sp2015_img3.png" alt=""></p>
											<p class="rmb_img"><img src="../common/img/responsibility/m_sp2015_img3.png" alt=""></p>
										</li>
										<!-- 150714 DOM 수정 end -->
									</ul>
									<p class="sp_last_info">스타벅스의 2015년 지구촌 사회공헌 활동 보고서에 대한 더 자세한 내용은 <a href="https://www.starbucks.com/responsibility/global-report" target="_blank">www.starbucks.com/GRreport</a> 에서 참조 하시길 바랍니다.</p>
								</div>
							</section>
							<!-- 150722 DOM 수정 구명준 전체 추가 end -->
						</dd>
						<dt class="dt2"><a href="javascript:void(0)">2014년 윤리경영 보고서</a></dt>
						<dd>
							<div class="sp_inner">
								<p class="tit">스타벅스 2014 전 세계 윤리경영 보고서 발간</p>
								<!-- <p class="main_pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/sp_main_bg.jpg" alt=""></p> -->
								<ul class="intro">
									<li class="li1">
										<!-- 150721 DOM 수정 구명준 텍스트 변경  -->
										...
										<p class="p2">2015년까지 원두 100% 윤리구매</p>
										<p class="p1">실적</p>
										<p class="p2">2014년 96% 원두가 <span class="en">C.A.F.E. Practice</span>와 공정무역, 기타 외부 감사 시스템을 통해 <br>윤리적으로 구매되었습니다.</p>
										<!-- 150722 DOM 수정 구명준 추가  -->
										<dl class="z_sp_point">
											<dt>* 윤리구매란 :</dt>
											<dd>C.A.F.E Practice나 공정무역인증 또는 외부감사기간 등 제3자가 인증하고 검증하는 구매제도를 뜻합니다.</dd>
									...
									<!-- 150714 DOM 수정 -->
									<li class="li2">
										<p class="rpc_img"><img src="../common/img/responsibility/sp2014_img1.png" alt=""></p>
										<p class="rmb_img"><img src="../common/img/responsibility/m_sp2014_img1.png" alt=""></p>
									</li>
									<!-- 150714 DOM 수정 end -->
								</ul>
							</div>
								...
								<div class="sp_inner">
									<ul class="intro">
										<li class="li1">
											...
											<p class="p2">2015년까지 고객과 직원 자원 봉사 활동 시간 연간 100만 시간 달성</p>
											<p class="p1">실적</p>
											<p class="p2">2014년에도 50만 시간 이상의 지역사회 봉사활동을 지속하였습니다.</p>
										</li>
										<!-- 150714 DOM 수정 -->
										<li class="li2">
											<p class="rpc_img"><img src="../common/img/responsibility/sp2014_img2.png" alt=""></p>
											<p class="rmb_img"><img src="../common/img/responsibility/m_sp2014_img2.png" alt=""></p>
										</li>
										<!-- 150714 DOM 수정 end -->
									</ul>
								</div>
							...
							<section class="sp_report_section3">
								<div class="sp_inner">
									<ul class="intro">
										...
										<!-- 150714 DOM 수정 -->
										<li class="li2">
											<p class="rpc_img"><img src="../common/img/responsibility/sp2014_img3.png" alt=""></p>
											<p class="rmb_img"><img src="../common/img/responsibility/m_sp2014_img3.png" alt=""></p>
										</li>
										<!-- 150714 DOM 수정 end -->
									</ul>
									<p class="sp_last_info">스타벅스의 2014년 지구촌 사회공헌 활동 보고서에 대한 더 자세한 내용은 <a href="https://www.starbucks.com/responsibility/global-report" target="_blank">www.starbucks.com/GRreport</a> 에서 참조 하시길 바랍니다.</p>
								</div>
							</section>
							<!-- 150722 DOM 수정 구명준 전체 추가 end -->	
						</dd>
						<dt class="dt3"><a href="javascript:void(0)">2013년 윤리경영 보고서</a></dt>
						<dd>
							<div class="sp_inner">
								<p class="tit">스타벅스 2013 전 세계 윤리경영 보고서 발간</p>
								<!-- <p class="main_pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/sp_main_bg.jpg" alt=""></p> -->
								<ul class="intro">
									<li class="li1">
										<!-- 150721 DOM 수정 구명준 텍스트 변경  -->
										...
										<p class="p2">2015년까지 원두 100% 윤리구매</p>
										<p class="p1">실적</p>
										<p class="p2">2013년 95% 원두가 <span class="en">C.A.F.E. Practice</span>와 공정무역, 기타 외부 감사 시스템을 통해<br>윤리적으로 구매되었습니다.</p>
										<!-- 150722 DOM 수정 구명준 추가  -->
										<dl class="z_sp_point">
											<dt>* 윤리구매란 :</dt>
											<dd>C.A.F.E Practice나 공정무역인증 또는 외부감사기간 등 제3자가 인증하고 검증하는 구매제도를 뜻합니다.</dd>
									...
									<!-- 150714 DOM 수정 -->
									<li class="li2">
										<p class="rpc_img"><img src="../common/img/responsibility/sp2013_img1.png" alt=""></p>
										<p class="rmb_img"><img src="../common/img/responsibility/m_sp2013_img1.png" alt=""></p>
									</li>
									<!-- 150714 DOM 수정 end -->
								</ul>
							</div>
								...
								<div class="sp_inner">
									<ul class="intro">
										<li class="li1">
											...
											<p class="p2">2015년까지 고객과 직원 자원 봉사 활동 시간 연간 100만 시간 달성</p>
											<p class="p1">실적</p>
											<p class="p2">지난해에 비해 17,600 시간이 증가, 2013년 자원봉사활동 시간은 총 63만 9백 시간</p>
										</li>
										<!-- 150714 DOM 수정 -->
										<li class="li2">
											<p class="rpc_img"><img src="../common/img/responsibility/sp2013_img2.png" alt=""></p>
											<p class="rmb_img"><img src="../common/img/responsibility/m_sp2013_img2.png" alt=""></p>
										</li>
										<!-- 150714 DOM 수정 end -->
									</ul>
								</div>
								...
								<div class="sp_inner">
									<ul class="intro">
										<li class="li1">
											...
											<p class="p2">LEED 인증을 획득하기 위한 새로운 형태의 매장 설계</p>
											<p class="p1">실적</p>
											<p class="p2">스타벅스는 전 세계 18개국에서 LEED 인증 매장을 운영하고 있으며, <br>리뉴얼 및 신축 매장에 그린 빌딩 전략을 적용했습니다.</p>
										</li>
										<!-- 150714 DOM 수정 -->
										<li class="li2">
											<p class="rpc_img"><img src="../common/img/responsibility/sp2013_img3.png" alt=""></p>
											<p class="rmb_img"><img src="../common/img/responsibility/m_sp2013_img3.png" alt=""></p>
										</li>
										<!-- 150714 DOM 수정 end -->
									</ul>
									<p class="sp_last_info">스타벅스의 2013년 지구촌 사회공헌 활동 보고서에 대한 더 자세한 내용은 <a href="https://www.starbucks.com/responsibility/global-report" target="_blank">www.starbucks.com/GRreport</a> 에서 참조 하시길 바랍니다.</p>
								</div>
							</section>
							<!-- 150722 DOM 수정 구명준 전체 추가 end -->
						</dd>
						<!-- <dt class="dt3"><a href="javascript:void(0)">2012년 윤리경영 보고서</a></dt>
						<dd>
							<div class="sp_inner">
								<p class="tit">스타벅스 2012 전 세계 윤리경영 보고서 발간</p>
								<ul class="intro">
									<li class="li1">
										<p class="p1">목표</p>
										<p class="p2">2015년까지 원두 100% 윤리구매</p>
										<p class="p1">실적</p>
										<p class="p2">2012년 93% 원두를 윤리구매했으며 이 중 90%는 <span class="en">C.A.F.E. Practice</span>를 통해 <br>구매되었습니다. </p>
										<dl class="z_sp_point">
											<dt>* 윤리구매란 :</dt>
											<dd>C.A.F.E Practice나 공정무역인증 또는 외부감사기간 등 제3자가 인증하고 검증하는 구매제도를 뜻합니다.</dd>
										</dl>
									...
									<li class="li2">
										<p class="rpc_img"><img src="//image.istarbucks.co.kr/common/img/responsibility/sp2012_img1.png" alt=""></p>
										<p class="rmb_img"><img src="//image.istarbucks.co.kr/common/img/responsibility/m_sp2012_img1.png" alt=""></p>
									</li>
								</ul>
							</div>
							<section class="sp_report_section2">
								<div class="sp_inner">
									<ul class="intro">
										<li class="li1">
											...
											<p class="p2">2015년까지 고객과 직원 자원 봉사 활동 시간 연간 100만 시간 달성</p>
											<p class="p1">실적</p>
											<p class="p2">2011년 대비 2012년 자원봉사 시간 40% 증가</p>
										</li>
										<li class="li2">
											<p class="rpc_img"><img src="//image.istarbucks.co.kr/common/img/responsibility/sp2012_img2.png" alt=""></p>
											<p class="rmb_img"><img src="//image.istarbucks.co.kr/common/img/responsibility/m_sp2012_img2.png" alt=""></p>
										</li>
									</ul>
								</div>
							</section>	
							<section class="sp_report_section3">
								<div class="sp_inner">
									<ul class="intro">
										<li class="li1">
											<p class="p1">목표</p>
											<p class="p2">2012년까지 종이컵과 플라스틱 컵 재활용 문제에 대한 종합적인 해결책을 강구</p>
											<p class="p1">실적</p>
											<p class="p2">미국과 캐나다, 영국, 독일에서 입증된 일회용컵 재활용성 결과를 바탕으로 전세계로 범위를 확대 예정</p>
										</li>
										<li class="li2">
											<p class="rpc_img"><img src="//image.istarbucks.co.kr/common/img/responsibility/sp2012_img3.png" alt=""></p>
											<p class="rmb_img"><img src="//image.istarbucks.co.kr/common/img/responsibility/m_sp2012_img3.png" alt=""></p>
										</li>
									</ul>
									<p class="sp_last_info">스타벅스의 2012년 지구촌 사회공헌 활동 보고서에 대한 더 자세한 내용은 <a href="https://www.starbucks.com/responsibility/global-report" target="_blank">www.starbucks.com/GRreport</a> 에서 참조 하시길 바랍니다.</p>
								</div>
							</section>
						</dd> -->
					</dl>
...
// 					});
		...
		<script>
			$(document).ready(function(){
				...
				//var etSlide = $('.et_slider').bxSlider({
				//	minSlides: 3,
				//	maxSlides: 3,
				//	slideWidth: 271,
				//	slideMargin: 50,
				...
				//	auto: true,
				//	pager: true,
				//	pagerSelector:'.et_slider_pagers',
				//	autoControlsSelector:'.et_slider_controls'
				//});

			//	$(".etSlideArea p.prevBtn a").on("click",function(e){
			//		etSlide.goToPrevSlide();
			//		e.preventDefault();
			//	});

			//	$(".etSlideArea p.nextBtn a").on("click",function(e){
			//		etSlide.goToNextSlide();
			//		e.preventDefault();
			//	});
				/* 150613 성연욱 - 지구촌 봉사의 달 end */
				/* jsp 추가 - 150625 성연욱 - 윤리경영 보고서 수정 */
				$('dl.sp_report > dt > a').bind('click', function(){
					$('dl.sp_report > dt > a').removeClass('on');
					$(this).addClass('on');
					$('dl.sp_report > dd').hide();
					$(this).parent().next().show();
				});
				/* jsp 추가 - 150625 성연욱 - 윤리경영 보고서 수정 end */
				// jsp 추가 -150630 추가 수정 150713
				$('section.sp_report_section dl.sp_report dt.box_bg, section.sp_report_section dl.sp_report dt a').bind('click', function(){
					var ww = $(window).width();
					if(ww <= 640){
						if($('section.sp_report_section dl.sp_report dt.dt1 a').hasClass('on')){
							$('section.sp_report_section dl.sp_report dt.dt1').css({left:10, top:10, margin:0});
							$('section.sp_report_section dl.sp_report dt.dt2').css({left:10, top:35, margin:0});
							$('section.sp_report_section dl.sp_report dt.dt3').css({left:10, top:60, margin:0});
						}else if($('section.sp_report_section dl.sp_report dt.dt2 a').hasClass('on')){
							$('section.sp_report_section dl.sp_report dt.dt1').css({left:10, top:35, margin:0});
							$('section.sp_report_section dl.sp_report dt.dt2').css({left:10, top:10, margin:0});
							$('section.sp_report_section dl.sp_report dt.dt3').css({left:10, top:60, margin:0});
						}else if($('section.sp_report_section dl.sp_report dt.dt3 a').hasClass('on')){
							$('section.sp_report_section dl.sp_report dt.dt1').css({left:10, top:35, margin:0});
							$('section.sp_report_section dl.sp_report dt.dt2').css({left:10, top:60, margin:0});
							$('section.sp_report_section dl.sp_report dt.dt3').css({left:10, top:10, margin:0});
						}
						if($('section.sp_report_section dl.sp_report dt.box_bg').css('height')=='35px'){
							$('section.sp_report_section dl.sp_report dt.box_bg').stop().animate({height: 88}, 500, function(){
								$('section.sp_report_section dl.sp_report > dt > a').css({display: 'block'});
							});
						}else{
							$('section.sp_report_section dl.sp_report dt.box_bg').css({height: 35});
							$('section.sp_report_section dl.sp_report > dt > a:not(.on)').css({display: 'none'});
						}
					}
				});
				// jsp 추가 -150630 추가 수정 150713 end
			});
		</script>
	</div></body>
