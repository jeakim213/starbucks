			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit8.jpg?v=210721" alt="친환경 활동"></h2> <!-- 202107 메뉴명 변경 -->
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="environment.do.html">환경보호 활동</a></li>
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="environment.do.html" class="this">친환경 활동</a></li> <!-- 202107 메뉴명 변경 -->
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="respon_wrap">
					<section class="respon_section">
						<!-- 사회공헌 대표 슬라이드 영역 -->
						<div class="youthSlideArea">
							<div class="bxslide-main">
								<ul class="youth_slider">
									<li><img src="../common/img/responsibility/enviro_slide_img1.jpg" alt=""></li>
									<li><img src="../common/img/responsibility/enviro_slide_img2.png" alt=""></li>
									<li><img src="../common/img/responsibility/enviro_slide_img3.png" alt=""></li>
								</ul>
								<div class="youth_slider_control_pager">
									<div class="youth_slider_controls"></div>
									<div class="youth_slider_pagers"></div>
								</div>
							</div>
					...
					<section class="respon_enviro_section">
						<div class="respon_inner">
							<p class="enviro_bg"><img src="../common/img/responsibility/enviro_bg.png" alt=""></p>
							<div class="enviro_txt">
								<p class="tit en">From Bean To Cup</p>
								<p class="con">스타벅스는 커피 원산지부터 매장까지 환경 발자국 줄이기 위해 노력하고 있습니다.</p><!-- 20210914 수정 -->
								<!--  p class="mb40"><a href="/footer/company/mission.do"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_btn1.png" alt="스타벅스 사명 보기"></a></p -->
								<p class="tit">친환경 원두 구매</p>
								<p class="con">스타벅스는 자체 친환경 원두 구매 가이드라인인 C.A.F.E Practice를 통해 <br>커피 원산지의 환경을 보호하며 사회, 경제적 여건을 향상시켜 최상질의 원두 커피를 <br>안정적으로 공급받을 수 있도록 전 세계 커피 농가와 지난 30여 년간 <br>장기적인 상상 협력 관계를 구축해오고 있습니다.</p><!-- 20210914 수정 -->
								<p><a href="ethically_sourcing.do.html"><img src="../common/img/responsibility/enviro_btn2.png" alt="C.A.F.E Practice 자료 보기"></a></p>
							</div>
						</div>
					</section>
					<section class="respon_enviro_section2">
						<dl class="res1">
							<dt class="w_res1"><img src="../common/img/responsibility/enviro_pic1.jpg" alt=""></dt>
							<dd>
								<p class="tit">친환경 활동</p>
								<p class="m_res1"><img src="../common/img/responsibility/enviro_pic1.jpg" alt=""></p>
								<p class="gt">“스타벅스는 탄소 발자국을 줄이기 위한 다양한 노력을 기울이고 있습니다.”</p>
								<p class="con">스타벅스는 친환경활동의 일환으로, 18년 11월 종이 빨대와 나무 스틱을 전국 매장으로 확대하면서 빨대 없이 마실 수 있는 아이스컵 뚜껑도 함께 소개하며 제품 포장을 위한 비닐 포장재는 친환경 소재 포장재로 변경해 1회용 플라스틱 사용 절감을 통한 친환경 활동을 시행하고 있습니다. <br><br>또한, 전국 스타벅스 매장에서 텀블러에 음료를 구매 시, 400원 할인 혹은 에코별을 증정하며 다회용컵 이용 고객에게 혜택을 드리고 있습니다. </p><!-- 20220303 수정 -->
							</dd>
						</dl>
						<dl class="res2">
							<dt><img src="../common/img/responsibility/enviro_pic2.jpg" alt=""></dt>
							<dd>
								<p class="gt">“구체적으로 매장별 평균 10W 기준의 LED 전구를 최대 10개까지<br>  소등하여 시간당 100W씩 하루 총 300W 이상을 절전하였고, <br>전국 매장에서 두 달간 약 1,000만W 이상의 전력 절약에 <br>도전하는 활동을 실시하였습니다.”</p>
								<p class="con">이와 더불어 스타벅스 코리아는 2010년부터 지구촌 기후변화 방지를 위한 전등끄기 캠페인 ‘Earth Hour’에 동참하고 있습니다. 스타벅스는 영업시간 1시간 동안 최소 조명만을 남겨둔 채, 전국 매장의 간판 및 창가 조명을 소등하고, 고객을 초청해 환경을 주제로 한 커피세미나를 행하고 있습니다. <br>스타벅스 코리아는 이처럼 작은 힘을 모아 큰 힘을 만들고 이를 통해 지구온난화 완화에 기여하고자 합니다.</p> <!-- 220112 수정 -->
							</dd>
						</dl>
					</section>
					<section class="respon_enviro_section3">
						<div class="respon_inner">
							<p class="tit">친환경 매장 설계</p>
							<p class="gt">“환경과 지역사회를 아우르는 스타벅스는 ‘그린스토어’를 통해 친환경 매장 구축을 통해 지역사회에 환경적으로 기여하고,<br> 나아가 지구촌 기후변화 방지활동에도 적극 참여하고 있습니다.”</p>
							<p class="con1">친환경 공사자재를 구매하고 시공하는 스타벅스의 새로운 매장 디자인 전략은 에너지 절약, 재활용 촉진, 친환경 건축방향에 맞춰 전개되고 있습니다. <br> 1호 이대점 리뉴얼을 시작으로 신규 매장 오픈 시 친환경 건축자재 사용 및 폐점 매장의 인테리어 자재를 재활용하는 노력을 하고 있습니다. <br> 또한 LED 조명, 절수형 수도꼭지, 자연 채광 이용 등의 친환경 설계전략을 이용하여 지구촌 기후변화 방지운동에 적극 참여하고 있습니다. <br> 이러한 노력으로 여의도에 있는 IFC 내 여의도IFC(1F) 매장은 친환경 건축물 평가시스템인 LEED®*인증을 획득하였습니다.</p>
							<p class="con2">※ LEED(Leadership in Energy and Environmental Design) : 미국그린빌딩위원회(USGBC)가 만든 자연친화적 빌딩이나 건축물에 부여하는 친환경 인증제도</p>
							<div class="enviro_pop_area">
								<img src="../common/img/responsibility/enviro_img1_1126.jpg?v=20201126" alt="스타벅스 매장 사진">

								<!-- 20201126 수정 -->
								<!-- <p class="enviro_pop_btn enviro_pop_btn1"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_btn.png" alt="팝업 띄우기 버튼"></a></p>
								<div class="enviro_pop enviro_pop1">
									<div class="head">
										<p class="tt">안전한 재료</p>
										<p class="close"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_close.jpg" alt="팝업 닫기 버튼"></a></p>
									</div>
									<div class="cont">
										<p class="pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_pic1.jpg" alt=""></p>
										<p class="txt">이 매장에서 사용된 페인트는 저휘발성 유기 화합물로 독성이 없습니다.</p>
										<p class="btn"><a href="javascript:void(0)">닫기</a></p>
									</div>
								</div>

								<p class="enviro_pop_btn enviro_pop_btn2"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_btn.png" alt="팝업 띄우기 버튼"></a></p>
								<div class="enviro_pop enviro_pop2">
									<div class="head">
										<p class="tt">에너지</p>
										<p class="close"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_close.jpg" alt="팝업 닫기 버튼"></a></p>
									</div>
									<div class="cont">
										<p class="pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_pic2.jpg" alt=""></p>
										<p class="txt">에너지 절약을 위해 저희 매장은 에너지 효율이 높은 LED 전구를 사용합니다.</p>
										<p class="btn"><a href="javascript:void(0)">닫기</a></p>
									</div>
								</div>

								<p class="enviro_pop_btn enviro_pop_btn3"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_btn.png" alt="팝업 띄우기 버튼"></a></p>
								<div class="enviro_pop enviro_pop3">
									<div class="head">
										<p class="tt">재활용</p>
										<p class="close"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_close.jpg" alt="팝업 닫기 버튼"></a></p>
									</div>
									<div class="cont">
										<p class="pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_pic3.jpg" alt=""></p>
										<p class="txt">쓰레기를 줄이고 지구를 아끼는 재활용에 동참해주셔서 감사합니다.</p>
										<p class="btn"><a href="javascript:void(0)">닫기</a></p>
									</div>
								</div>

								<p class="enviro_pop_btn enviro_pop_btn4"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_btn.png" alt="팝업 띄우기 버튼"></a></p>
								<div class="enviro_pop enviro_pop4">
									<div class="head">
										<p class="tt">폐기물</p>
										<p class="close"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_close.jpg" alt="팝업 닫기 버튼"></a></p>
									</div>
									<div class="cont">
										<p class="pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_pic4.jpg" alt=""></p>
										<p class="txt">목재, 금속, 콘크리트 및 기타 공사 잔여분은 분리/재활용합니다.</p>
										<p class="btn"><a href="javascript:void(0)">닫기</a></p>
									</div>
								</div>

								<p class="enviro_pop_btn enviro_pop_btn5"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_btn.png" alt="팝업 띄우기 버튼"></a></p>
								<div class="enviro_pop enviro_pop5">
									<div class="head">
										<p class="tt">지역 사회 보호</p>
										<p class="close"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_close.jpg" alt="팝업 닫기 버튼"></a></p>
									</div>
									<div class="cont">
										<p class="pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_pic5.jpg" alt=""></p>
										<p class="txt">매장공사로 발생되는 탄소발자국을 줄이기 위해 이 매장의 물품은 대부분 국내에서 자재를 조달하고 제작하였습니다.</p>
										<p class="btn"><a href="javascript:void(0)">닫기</a></p>
									</div>
								</div>

								<p class="enviro_pop_btn enviro_pop_btn6"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_btn.png" alt="팝업 띄우기 버튼"></a></p>
								<div class="enviro_pop enviro_pop6">
									<div class="head">
										<p class="tt">물</p>
										<p class="close"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_close.jpg" alt="팝업 닫기 버튼"></a></p>
									</div>
									<div class="cont">
										<p class="pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/enviro_pop_pic6.jpg" alt=""></p>
										<p class="txt">이 매장의 절수형 수도꼭지는 물사용을 줄인 제품으로 설치되었습니다</p>
										<p class="btn"><a href="javascript:void(0)">닫기</a></p>
									</div>
								</div> -->
								<!-- //20201126 수정 -->
							...
							<div class="m_enviro_info">
								<dl>
									<dt>1. 안전한 재료</dt>
									<dd>이 매장에서 사용된 페인트는 저휘발성 유기 화합물로 독성이 없습니다.</dd>
									<dt>2. 에너지 </dt>
									<dd>에너지 절약을 위해 저희 매장은 에너지 효율이 높은 LED 전구를 사용합니다.</dd>
									<dt>3. 재활용</dt>
									<dd>쓰레기를 줄이고 지구를 아끼는 재활용에 동참해 주셔서 감사합니다.</dd>
									<dt>4. 폐기물 전환</dt>
									<dd>목재, 금속, 콘크리트 및 기타 공사 잔여분은 분리/재활용합니다.</dd>
									<dt>5. 지역 사회 보호 </dt>
									<dd>매장공사로 발생되는 탄소발자국을 줄이기 위해 이 매장의 물품은 대부분 국내에서 자재를 조달하고 제작하였습니다.</dd>
									<dt>6. 물</dt>
									<dd>이 매장의 절수형 수도꼭지는 물사용을 줄인 제품으로 설치되었습니다.</dd>
								</dl>
							</div>
						</div>
					</section>
					<section class="respon_enviro_section4">
						<p class="tit">친환경 종이컵</p>
						<p class="con">스타벅스는 4년간의 연구 개발 기간을 거쳐 재생지를 활용한 일회용 컵 제조에 성공하였으며, 그 결과 2007년 한해 110만 그루의 나무와 900 가족의 일 년간 에너지 사용량에<br>해당하는 자원을 아낄 수 있었습니다. 이와 더불어 향후 전 세계 스타벅스 매장에서 머그컵 사용을 표준으로 제정할 계획입니다.</p><!-- 20210914 수정 -->
						<p class="btn1"><a href="no_disposable_cup.do.html"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></p>
						<p class="tit"><span class="en">Grounds for Your Garden</span> 캠페인</p>
						<p class="con">스타벅스는 1995년부터 매장에서 한번 사용하고 버려지는 커피 원두를 퇴비나 탈취제 등으로 고객이 활용하실 수 있게 무료로 제공해 드리고 있습니다. <br> 북미 지역에서 시작된 Grounds for Your Garden 캠페인은 현재 미국 외에도 한국, 영국, 홍콩, 캐나다, 호주, 칠레, 그리스 등 각국의 스타벅스 매장에서 실시되고 있습니다.</p>
						<p><a href="bean_recycling.do.html"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></p>
					</section>
				</div>
			</div>
			<!-- container end -->
...
// 					});
		...
		<script>
			$(document).ready(function(){
				...
				/* 150613 성연욱 - 커뮤니티 스토어 */
				var mySlide = $('.youth_slider').bxSlider({
					pause: 5000,
					speed: 2000,
					// mode: 'fade',
					controls: true,
					...
					auto: true,
					pager: true,
					pagerSelector:'.youth_slider_pagers',
					autoControlsSelector:'.youth_slider_controls'
				});

				$(".youthSlideArea p.prevBtn a").on("click",function(e){
					mySlide.goToPrevSlide();
					e.preventDefault();
				});

				$(".youthSlideArea p.nextBtn a").on("click",function(e){
					mySlide.goToNextSlide();
					e.preventDefault();
				});

				var mySlide_s1 = $('.youth_slider_s1').bxSlider({
					pause: 5000,
					speed: 2000,
					// mode: 'fade',
					controls: true,
					...
					auto: true,
					pager: true,
					pagerSelector:'.youth_slider_s1_pagers',
					autoControlsSelector:'.youth_slider_s1_controls'
				});

				$(".mySlideArea1 p.prevBtn a").on("click",function(e){
					mySlide_s1.goToPrevSlide();
					e.preventDefault();
				});

				$(".mySlideArea1 p.nextBtn a").on("click",function(e){
					mySlide_s1.goToNextSlide();
					e.preventDefault();
				});

				var mySlide_s2 = $('.youth_slider_s2').bxSlider({
					pause: 5000,
					speed: 2000,
					// mode: 'fade',
					controls: true,
					...
					auto: true,
					pager: true,
					pagerSelector:'.youth_slider_s2_pagers',
					autoControlsSelector:'.youth_slider_s2_controls'
				});

				$(".mySlideArea2 p.prevBtn a").on("click",function(e){
					mySlide_s2.goToPrevSlide();
					e.preventDefault();
				});

				$(".mySlideArea2 p.nextBtn a").on("click",function(e){
					mySlide_s2.goToNextSlide();
					e.preventDefault();
				});
				/* 150613 성연욱 - 커뮤니티 스토어 end */
				
				// jsp 적용 - 150624 성연욱
				var controller = $.superscrollorama();
				controller.addTween(10, TweenMax.from($('.enviro_bg'), 1, {css:{top:-458, opacity:0}, ease: Quad.easeOut}), 1, 200);

				$('p.enviro_pop_btn1').bind('click', function(){
					$('.myDimm').show();
					$('.enviro_pop1').fadeIn();
				});

				$('p.enviro_pop_btn2').bind('click', function(){
					$('.myDimm').show();
					$('.enviro_pop2').fadeIn();
				});

				$('p.enviro_pop_btn3').bind('click', function(){
					$('.myDimm').show();
					$('.enviro_pop3').fadeIn();
				});

				$('p.enviro_pop_btn4').bind('click', function(){
					$('.myDimm').show();
					$('.enviro_pop5').fadeIn();
				});

				$('p.enviro_pop_btn5').bind('click', function(){
					$('.myDimm').show();
					$('.enviro_pop6').fadeIn();
				});

				$('p.enviro_pop_btn6').bind('click', function(){
					$('.myDimm').show();
					$('.enviro_pop4').fadeIn();
				});

				$('.myDimm, .enviro_pop div.head p.close, .enviro_pop div.cont p.btn').bind('click', function(){
					$('.myDimm').hide();
					$('.enviro_pop').fadeOut();
				});
				// jsp 적용 - 150624 성연욱 end
			});
		</script>
	</div></body>
