			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit12.jpg" alt="공정무역 인증"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="fair_trade.do.html" class="this">공정무역 인증</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="respon_wrap">
					<section class="respon_section">
						<div class="fair_trade_wrap">
							<dl class="ethic_intro">
								<dt><img src="../common/img/responsibility/fair_trade_vis.jpg" alt=""></dt>
								<dd>
									<p class="et3">“스타벅스는 전 세계에서 가장 많은 공정무역 인증 커피를 유통 및 로스팅하고 있습니다.”</p>
									<p class="et5">스타벅스와 공정 무역 운동은 공정한 가격으로 커피 원두를 구매해, 전 세계 커피 농가의 경제적 자립을 지원하고,  이들의 지역사회와 환경을 <br>   보호한다는 점에서 공동의 목표를 추구하고 있습니다.  스타벅스는 환경 보호와 경제적 안정에 기여하는 방식으로 재배되는 <br>   제3자 인증 커피를 지속적으로 구매하고 있습니다.   공정 무역 인증 커피와 유기농 인증 커피가 좋은 예입니다. <br>   지난 2000년부터 공정 거래 기구인 TransFair USA와 제휴, 공정 무역 인증 커피를 지속적으로 늘려왔습니다.  스타벅스는 북미 지역은 물론, <br>   전 세계에서 가장 많은 공정무역 인증 커피를 유통, 로스팅 하는 기업입니다.</p><!-- 20210914 수정 -->
									<p class="et5"> 스타벅스는 2015년까지 100%의 원두를 윤리구매 하겠다는 목표를 가지고 <br>그동안 C.A.F.E Practice나 공정 무역 인증 등 제3자가 인증하고 검증하는 방식을 통해 <br>   윤리 구매를 실천해 왔으며, 괄목할 만한 성과를 이루어냈습니다. <br>   이는 2000년부터 공정무역 인증 커피를 적극적으로 구매해 온 스타벅스의 강한 실천 의지가 반영된 결과로 <br>   스타벅스는 세계 최대의 공정무역 인증 커피 구매 업체로서의 입지를 단단히 굳히며 소규모 농가 지원에 <br>   더욱 힘을 실을 수 있게 되었습니다. </p><!-- 20210914 수정 -->
									<p class="view"><a href="ethically_sourcing.do.html"><img src="../common/img/responsibility/res_btn9.png" alt="스타벅스 윤리 구매 프로그램 보기"></a></p>
								</dd>
							</dl>
							<div class="about_fair_trade">
								<p>
									<a href="http://www.conservation.org/partners/pages/starbucks.aspx" target="_blank"><img src="../common/img/responsibility/mark_falrtrade.jpg" alt="FAIRTRADE 공정무역 운동 국제 네트워크조직(FLO)의 인증 기준을 지켜 수입되는 상품에 공정무역 인증 마크가 부착됩니다. 소규모 농가에 의해 민주적으로 운영되는 협동조합 만이 취득할 수 있는 공정무역 인증입니다."></a>
								</p>
								<!-- <dl>
									<dt><img src="//image.istarbucks.co.kr/common/img/responsibility/fair_trade_logo1.jpg" alt=""></dt>
									<dd>
										<p class="txt"><img src="//image.istarbucks.co.kr/common/img/responsibility/fair_trade_txt.jpg" alt=""></p>
										<p><img src="//image.istarbucks.co.kr/common/img/responsibility/fair_trade_logo2.jpg" alt=""></p>
									</dd>
								</dl> -->
							</div>
						</div>
						<p class="res_gt">“정당한 이익이 돌아갈 수 있는 지속 가능한 거래를 만들어 가고 있습니다. ”</p>
						<p class="fair_t1">공정 무역으로 인증되어 유통될 수 있는 커피는 전 세계 커피 생산량 중의 4% 정도로 소량입니다.  스타벅스는 제3자 인증의 윤리 구매 프로그램인 <span class="en">C.A.F.E Practice</span>를 통해 커피 품질은 뛰어나나 <br> 공정 무역 조합에 가입되지 않는 농가들에게 시세보다 높은 프리미엄 가격을 보장해, 이들 농가에도 정당한 이익이 돌아갈 수 있는 지속 가능한 거래를 만들어 가고 있습니다.<br>스타벅스는 한국을 비롯한 전세계 28개국에서 공정 무역 인증 커피를 판매하고 있습니다.</p><!-- 20210914 수정 -->
						<div class="fair_roast_area">
							<p class="p1">공정무역 인증 이탈리안 로스트 원두 <span>(Fair Trade Certified™ Italian Roast)</span></p>
							<p class="p2">2012년부터 새롭게 소개되는 스타벅스의 공정무역 인증 원두인 이탈리안 로스트는 <br> 라틴아메리카의 혼합커피로 커피 농가의 경제적 자립을 지원하고 있습니다.</p>
							<p class="roast_bg"><img src="../common/img/responsibility/bean_box_bg.png" alt="FAIRTRADE 공정무역 운동 국제 네트워크조직(FLO)의 인증 기준을 지켜 수입되는 상품에 공정무역 인증 마크가 부착됩니다. 소규모 농가에 의해 민주적으로 운영되는 협동조합 만이 취득할 수 있는 공정무역 인증입니다."></p>
						</div>
					</section>
				</div>
			</div>
