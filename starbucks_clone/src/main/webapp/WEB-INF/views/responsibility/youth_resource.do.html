			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit5.jpg?v=210721" alt="청년인재 양성"></h2><!-- 202107 이미지 변경 -->
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="youth_resource.do.html" class="this">청년 지원 프로그램</a></li> <!-- 202107 메뉴명 수정 -->
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="respon_wrap">
					<section class="respon_section">
						<!-- 150626 디자인 추가 -->
						<p class="respon_titl_img">
							<img src="../common/img/responsibility/youth_top_img1.png" class="img_pc" alt=""><!-- 202107 이미지 추가 -->
							<img src="../common/img/responsibility/m_youth_top_img1.png" class="img_m" alt=""><!-- 202107 모바일 이미지 추가 -->
						</p> 
						<!-- 사회공헌 대표 슬라이드 영역 150626 디자인 수정  -->
						<!-- <div class="youthSlideArea">
							<div class="bxslide-main">
								<ul class="youth_slider">
									<li><img src="//image.istarbucks.co.kr/common/img/responsibility/youth_slide_img1.jpg" alt=""></li>
									<li><img src="//image.istarbucks.co.kr/common/img/responsibility/youth_slide_img1.jpg" alt=""></li>
									<li><img src="//image.istarbucks.co.kr/common/img/responsibility/youth_slide_img1.jpg" alt=""></li>
								</ul>
						...
						<!-- 사회공헌 대표 슬라이드 영역 end -->
						<p class="youth_tit">청년인재 양성 프로그램 <span class="en">(Starbucks Youth Leadership Program)</span></p>
						<p class="youth_con"><span class="sb">국내의 커뮤니티 스토어에서 적립된 기금으로 운영되는 스타벅스 청년인재 양성 프로그램</span>은 젊은 학생들이 경제적인 이유로 꿈을 포기하지 않도록 장학금을 지원함은 물론, <br>연중 진행되는 리더십 함양을 위한 유스 리더십 캠프, 개인 역량 강화 세미나 등의 다양한 기회를 제공합니다. 또한, 멘토링 프로그램, 다양한 지역사회 봉사활동을 통해 나눔을 실천하는 <br>모범적인 인재로 성장하여 이들이 지역사회에 긍정적인 변화를 이끌어 나갈 리더로서 성장하도록 돕고 있습니다.</p> <!-- 202107 내용 변경 -->
					</section>
					<section class="respon_gray_section">
						<div class="respon_inner">
							<p class="res_youth_tit">지역사회 우수 학생 지원 </p>
							<dl class="res_youth_intro">
								<dt>
									<img src="../common/img/responsibility/rs_img2021.jpg" alt=""> <!-- 202107 이미지 추가 -->
								</dt>
								<dd>
									<!-- 202107 내용 변경 -->
									<p class="tit">보호종료 청년 후원 </p>
									<p class="p1">만 18세 법적으로 아동양육시설을 떠나 자립해야하는 ‘보호종료청년’ 스타벅스와 <br>아름다운재단은 ‘청년 자립정착꿈 지원사업’을 통해 보호종료 비진학 청년들의 자립정착을  <br>위한 다양한 꿈을 지원하고 실질적인 자립기회를 제공하고자 합니다. </p>
									<!-- //202107 내용 변경 -->
								</dd>
							</dl>
						</div>
					...
					<section class="respon_section">
						<p class="res_youth_tit">바리스타 재능기부</p>
						<dl class="res_youth_intro">
							<dt>
								<!-- 지역사회 우수 학생 지원 슬라이드 영역 -->
								<div class="mySlideArea2">
									<div class="bxslide-main">
										<ul class="youth_slider_s2">
											<!-- li><img src="//image.istarbucks.co.kr/common/img/responsibility/rs2_img1.jpg" alt=""></li -->
											<li><img src="../common/img/responsibility/rs2_img2.png" alt=""></li>
											<li><img src="../common/img/responsibility/rs2_img3.png" alt=""></li>
											<li><img src="../common/img/responsibility/rs2_img4.jpg" alt=""></li>
											<li><img src="../common/img/responsibility/rs2_img5.jpg" alt=""></li>
										</ul>
										<div class="youth_slider_control_pager">
								...
								<!-- 지역사회 우수 학생 지원 슬라이드 영역 end -->
							</dt>
							<dd>
								<p class="p1">스타벅스 바리스타들은 지난 2008년부터 사회적 일자리 사업 지원을 위해 <br>서울, 성남, 용인, 대전, 부산, 울산 등 지역 연계 단체의 <br>노인, 미혼모, 장애인이 운영하는 카페를 방문해 바리스타 교육 및 매장 운영 지원 등의<br>재능기부 활동을 전개하고 있습니다.</p> <!-- 20210730 수정 -->
								<p>아울러 2015년 여성가족부와의 협업을 통해 스타벅스 재능기부 카페 5호점을 오픈하고, <br>이와 함께 전국에 위치한 취약계층 청년들이 운영하는 14곳의 카페에서 <br>바리스타 교육을 진행하는 업무 협약을 체결하였습니다. <br>이를 통해, 스타벅스 파트너들은 우리 청년들이 더 많은 기회를 만날 수 있도록 <br>활발한 재능기부 활동을 펼칠 것을 약속했습니다.</p>
							</dd>
						</dl>
					</section>
				</div>
