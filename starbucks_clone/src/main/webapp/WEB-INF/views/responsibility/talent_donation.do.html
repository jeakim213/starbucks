...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="../common/css/style_responsibility-1.css?v=210721" rel="stylesheet">
	</head>
				...
				<div class="mob_gnb_wrap_inner">
					...
					<nav class="mob_gnb_menus">
						...
						<ul>
							...
							<li><a href="starbucks_shared_planet.do.html">사회공헌 캠페인 소개</a></li> <!-- 20210820 메뉴명 수정 -->
							<li>
								<a role="button" href="javascript:void(0);">지역 사회 참여 활동<span class="mob_gnb_arrow_down"></span></a><!-- 접근성_20171106 role 추가 -->
								<ul>
									<li><a href="hope_delivery.do.html">희망배달 캠페인</a></li>
									<li><a href="talent_donation.do.html">재능기부 카페 소식</a></li>
									<li><a href="community_store.do.html">커뮤니티 스토어</a></li>
									<li><a href="youth_resource.do.html">청년 지원 프로그램</a></li><!-- 202107 메뉴명 수정 -->
									<li><a href="our_agriculture.do.html">우리 농산물 사랑 캠페인</a></li>
									<li><a href="our_culture_defend.do.html">우리 문화 지키기</a></li>
								</ul>
							</li>
							<li>
								<a role="button" href="javascript:void(0);">환경보호 활동<span class="mob_gnb_arrow_down"></span></a><!-- 접근성_20171106 role 추가 -->
								<ul>
									<li><a href="environment.do.html">친환경 활동</a></li><!-- 202107 메뉴명 수정 -->
									<li><a href="no_disposable_cup.do.html">일회용 컵 없는 매장</a></li>
									<li><a href="bean_recycling.do.html">커피 원두 재활용</a></li>
								</ul>
							</li>
							<li>
								<a role="button" href="javascript:void(0);">윤리 구매<span class="mob_gnb_arrow_down"></span></a><!-- 접근성_20171106 role 추가 -->
								<ul>
									<li><a href="ethically_sourcing.do.html">윤리적 원두 구매</a></li>
									<li><a href="fair_trade.do.html">공정무역 인증</a></li>
									<li><a href="farmer_support.do.html">커피 농가 지원 활동</a></li>
								</ul>
							</li>
							<li>
								<a role="button" href="javascript:void(0);">글로벌 사회 공헌<span class="mob_gnb_arrow_down"></span></a><!-- 접근성_20171106 role 추가 -->
								<ul>
									<li><a href="sp_ethical_management.do.html">윤리경영 보고서</a></li>
									<li><a href="starbucks_foundation.do.html">스타벅스 재단</a></li>
									<li><a href="sp_global_month.do.html">지구촌 봉사의 달</a></li>
								</ul>
							</li>
						</ul>
						<ul>
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit3.jpg" alt="재능기부 카페 소식"></h2>
						<ul class="smap">
							...
							<li class="en"><a href="index.do.html">RESPONSIBILITY</a></li>
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="hope_delivery.do.html">지역사회 참여 활동</a></li>
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="talent_donation.do.html" class="this">재능기부 카페 소식</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<section class="respon_section">
					<div class="res_ytb_wrap">
						<div class="youtobe_dona">
							<iframe width="100%" height="100%" src="https://www.youtube.com/embed/JeGvRjb6F4w?feature=player_embedded&wmode=transparent&rel=0" frameborder="0" allowfullscreen=""></iframe>
						</div>	
					</div>
					<!-- 202107 내용 변경 -->
					<p class="res_gt">“스타벅스 재능기부 카페는 현물 등 일회성 기부를 넘어 기업의 전문성과 <br>노하우의 공유를 통해 지역사회와 동반성장할 수 있는 새로운 형태의 사회공헌 모델입니다.”</p><!-- 20210914 수정 -->
					<p class="con2">지역사회단체가 운영하는 시설 중 유지보수 등 지원이 필요한 카페를 스타벅스와 협력사가 전문역량을 발휘해 재단장하는 스타벅스 재능기부 카페는 현물 등 일회성 기부를 넘어 기업의 전문성과 <br>노하우의 공유를 통해 지역사회와 동반성장할 수 있는 새로운 형태의 사회공헌 모델입니다. 오픈 후에도 지속적으로 시설 보수관리와 더불어 카페 바리스타 교육을 진행하고 있습니다. </p> <!-- 20210914 수정 --><!-- 20210802 수정 -->
					<!-- //202107 내용 변경 -->
				</section>
				<section class="respon_donation_section">
					<div class="respon_donation">
						<ul class="res_don_year en">
							<li>2012</li>
							<li>2013</li>
							<li>2014</li>
							<li>2015</li>
						...
						<!-- 202107 일부 마크업 추가 -->
						<div class="res_bal01 res-modal" data-index="res_don_pop1">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit1.jpg" alt="카페 이스턴"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop1" id="res_don_pop1">
							<div class="res_pop_head">
								<p class="tt">카페 이스턴</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic1.jpg?v=210721" alt=""></p>
								<ul>
									<li>카페명 : 카페 이스턴 / 서울 서대문구</li>
									<li>개관일 : 2012.12.17</li>
									<li>운영 : 서대문사회복지관 운영</li>
									<li>지원 형태 : 실버 바리스타근무</li> <!-- 202107 수정 -->
									<li>재능기부 현황 : 카페 시설 리뉴얼</li>
								</ul>
								<p class="inf">- 커피머신, 인테리어, 가구, 냉난방, 설비, 간판 등</p>
								<p class="btn"><a href="javascript:void(0)">닫기</a></p>
							</div>
						</div>
						<div class="res_bal02 res-modal" data-index="res_don_pop2">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit2.jpg" alt="카페 뜰"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop2" id="res_don_pop2">
							<div class="res_pop_head">
								<p class="tt">카페 뜰</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic2.jpg?v=210721" alt=""></p>
								<ul>
									<li>카페명 : 카페 뜰 / 대전 동구</li>
									<li>개관일 : 2013.12.17</li>
									<li>운영 : 대전혜광학교</li>
									<li>지원 형태 : 장애인 바리스타 근무</li> <!-- 202107 수정 -->
									<li>재능기부 현황 : 카페 교육장 리뉴얼</li>
								</ul>
								<p class="inf">- 조명, 인테리어, 가구, 설비, 간판 등</p>
								<p class="btn"><a href="javascript:void(0)">닫기</a></p>
							</div>
						</div>
						<!-- 202107 폐점으로 인한 삭제 -->
						<!-- <div class="res_bal03 res-modal" data-index="res_don_pop3">
							<ul class="bal_info">
								<li><img src="//image.istarbucks.co.kr/common/img/responsibility/bal_tit3.jpg" alt="빵카페 빵집"></li>
								<li class="view"><a href="javascript:void(0)"><img src="//image.istarbucks.co.kr/common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop3" id="res_don_pop3">
							<div class="res_pop_head">
								<p class="tt">빵카페 빵집</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="//image.istarbucks.co.kr/common/img/responsibility/pop_pic3.jpg" alt=""></p>
								<ul>
									<li>카페명 : 빵카페 빵집 / 부산 진구</li>
									<li>개관일 : 2013.04.30</li>
									<li>운영 : 전포사회복지관 운영</li>
									<li>지원 형태 : 장애인 바리스타근무</li>
									<li>재능기부 현황 : 카페 시설 리뉴얼</li>
								</ul>
								<p class="inf">- 커피머신, 인테리어, 가구, 설비, 간판 등</p>
								<p class="btn"><a href="javascript:void(0)">닫기</a></p>
							</div>
						</div> -->
						<!-- //202107 폐점으로 인한 삭제 -->
						<div class="res_bal04 res-modal" data-index="res_don_pop4">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit4.jpg" alt="카페 마인"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop4" id="res_don_pop4">
							<div class="res_pop_head">
								<p class="tt">카페마인</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic4.jpg?v=210721" alt=""></p>
								<ul>
									<li>카페명 : 카페마인 / 서울 동작구</li>
									<li>개관일 : 2014.06.09</li>
									<li>운영 : 살레시오 수녀회</li>
									<li>지원 형태 : 취약계층 여성바리스타</li> <!-- 202107 수정 -->
									<li>재능기부 현황 : 카페 시설 리뉴얼</li>
								</ul>
								<p class="inf">- 조명, 인테리어, 가구, 냉난방, 설비, 간판 등</p>
								<p class="btn"><a href="javascript:void(0)">닫기</a></p>
							</div>
						</div>
						<div class="res_bal05 res-modal" data-index="res_don_pop5">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit5.jpg" alt="카페 더 드림"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop5" id="res_don_pop5">
							<div class="res_pop_head">
								<p class="tt">카페 더 드림</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic5.jpg?v=210721" alt=""></p>
								<ul>
									<li>카페명 : 카페 더 드림/ 용인 수지구</li>
									<li>개관일 : 2015.04.22</li>
									<li>운영 : 용인푸른꿈 청소년 쉼터</li>
									<li>지원 형태 : 취약계층 청소년</li> <!-- 202107 수정 -->
						...
						<!-- 202107 2016 ~ 2021년 내용 추가 -->
						<div class="res_bal06 res-modal" data-index="res_don_pop6">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit6.jpg" alt="카페 홀더"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop6" id="res_don_pop6">
							<div class="res_pop_head">
								<p class="tt">카페 홀더</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic6.jpg?v=210721" alt=""></p>
								<ul>
									<li>카페명 : 카페 홀더 / 광주 서구</li>
									<li>개관일 : 2016.04.28</li>
									<li>운영 : 실로암사람들</li>
									<li>지원 형태 : 청각 장애인</li> <!-- 202107 수정 -->
									<li>재능기부 현황 : 카페  시설 리뉴얼</li>
								</ul>
								<p class="inf">- 조명, 인테리어, 가구, 냉난방, 설비, 간판 등</p>
								<p class="btn"><a href="javascript:void(0)">닫기</a></p>
						...
						<div class="res_bal07 res-modal" data-index="res_don_pop7">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit7.jpg" alt="다드림 카페"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop7" id="res_don_pop7">
							<div class="res_pop_head">
								<p class="tt">다드림 카페</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic7.jpg" alt=""></p>
								<ul>
									<li>카페명 : 다드림 카페 / 울산 북구</li>
									<li>개관일 : 2017.02.09</li>
									<li>운영 : 어울림복지재단</li>
									<li>지원 형태 : 다문화가정여성</li> <!-- 202107 수정 -->
									<li>재능기부 현황 : 카페  시설 리뉴얼</li>
								</ul>
								<p class="inf">- 조명, 인테리어, 가구, 냉난방, 설비, 간판 등</p>
								<p class="btn"><a href="javascript:void(0)">닫기</a></p>
						...
						<div class="res_bal08 res-modal" data-index="res_don_pop8">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit8.jpg" alt="꿈꾸는 드림 카페"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop8" id="res_don_pop8">
							<div class="res_pop_head">
								<p class="tt">꿈꾸는 드림 카페</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic8.jpg" alt=""></p>
								<ul>
									<li>카페명 : 꿈꾸는 드림 카페 / 서울 강남구</li>
									<li>개관일 : 2018.01.31</li>
									<li>운영 : 서울시립 청소년드림센터</li>
									<li>지원 형태 : 청소년</li> <!-- 202107 수정 -->
									<li>재능기부 현황 : 카페  시설 리뉴얼</li>
								</ul>
								<p class="inf">- 조명, 인테리어, 가구, 냉난방, 설비, 간판 등</p>
								<p class="btn"><a href="javascript:void(0)">닫기</a></p>
						...
						<div class="res_bal09 res-modal" data-index="res_don_pop9">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit9.jpg" alt="카페 숲"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop9" id="res_don_pop9">
							<div class="res_pop_head">
								<p class="tt">카페 숲</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic9.jpg" alt=""></p>
								<ul>
									<li>카페명 : 카페 숲 / 서울 동대문구</li>
									<li>개관일 : 2018.04.05</li>
									<li>운영 : 경동장학재단</li>
									<li>지원 형태 : 청소년(경동시장상인자녀)</li> <!-- 202107 수정 -->
									<li>재능기부 현황 : 카페  신규개설</li>
								</ul>
								<p class="inf">- 조명, 인테리어, 가구, 냉난방, 설비, 간판 등</p>
								<p class="btn"><a href="javascript:void(0)">닫기</a></p>
						...
						<div class="res_bal10 res-modal" data-index="res_don_pop10">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit10.jpg" alt="에스빔 바리스타 교육장"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop10" id="res_don_pop10">
							<div class="res_pop_head">
								<p class="tt">에스빔 바리스타 교육장</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic10.jpg" alt=""></p>
								<ul>
									<li>카페명 : 에스빔 바리스타 교육장 / 경기 군포시</li>
									<li>개관일 : 2019.09.10</li>
									<li>운영 : 한국시니어클럽협회</li>
									<li>지원 형태 : 시니어 바리스타 교육</li> <!-- 202107 수정 -->
						...
						<div class="res_bal11 res-modal" data-index="res_don_pop11">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit11.jpg" alt="휴 카페"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop11" id="res_don_pop11">
							<div class="res_pop_head">
								<p class="tt">휴 카페</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic11.jpg" alt=""></p>
								<ul>
									<li>카페명 : 휴 카페 / 부산 사하구</li>
									<li>개관일 : 2020.05.06</li>
									<li>운영 : 부산시니어클럽</li>
									<li>지원 형태 : 시니어 바리스타</li> <!-- 202107 수정 -->
									<li>재능기부 현황 : 카페  신규개설</li>
								</ul>
								<p class="inf">- 조명, 인테리어, 가구, 냉난방, 설비, 간판 등</p>
								<p class="btn"><a href="javascript:void(0)">닫기</a></p>
						...
						<div class="res_bal12 res-modal" data-index="res_don_pop12">
							<ul class="bal_info">
								<li><img src="../common/img/responsibility/bal_tit12.jpg" alt="노 플라스틱 카페"></li>
								<li class="view"><a href="javascript:void(0)"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></li>
							</ul>
						</div>
						<div class="res_don_pop res_don_pop12" id="res_don_pop12">
							<div class="res_pop_head">
								<p class="tt">노 플라스틱 카페</p>
								<p class="close"><a href="javascript:void(0)">닫기</a></p>
							</div>
							<div class="res_pop_cont">
								<p class="pic"><img src="../common/img/responsibility/pop_pic12.jpg" alt=""></p>
								<ul>
					...
					<div class="m_respon_donation">
						<ul class="m_respon_btn">
							<!-- 202107 일부 마크업 추가 -->
							<li class="m_res_bal01"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop01">카페 이스턴</a>
								<div class="m_res_don_pop m_res_don_pop1" id="m_res_don_pop01">
									<div class="m_res_pop_head">
										<p class="tt">카페 이스턴</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
									<div class="m_res_pop_cont">
										<p class="pic"><img src="../common/img/responsibility/pop_pic1.jpg?v=210721" alt=""></p>
										<ul>
											<li>카페명 : 카페 이스턴 / 서울 서대문구</li>
											<li>개관일 : 2012.12.17</li>
							...
							<li class="m_res_bal03"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop03">카페 뜰</a>
								<div class="m_res_don_pop m_res_don_pop3" id="m_res_don_pop03">
									<div class="m_res_pop_head">
										<p class="tt">카페 뜰</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
							...
							<li class="m_res_bal04"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop04">카페 마인</a>
								<div class="m_res_don_pop m_res_don_pop4" id="m_res_don_pop04">
									<div class="m_res_pop_head">
										<p class="tt">카페마인</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
							...
							<li class="m_res_bal05"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop05">카페 더 드림</a>
								<div class="m_res_don_pop m_res_don_pop5" id="m_res_don_pop05">
									<div class="m_res_pop_head">
										<p class="tt">카페 더 드림</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
							...
							<!-- 202107 2016 ~ 2021년 내용 추가 -->
							<li class="m_res_bal06"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop06">카페 홀더</a>
								<div class="m_res_don_pop m_res_don_pop6" id="m_res_don_pop06">
									<div class="m_res_pop_head">
										<p class="tt">카페 홀더</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
							...
							<li class="m_res_bal07"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop07">다드림 카페</a>
								<div class="m_res_don_pop m_res_don_pop7" id="m_res_don_pop07">
									<div class="m_res_pop_head">
										<p class="tt">다드림 카페</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
									<div class="m_res_pop_cont">
										<p class="pic"><img src="../common/img/responsibility/pop_pic7-1.jpg?v=210721" alt=""></p>
										<ul>
											<li>카페명 : 다드림 카페 / 울산 북구</li>
                                            <li>개관일 : 2017.02.09</li>
                                            <li>운영 : 어울림복지재단</li>
							...
							<li class="m_res_bal08"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop08">꿈꾸는 드림 카페</a>
								<div class="m_res_don_pop m_res_don_pop8" id="m_res_don_pop08">
									<div class="m_res_pop_head">
										<p class="tt">꿈꾸는 드림 카페</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
									<div class="m_res_pop_cont">
										<p class="pic"><img src="../common/img/responsibility/pop_pic8-1.jpg?v=210721" alt=""></p>
										<ul>
											<li>카페명 : 꿈꾸는 드림 카페 / 서울 강남구</li>
                                            <li>개관일 : 2018.01.31</li>
                                            <li>운영 : 서울시립 청소년드림센터</li>
							...
							<li class="m_res_bal09"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop09">카페 숲</a>
								<div class="m_res_don_pop m_res_don_pop9" id="m_res_don_pop09">
									<div class="m_res_pop_head">
										<p class="tt">카페 숲</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
							...
							<li class="m_res_bal10"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop10">에스빔 바리스타 교육장</a>
								<div class="m_res_don_pop m_res_don_pop10" id="m_res_don_pop10">
									<div class="m_res_pop_head">
										<p class="tt">에스빔 바리스타 교육장</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
							...
							<li class="m_res_bal11"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop11">휴 카페</a>
								<div class="m_res_don_pop m_res_don_pop11" id="m_res_don_pop11">
									<div class="m_res_pop_head">
										<p class="tt">휴 카페</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
							...
							<li class="m_res_bal12"><a href="javascript:void(0);" class="m_res-modal" data-index="m_res_don_pop12">노 플라스틱 카페</a>
								<div class="m_res_don_pop m_res_don_pop12" id="m_res_don_pop12">
									<div class="m_res_pop_head">
										<p class="tt">노 플라스틱 카페</p>
										<p class="close"><a href="javascript:void(0)">닫기</a></p>
									</div>
...
// 					});
		...
		$(document).ready(function(){
			...
			$('.responsibility_slider li').eq(0).css({'background':'#cdb78e'});
			$('.responsibility_slider li').eq(1).css({'background':'#ab946b'});
			$('.responsibility_slider li').eq(2).css({'background':'#ab946b'});

			var responsibilitySlide = $('.responsibility_slider').bxSlider({
				pause: 5000,
				speed: 2000,
				mode: 'fade',
				controls: true,
				...
				auto: true,
				pager: true,
				pagerSelector:'.responsibility_slider_pagers',
				autoControlsSelector:'.responsibility_slider_controls'
			});

			$("#prevBtn a").on("click",function(e){
				responsibilitySlide.goToPrevSlide();
				e.preventDefault();
			});

			$("#nextBtn a").on("click",function(e){
				responsibilitySlide.goToNextSlide();
				e.preventDefault();
			});
		...
		<script>
			$(document).ready(function(){
				...
				/* 202107 pc 팝업 스크립트 변경(이수정) */
 				$('.res-modal').bind('click', function(){
					var _this = $(this);
					var contIndex = _this.attr('data-index');
					var popCont = $("#" + contIndex);
					...
					if(_this.hasClass('active')){
						...
						// 딤 클릭시 close
						if($('.myDimm').css('display') === 'block'){
							$('.myDimm').on('click', function(){
								$(this).hide();
								popCont.fadeOut();
				...
				$('.res_don_pop p.close, .res_don_pop p.btn').bind('click', function(){
					var activeElem = $(this).parents('.res_don_pop');
					var modalLinkElem = activeElem.prev();
					
					activeElem.fadeOut();
					$('.myDimm').hide();
					modalLinkElem.removeClass('active');
				});
				/* 202107 pc 팝업 스크립트 변경(이수정) end */
				
				
				/* 202107 mobile 팝업 스크립트 변경(이수정) */
				$('.m_res-modal').bind('click', function(){
					var _this = $(this);
					var contIndex = _this.attr('data-index');
					var popCont = $("#" + contIndex);
				...
				$('.m_res_don_pop p.close, .m_res_don_pop p.btn').bind('click', function(){
					var activeElem = $(this).parents('.m_res_don_pop');
					var modalLinkElem = activeElem.prev();
				...
				/* 202107 mobile 팝업 스크립트 변경(이수정) end */
