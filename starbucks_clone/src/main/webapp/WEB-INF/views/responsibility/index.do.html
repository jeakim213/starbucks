...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="../common/css/style_responsibility.css?v=210826" rel="stylesheet">
	</head>
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/responsibility_tit.jpg" alt="RESPONSIBILITY"></h2>
						<ul class="smap">
							...
							<li class="en"><a href="index.do.html" class="this ">RESPONSIBILITY</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<!-- 서브 슬라이드 영역 -->
				<div class="responsibilitySlideArea">
					<div class="bxslide-main">
						<ul class="responsibility_slider">
						</ul>
						<!-- div class="ytb_t_bg"></div>
						<div class="ytb_b_bg"></div>
						<div class="ytb_all_bg"></div -->
						<div class="responsibility_slider_control_pager">
							<div class="responsibility_slider_controls"></div>
							<div class="responsibility_slider_pagers"></div>
						</div>
					</div>
				...
				<div class="newsArea">
                    ...
                    <div class="newsArea_bg">
                        ...
                        <div class="newsArea_bgr">
                            <p class="tit">
								<img class="w_pic" src="../common/img/menu/useInfo_txt.png" alt="새로워진 스타벅스 웹사이트 이용안내">
								<img class="m_pic" src="../common/img/menu/m_useInfo_txt.png" alt="새로워진 스타벅스 웹사이트 이용안내">
							</p> 
				...
				<!-- 스타벅스 사회 공헌 캠페인 소개 -->
				<section class="responsibility05_wrap">
					<div class="responsibility_wrap_inner">
						<img class="m_pic" src="../common/img/responsibility/m_respon_bimg5.jpg?v=210730" alt="">
						<p class="responsibility05_txt"><img class="w_pic" src="../common/img/responsibility/responsibility05_txt.png?v=210803" alt="환경보호 활동 스타벅스는 커피 원산지에서 매장에 이르기까지 환경에 대한 책임감을 가지고 환경 발자국 줄이기, 일회용 컵 없는 매장, 커피 원두 재활용 활동을 펼치고 있습니다."><img class="m_pic" src="../common/img/responsibility/m_respon_btxt5.png?v=210803" alt=""></p> <!-- 20210730 수정 -->
						<div class="responsibility05_btn"><a href="starbucks_shared_planet.do.html" title="스타벅스 사회 공헌 캠페인 자세히 보기">자세히 보기</a><!-- 접근성_20171201 title 추가 --></div>
					</div>
				</section>
				<!-- 스타벅스 사회 공헌 캠페인 소개 end -->

				<!-- 지역 사회 참여 활동 -->
				<section class="responsibility01_wrap">
					<div class="responsibility_wrap_inner">
						<img class="m_pic" src="../common/img/responsibility/m_respon_bimg1.jpg?v=210820" alt=""> <!-- 20210730 수정 -->
						<p class="responsibility01_txt"><img class="w_pic" src="../common/img/responsibility/responsibility01_txt.png" alt="지역 사회 참여 활동 스타벅스는 더욱 풍요로운 지역 사회를 위해 노력합니다. 사업의 모든 단계에서 접하게 되는 다양한 이해관계자들과 함께 좋은 일을 해낼 수 있다는 생각이 바로 오늘의 스타벅스를 만들었습니다."><img class="m_pic" src="../common/img/responsibility/m_respon_btxt1.png" alt=""></p>
						<div class="responsibility01_btn"><a href="hope_delivery.do.html" title="스타벅스 지역 사회 참여활동 자세히 보기">자세히 보기</a><!-- 접근성_20171201 title 추가 --></div>
					</div>
				</section>
				<!-- 지역 사회 참여 활동 end -->

				<!-- 환경보호 활동 -->
				<section class="responsibility02_wrap">
					<div class="responsibility_wrap_inner">
						<img class="m_pic" src="../common/img/responsibility/m_respon_bimg2.jpg?v=210820" alt="">
						<p class="responsibility02_txt"><img class="w_pic" src="../common/img/responsibility/responsibility02_txt.png?v=210802" alt="환경보호 활동 스타벅스는 커피 원산지에서 매장에 이르기까지 환경에 대한 책임감을 가지고 환경 발자국 줄이기, 일회용 컵 없는 매장, 커피 원두 재활용 활동을 펼치고 있습니다."><img class="m_pic" src="../common/img/responsibility/m_respon_btxt2.png" alt=""></p>
						<div class="responsibility02_btn"><a href="environment.do.html" title="스타벅스 환경보호 활동 자세히 보기">자세히 보기</a><!-- 접근성_20171201 title 추가 --></div>
					</div>
				</section>
				<!-- 환경보호 활동 end -->

				<!-- 윤리구매 -->
				<section class="responsibility03_wrap">
					<div class="responsibility_wrap_inner">
						<img class="m_pic" src="../common/img/responsibility/m_respon_bimg3.jpg" alt="">
						<p class="responsibility03_txt"><img class="w_pic" src="../common/img/responsibility/responsibility03_txt.png" alt="윤리 구매 스타벅스는 윤리적인 원두 구매에 있어서 전 세계 커피 산업을 선도하며, 공정한 가격으로 커피 원두를 구매해 커피 농가의 경제적 자립을 지원하고 커피 원산지를 보호합니다."><img class="m_pic" src="../common/img/responsibility/m_respon_btxt3.png" alt=""></p>
						<div class="responsibility03_btn"><a href="ethically_sourcing.do.html" title="스타벅스 윤리구매 자세히 보기">자세히 보기</a><!-- 접근성_20171201 title 추가 --></div>
					</div>
				</section>
				<!-- 윤리구매 end -->

				<!-- 글로벌 사회공헌 -->
				<section class="responsibility04_wrap">
					<div class="responsibility_wrap_inner">
						<img class="m_pic" src="../common/img/responsibility/m_respon_bimg4.jpg" alt="">
						<p class="responsibility04_txt"><img class="w_pic" src="../common/img/responsibility/responsibility04_txt.png" alt="글로벌 사회공헌 스타벅스는 전 세계 파트너들이 다양한 지역사회 활동에 참여하는 지구촌 봉사의 달을 전개하며, 스타벅스 윤리 구매, 환경 보호 및 지역사회 참여활동의 연간 실적을 공개하고 있습니다."><img class="m_pic" src="../common/img/responsibility/m_respon_btxt4.png" alt=""></p>
						<div class="responsibility04_btn"><a href="sp_ethical_management.do.html" title="스타벅스 글로벌 사회공헌 자세히 보기">자세히 보기</a><!-- 접근성_20171201 title 추가 --></div>
					</div>
				</section>
				<!-- 글로벌 사회공헌 end -->
...
// 					});
                ...
                if(data.list.length > 0) {
                    ...
                    $.each( data.list, function(x, y) {
                        ...
                        if(y.banner_GBN == "I") {
                            ...
                            tmpStr += '<li style="background-color: '+y.simg_NM+'"><div class="video"><iframe width="100%" height="100%" src="https://www.youtube.com/embed/'+y.youtube+'?wmode=transparent&rel=0" frameborder="0" allowfullscreen title="' + y.title +'"></iframe></div></li>';
                            m_tmpStr += '<li class="respon_video"><div class="video"><iframe width="100%" height="100%" src="https://www.youtube.com/embed/'+y.youtube+'?wmode=transparent&rel=0" frameborder="0" allowfullscreen title="'+ y.title+'"></iframe></div></li>';

                            ytbArr.push('<iframe width="100%" height="100%" src="https://www.youtube.com/embed/'+y.youtube+'?wmode=transparent&rel=0" frameborder="0" allowfullscreen title="' + y.title +'"></iframe>');
                        }
                        
                        $('.responsibility_slider').append(tmpStr);
                    ...
                    var responsibilitySlide = $('.responsibility_slider').bxSlider({
                        ...
                        onSlideBefore : function($slideElement, oldIndex, newIndex){
                            ...
                            $('.responsibility_slider li').each(function(ix){
        ...
        </div><!-- 접근성_20171201 "<div id="wrap">" 닫기 태그 누락 -->
	</body>
