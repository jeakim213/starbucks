			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit1.jpg?v=210820" alt="스타벅스 사회공헌 캠페인 소개"></h2> <!-- 20210820  수정 -->
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="starbucks_shared_planet.do.html" class="this">스타벅스 사회공헌 캠페인 소개</a></li> <!-- 20210820 메뉴명 수정 -->
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="respon_wrap">
					<section class="respon_section">
						<!-- 202107 이미지 수정 -->
						<p class="res_vis">
							<img class="w_pic" src="../common/img/responsibility/21res_vis2.png" alt="2021Gmos">
							<img class="m_pic" src="../common/img/responsibility/m_21res_vis2.png" alt="2021Gmos">
						</p>
						<!-- 202107 이미지 수정 end -->
						<p class="res_gt">“우리는 스타벅스가 속한 지역사회에 긍정적인 영향을 미칠 수 있다고 믿으며, 또한 꼭 그래야만 한다고 생각합니다. <br>이를 위해 한 분의 고객, 한 잔의 음료, 우리의 이웃 사회에 정성을 다합니다.”</p>
						<p class="res_t1">스타벅스는 전세계 80여개 지역에서 매장을 운영하는 기업으로 성장하였으며 이러한 성장을 기반으로 사회에 기여하는 책임 또한 함께 증가했습니다.</p> <!-- 20210820 문구수정 -->
						<p class="res_t1">스타벅스의 비전은 파트너와 고객, 커피 농가, 이웃 사회와 모두 함께 성장할 수 있도록 노력하면서 긍정적인 변화를 창출하는 것입니다. <br>즉, 함께하는 사회와 건강한 환경을 위한 혁신업체이자 선도자, 또한 동시에 기여자가 되어 스타벅스와 관련된 모든 이들이 오랫동안 번성할 수 있게 하고자 합니다.</p>
						<div class="res_intro">
							<ul>
								<!-- 202107 내용 수정 -->
								<li class="fli">
									<dl>
										<dt>지역 사회 참여</dt>
										<dd>우리는 항상 좋은 이웃이 되기 위해 <br>노력합니다. <br>파트너와 고객, 지역사회가 하나가  <br>되도록 최선을 다합니다.</dd>
									</dl>
								</li>
								<li>
									<dl>
										<dt>윤리적 원두 구매</dt>
										<dd>우리는 친환경적으로 재배하고,<br>윤리적으로 거래된 최상품 커피 <br>원두만을 구매합니다.</dd>
									</dl>
								</li>
								<li>
									<dl>
										<dt>환경 보호 활동</dt>
										<dd>우리는 환경피해를 최소화하고<br>전세계 기후변화 방지를 위해 <br>노력하며 많은 고객들의 참여를 <br>지원합니다.</dd>
									</dl>
								</li>
								<li>
									<dl>
										<dt>일자리 창출</dt>
										<dd>우리는 교육과 훈련 그리고 채용 등 <br>다양한 기회 제공을 위한 투자를 <br>지속하고 있습니다.</dd>
									</dl>
								</li>
								<!-- //202107 내용 수정 -->
							</ul>
						</div>
						<p class="res_view m_res_view"><a href="https://www.starbucks.com/responsibility" target="_blank"><img src="../common/img/responsibility/res_btn1.png" alt="글로벌 사회적 책임 활동보기"></a></p>
					</section>
					<section class="respon_gray_section">
						<div class="respon_inner">
							<article class="m_gray">
								<p class="tit">국내 사회공헌 활동 테마</p><!-- 20210820 제목 수정 -->
								<ul class="theme">
									<li>
										<dl>
											<dt class="dt1">
												<p>청년<br>Youth</p><!-- 202107 제목 수정 -->
											</dt>
											<dd>
												<p class="txt">우리는 청년들이 꿈을 실현할 기회를 만날 수 있도록 <br>다양한 청년인재 양성 활동을 전개합니다. </p>
												<p class="btn"><a href="youth_resource.do.html">자세히 보기</a></p>
											</dd>
										</dl>
									</li>
									<li>
										<dl>
											<dt class="dt2">
												<p>환경<br>Environment</p><!-- 202107 제목 수정 -->
											</dt>
											<dd>
												<p class="txt">우리는 커피 원산지에서 매장에 이르기까지 <br>환경 발자국 줄이기에 노력하고 있습니다.</p>
												<p class="btn"><a href="environment.do.html">자세히 보기</a></p>
											</dd>
										</dl>
									</li>
									<li class="mrn">
										<dl>
											<dt class="dt3">
												<p>전통문화<br>K-Heritage</p><!-- 202107 제목 수정 -->
											</dt>
											<dd>
												<p class="txt">우리는 문화재 지키기 캠페인을 통해 <br>전통문화를 알리고 보존하고자 노력합니다.</p>
												<p class="btn"><a href="our_culture_defend.do.html">자세히 보기</a></p>
											</dd>
										</dl>
									</li>
								</ul>
					...
					<section class="respon_section">
						...
						<p class="con">지역사회와 함께 하는 상생과 친환경 패러다임 제시를 위해 스타벅스는 ‘Better Together’ 슬로건 하에 ‘플래닛’, ‘피플’ 두 가지 분야 5과제를 발표하고 이를 실천하고자 합니다. <br>스타벅스의 지속가능성 중장기 전략은 2025년까지 한국 내 모든 매장에서 일회용컵이 사라지는 등의 내용을 포함하여 탄소 감축 30%를 목표로 하며 30% 채용확대 등의 내용을 포함하고 있습니다. </p><!-- 20210914 수정 -->
						<!-- //202107 내용 변경 -->

						<!-- 20107 이미지 추가 -->
						<div class="respon_img_wrap">
							<img src="../common/img/responsibility/respon_better_together.jpg" alt="" class="img_pc">
							<img src="../common/img/responsibility/m_respon_better_together.jpg" alt="" class="img_m">
						</div>
						<!-- //202107 이미지 추가 -->
					</section>
				</div>
			</div>
			<input type="hidden" id="ACTIVE_YEAR" name="ACTIVE_YEAR" value="">
			<!-- container end -->
...
// 					});
			...
			<script src="../common/js/bbs/starbucks_shared_planet.js?v=210721"></script>
		<script>
		$(document).ready(function(){
			//$.openevent.getStamp('J');	//오픈이벤트  
