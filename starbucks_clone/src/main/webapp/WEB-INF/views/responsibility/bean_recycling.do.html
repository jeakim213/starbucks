...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="../common/css/style_responsibility-2.css?v=210820" rel="stylesheet">
	</head>
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit10.jpg" alt="커피 원두 재활용"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="bean_recycling.do.html" class="this">커피 원두 재활용</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<section class="respon_section">
					<!-- 20210820 주석처리 <div class="res_ytb_wrap">
						<div class="youtobe_dona">
							<iframe width="100%" height="100%" src="https://www.youtube.com/embed/UOfoZtwVC6A?feature=player_embedded&wmode=transparent&rel=0" frameborder="0" allowfullscreen></iframe>
						</div>
					</div> -->
					<!-- 20210820 추가 -->
					<div class="res_img_wrap">
						<img class="w_pic" src="../common/img/responsibility/coffee_compost.jpg" alt="커피퇴비">
						<img class="m_pic" src="../common/img/responsibility/m_coffee_compost.jpg" alt="커피퇴비">
					</div>
					<!--// 20210820 추가 -->
				</section>
				<section class="respon_gray_section2">
					<div class="respon_inner">
						<dl class="res_bean_intro">
							<dt>
								<!-- 슬라이드 영역 -->
								<div class="mySlideArea1">
									<div class="bxslide-main">
										<ul class="youth_slider_s1">
											<li><img src="../common/img/responsibility/bean_slide_img2.png" alt=""></li>
											<li><img src="../common/img/responsibility/bean_slide_img3.png" alt=""></li>
										</ul>
							...
							<dd>
								<p class="p1">스타벅스 커피박을 재활용 해보세요.</p>
								<p class="p2">스타벅스 코리아는 전국 매장에서 음료제조 후 발생된 <br>커피박을 퇴비나 탈취제, 제습제 등의 새로운 자원으로 활용할 수 있도록 무료 배포하고 있습니다.</p> <!-- 220112 수정 -->
								<p class="p3">스타벅스 코리아는 2015년부터 7년간 누적으로 4,000여톤에 달하는 친환경 커피퇴비 20만포를 스타벅스 커피박의 재활용을 통해 새로운 자원으로 사용하였습니다. 2016년에는 업계 최초로 환경부,자원순환사회연대와 커피찌꺼기 재활용 활성화 시범사업을 위한 업무 협약을 체결했으며, 이를 통해 커피박을 재활용하는 프로세스를 구축했습니다. 스타벅스는 커피박의 자원재활용 100%달성을 통해 친환경 기업으로서 책임을 다하고자 노력하겠습니다.</p> <!-- 220112 수정 -->
							</dd>
						</dl>
					</div>
				</section>
