			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit9.jpg" alt="일회용 컵 없는 매장"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="no_disposable_cup.do.html" class="this">일회용 컵 없는 매장</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="respon_wrap">
					<section class="respon_section">
						...
						<div class="youthSlideArea">
							<div class="bxslide-main">
								<ul class="youth_slider">
									<li><img src="../common/img/responsibility/onetime_slide_img1.jpg" alt=""></li>
									<li><img src="../common/img/responsibility/onetime_slide_img2.png" alt=""></li>
									<li><img src="../common/img/responsibility/onetime_slide_img3.png" alt=""></li>
								</ul>
						...
						<!-- 사회공헌 대표 슬라이드 영역 end -->
						<p class="res_gt">“환경을 위해 매장에서는 머그로 스타벅스 음료를 즐겨주세요.”</p>
						<p class="one_txt">스타벅스 코리아는 환경부와 함께 일회용 컵 없는 매장 캠페인을 통해 매장에서 드시는 고객께는 음료를 머그에 담아드리는 것을 표준으로 지정해 실천하고 있습니다.</p> <!-- 220112 수정 -->
						<p class="one_txt">스타벅스 코리아는 환경부, 그린스타트 전국네트워크, 자원순환사회연대와 함께 2011년 1월부터 '일회용 컵 없는 매장' 캠페인을 전개하고 있습니다. <br> 매장에서 음료를 드시는 고객께는 머그에 제공드리는 것을 서비스의 표준으로 하고 있습니다.</p> <!-- 220112 수정 -->
						<p class="one_txt">이를 위해 스타벅스의 일회용 컵 없는 매장에서는 업계 최초로 머그 전용 선반을 비롯해,<br>  머그의 온도를 따뜻하게 유지시켜 줄 수 있도록 특별 열선이 장치된 '머그 워머'가 설치되어 있어 더욱 편리하고 위생적으로 머그를 제공하고 사용할 수 있도록 최선을 다하고 있습니다.</p>
						<p class="one_txt2">여러분, 환경을 위해 매장에서는 머그로 스타벅스 음료를 즐겨주세요.</p>
					</section>
					
					<!-- 202107 내용 추가 -->
					<section class="respon_onetime">
					<div class="respon_inner">
						<p class="tit">매월 10일은 1회용컵(1) 없는 날(0)</p>
						<p class="cont">다회용컵 권장 캠페인인 일회용컵 없는 날은 2018년부터 매월 10일을 일회용컵(1) 없는 날(0)으로 지정해, 다회용컵 사용을 권장하는 프로그램으로 21년에는 서울, 인천, 부산, 제주 등 전국단위로 <br>오프라인과 온라인으로 다회용컵 사용 권장 이벤트를 병행하여 진행하고 있습니다.</p>
						<p class="cont">스타벅스는 환경부의 일회용품 줄이기 자발적 협약에 동참해 오며 다회용컵 사용을 권장하는 노력을 지속하고 있습니다. 개인 다회용컵에 음료 주문 시 할인 혜택 또는 에코별 제공, 매장 내 머그 사용 <br>권유 등 고객 동참을 이끌어내기 위한 다양한 친환경 활동을 전개해 오고 있습니다.</p>
					</div></section>
					<!-- //202107 내용 추가 -->
				</div>
			</div>
