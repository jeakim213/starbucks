			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit15.jpg" alt="스타벅스 재단"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="starbucks_foundation.do.html" class="this">스타벅스 재단</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="respon_p_wrap">
					<section class="respon_section">
						<dl class="res_found">
							<dt>
								<img src="../common/img/responsibility/foundation_img1.jpg" alt="">
							</dt>
							<dd>
								<p class="p1">“스타벅스 재단은 지역사회와 함께 성장하겠다는  스타벅스 약속의 일환으로 설립되었습니다.”</p>
								<p class="p2">스타벅스 재단은 스타벅스 기업 및 개인 기부를 통해 기금을 조성하는 독립적인 자선 단체로서, 1997년 미국과 캐나다 내의 문맹 퇴치 프로그램을 지원하면서 처음 활동을 시작하였으며, <br> 오늘날에는 전 세계 각국의 수많은 지역사회를 지원하고 있습니다.</p><!-- 20210914 수정 -->
							</dd>
						</dl>
					</section>
					<section class="res_found_section">
						<div class="respon_inner">
							<dl class="found_intro">
								<dt>
									<p class="found_obj"><img src="../common/img/responsibility/foundation_obj.png" alt=""></p>
								</dt>
								<dd>
									<p class="p1">청년들을 위한 기회</p>
									<p class="p2">스타벅스 재단은 오늘날 변화하는 세계 경제시장에서 요구되는 기술을 교육하는 <br> 프로그램에 투자하여 15~24세의 청년들에게 기회의 발판을 제공하고 있습니다.</p><!-- 150710 DOM 수정 - 5 → 15로 수정 -->
									<p class="p1">지역사회 공헌 활동</p>
									<p class="p2">스타벅스 재단은 또한 파트너 매치 (Partner Match) 프로그램을 통해 스타벅스 파트너(직원)들로 하여금 소속 지역사회 활동에 참여할 수 있도록 지원합니다. 또한, 우리의 파트너들이 자발적으로 기부에 참여하거나 활동을 실천하고 있는 비영리단체에 적절한 보조금을 지원하고 있습니다. 이러한 활동을 통해 개인과 기업, 그리고 지역사회 구성원들이 다 함께 노력하고 조화롭고 결집된 사회를 위한 문화가 창출되고 확산되길 바랍니다.</p>
								</dd>
							</dl>
						</div>
					</section>	
					<!-- 150713 DOM 수정 -디자인 추가  -->
					<section class="resm_found_section">
						<div class="respon_inner">
							<dl class="resm_found_01">
								<dt><p class="resm_found_img01"><img src="../common/img/responsibility/resm_found_img01.jpg" alt=""></p></dt>
								<dd>
									<p class="resm_p1">국내 활동</p>
									<p class="resm_img"><img src="../common/img/responsibility/resm_found_img01.jpg" alt=""></p>
									<p class="resm_p2">“2010년부터 국내에서도 스타벅스 재단은 30 곳의 기관에 <br> 지금까지 한화로 약 7억 9천만 원의 기부금을 전달하였습니다.”</p>
									<p class="resm_p3">2010년부터 국내에서도 스타벅스 재단은 금천구청소년쉼터, 동방사회복지회, <br> 서대문종합사회복지관, 서울그린트러스트, 용인그린나래청소년쉼터, 전국지역아동센터, <br> 전포종합사회복지관, 제주올레, 초록우산 어린이재단, 환경교육센터, JA Korea 등 <br> 지금까지 30 곳의 기관에 지금까지 한화로 약 7억 9천만 원의 기부금을 전달하였습니다. </p>
								</dd>
							</dl>
							<dl class="resm_found_02">
								<dt><p class="resm_found_img01"><img src="../common/img/responsibility/resm_found_img02.jpg" alt=""></p></dt>
								<dd>									
									<p class="resm_p1">“스타벅스 재단의 기금은 지역의 청소년들을 변화시키고 <br> 청년들과 함께 행동하며, 이들의 꿈과 미래를 응원하는 <br> 다양한 프로그램을 운영하기 위해 쓰였습니다.” </p><!-- 20210914 수정 -->
									<p class="resm_p2">앞으로도 스타벅스 재단은 대한민국의 젊은이들이 일생의 기회를 접하고, <br> 그들의 미래를 설계해 나가며, 더 나아가 지역사회의 꼭 필요한 인재로 거듭날 수 있도록 <br> 돕기 위해 지속적으로 지원할 예정입니다. </p>
								</dd>
							</dl>
						</div>
					</section>
					<!-- 150713 DOM 수정 -디자인 추가 end -->			
				</div>
			</div>
			<!-- container end -->
...
// 					});
		...
		<script>
			$(document).ready(function(){
				...
				controller.addTween(10, TweenMax.from($('.found_intro p.found_obj'), 1, {css:{top:-413, opacity:0}, ease: Quad.easeOut}), 1, 150);
				/* 150613 성연욱 - 스타벅스 재단 end */
