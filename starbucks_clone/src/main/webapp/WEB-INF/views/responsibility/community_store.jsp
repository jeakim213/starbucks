			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit4.jpg" alt="커뮤니티 스토어"></h2>
						<ul class="smap">
						<li><a href="../index.htm"><img src="../common/img/common/icon_home.png" alt="홈으로"></a></li>
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="community_store.do.html" class="this">커뮤니티 스토어</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<section class="respon_section">
					<div class="res_ytb_wrap">
						<div class="youtobe_dona">
							<iframe width="100%" height="100%" src="https://www.youtube.com/embed/eCTl42KlMXU?feature=player_embedded&wmode=transparent&rel=0" frameborder="0" allowfullscreen=""></iframe>
						</div>
					</div>
					<p class="res_cst1">스타벅스 커뮤니티 스토어<span class="en">(Starbucks Community Store)</span>란?</p>
					<p class="res_con1">스타벅스는 더욱 풍요로운 지역 사회를 위해 노력합니다. 지역사회와 환경을 적극적으로 돕는 것을 기업 윤리의 중요한 덕목으로 여기며 적극적으로 실천하고 있으며, <br>스타벅스의 파트너들은 많은 분야에서 우리 주위의 환경과 복지를 개선 하기 위한 노력을 하고 있습니다.</p><!-- 20210914 수정 -->
					<p class="res_gt">“스타벅스 커뮤니티 스토어는 지역사회의 긍정적인 변화와 장기적인 발전에 기여하기 위해 <br>매장의 수익금을 지역사회에 환원하는 이익공유형 매장으로, 차별화된 스타벅스의 글로벌 사회공헌 모델입니다.”</p>
					<p class="res_con1">'커뮤니티 스토어'라는 이름에 내포되어 있듯이, 커뮤니티 스토어는 지역사회와 소통하는 열린 공간으로써, 전 세계 각 지역의 특성에 따른 연계 NGO와 함께 다양한 프로그램을 운영하고 있습니다. <br>스타벅스 코리아는 2011년 미국을 시작으로, 태국에 이어 전 세계 2만 1천여 개의 매장 중 8번째로 2014년 10월 1일, 한국에서도 커뮤니티 스토어를 오픈했습니다.</p> <!-- 220112 수정 -->
					<p class="res_view"><a href="https://www.starbucks.com/responsibility/community/community-stores" target="_blank" title="새창 열림"><img src="../common/img/responsibility/res_btn2.png" alt="전 세계 스타벅스 커뮤니티 스토어 확인하기"></a></p>
				</section>
				<section class="respon_cms_section1">
					<div class="respon_inner">
						<p class="tit">개점 배경</p>
						<p class="res_gt m_res_gt">“스타벅스 코리아는 2014년, <br>15주년을 맞이해 사회책임 경영의 원년을 선포하고, <br>15년간 진행해 온 사회 공헌 활동 역량을 집중해 한국 실정에 맞는  <br>새로운 형태의 차별화된 사회 공헌 프로그램 개발의 일환으로 <br>커뮤니티 스토어를 오픈 하였습니다.”</p> <!-- 220112 수정 -->
						<div class="respon_cms_bg m_respon_cms_bg"><img src="../common/img/responsibility/cms_bg2021.png" alt=""></div>
					</div>
				</section>
				<section class="respon_cms_section2">
					<p class="tit">운영 방안</p>
					<p class="res_gt">‘오늘의 청년은 내일의 미래를 만드는 원동력' - Youth Leadership</p>
					<p class="res_con1">OECD 국가 중 상위 5개국에 속하는 비싼 대학 등록금과 저소득 취약 계층 가정 학생들의 낮은 진학률에 대한 국내 실정을 고려하여 청년인재 양성 프로그램을 운영하고, <br>고객분들의 따듯한 마음을 모아 젊은 학생들의 꿈과 희망을 지원하고 있습니다. <br>사회 초년생으로서 필요한 역량과 능력을 개발할 수 있도록 리더십을 함양하고 비즈니스 및 커뮤니케이션 스킬 등, 개인 역량을 극대화할 수 있는 종합적인 Youth Leadership 프로그램을 <br>연중 내내 운영할 방침입니다. <br>이와 더불어, 지역사회의 열린 공간으로서 지역 주민 및 인근 대학생들과 함께 소통하는 사랑방 역할도 수행하게 됩니다.</p><!-- 20210914 수정 -->
					<ul class="cms_intro">
						<li><img src="../common/img/responsibility/cms_pic1.jpg" alt=""></li>
						<li class="txt">
							<p class="tt">청년인재 양성 프로그램</p>
							<ul>
								<li>- 모든 품목당 300원 적립 기금 조성</li>
								<li>- 커뮤니티 스토어 장학금 지급</li>
								<li>- 인턴십 프로그램 운영</li>
								<li>- 특별 채용 기회 제공</li>
								<li>- 스타벅스 글로벌 프로그램 체험</li>
								<li>- 봉사활동 지원 및 바리스타 교육</li>
							</ul>
							<p class="res_view"><a href="youth_resource.do.html"><img src="../common/img/responsibility/re_detail_view.png" alt="자세히 보기"></a></p>
						</li>
						<li><img src="../common/img/responsibility/cms_pic2.jpg" alt=""></li>
						<li class="txt">
							<p class="tt">지역사회 소통형 매장</p>
							<ul>
								<li>- 대학로 가로수 돌보미 활동</li>
								<li>- 학생 멘토링 프로그램</li>
								<li>- 명사 초청 문화 특강</li>
								<li>- 고객 초청 커피 세미나</li>
								<li>- 디지털 커뮤니티 보드 운영</li>
							</ul>
						</li>
					</ul>
					<section class="tb_cms_intro">
						<dl class="tb_cms_intro01">
							<dt><img src="../common/img/responsibility/tb_cms_pic1.jpg" alt=""></dt>
							<dd>
								<p class="tb_tit">청년인재 양성 프로그램</p>
								<ul>
									<li>- 모든 품목당 300원 적립 기금 조성</li>
									<li>- 커뮤니티 스토어 장학금 지급</li>
									<li>- 인턴십 프로그램 운영</li>
								...
								<p class="res_view"><a href="youth_resource.do.html"><img src="../common/img/common/detail_view.png" alt="자세히 보기"></a></p>
							</dd>
						</dl>
						<dl class="tb_cms_intro02">
							<dt><img src="../common/img/responsibility/tb_cms_pic2.jpg" alt=""></dt>
							<dd>
								<p class="tb_tit">지역사회 소통형 매장</p>
								<ul>
									<li>- 대학로 가로수 돌보미 활동</li>
									<li>- 학생 멘토링 프로그램</li>
									<li>- 명사 초청 문화 특강</li>
					...
					<p class="res_con1">스타벅스 코리아의 많은 매장 중 Youth Leadership의 컨셉을 가장 잘 나타내고, 젊음과 소통의 상징성을 가지고 있는 대학로 지역에 위치한 대학로점을 커뮤니티 스토어로 오픈하게 되었습니다.<br>한 달 동안의 재단장 기간을 거쳐, 2014년 10월 1일 오픈한 대학로점은 대학생들과 함께 작업한 대형 아트월, 전 세계 최초 디지털 커뮤니티 보드, 커뮤니티 스토어의 메시지를 담은 전용 슬리브 등  <br>“Youth Leadership”을 형상화한 커뮤니티 스토어만의 차별화된 디자인 컨셉이 반영되었으며, 지역주민과 대학생들이 커뮤니티 스토어의 취지를 공감하고 소통 할 수 있도록, <br>다양한 행사 진행을 위한 독립형 공간도 별도 마련하였습니다.</p> <!-- 220112 수정 -->
					<p class="res_view"><a href="../store/store_community.do.html"><img src="../common/img/responsibility/res_btn3.png" alt="커뮤니티 스토어 매장 바로가기"></a></p>
				</section>
				
				<!-- 202107 section3 내용 변경 및4 내용 추가 -->
				<section class="respon_cms_section3">
					<div class="respon_inner">
						<dl>
							<dt><img src="../common/img/responsibility/cms_pic4.jpg" alt=""></dt>
							<dd>
								<p class="p1">커뮤니티 스토어 2호점</p>
								<p class="p2">스타벅스 ‘창업카페’는 청년 창업 생태계 조성을 목표로 2015년부터 <br>스타벅스 매장에서 청년들에게 창업과 관련된 강연, 멘토링, 네트워킹 등을 제공하는 <br>‘청년창업문화지원 프로그램’입니다. </p><!-- 20210914 수정 -->
								<p class="p3">2015년부터 창업을 준비하는 청년들에게 창업에 도움이 되는 다양한 프로그램을 진행하여  <br>올해까지 총 8회의 창업 카페 프로그램을 시즌제로 운영하고 있습니다. <br>이를 통해 약 2,800 명의 창업을 준비하는 청년들에게 창업 강연 및 네트워킹, 세미나 등을  <br>진행하여 창업을 희망하는 청년들을 응원하고 있습니다.  </p><!-- 20210914 수정 -->
								<p class="p3">또한 2020년 5월 7일 중소벤처기업부와 ‘자상한 기업’ 협약을 통해 커뮤니티 스토어 2호점인 <br>‘성수역점’에서 고객이 구매 시 품목당 300원의 기금을 적립해 전국 10개의 창업카페 <br>거점매장에서 ‘창업카페’ 프로그램 운영에 사용하고 있습니다.</p>
								<p class="p4"><span class="black">* 창업카페 거점매장 </span><br><span class="line_block">성수역점, 이대R점, 더종로R점, 안암역점, 인천용현DT점, 천안안서점, 대전중앙로R점, 대구계산점, 조선대점,더해운대R점</span></p>
							</dd>
						</dl>
					</div>
				</section>
				
				<section class="respon_cms_section3 type2">
					<div class="respon_inner">
						<dl>
							<dt>
								<p class="p1">커뮤니티 스토어와 함께하는 NGO</p>
								<p class="p2">대학로 커뮤니티 스토어의 <span class="black">장학금 재원 운영과<br>청년인재 양성 프로그램의 시너지 효과를 창출하기 위해</span> <br>스타벅스와 연계되어 있는 전국의 150여 NGO 중 초록우산 어린이재단과 손을 잡았습니다. </p> <!-- 20210802 수정 -->
								<p class="p3">1948년 설립된 국내 최대 아동복지 전문 비영리기관인 초록우산 어린이재단은<br>스타벅스와 지난 2006년부터 지역사회 결손 가정 어린이를 지원하는<br>임직원 매칭 그랜트 활동인 희망배달 캠페인을 비롯해,<br>유스 리더십 그랜트, 산타 바리스타, 희망나무 키우기 캠페인 등을 통해 지속적인 기부 <br>캠페인과 다양한 지역사회 봉사활동을 함께 전개해오고 있습니다.</p>
								<p class="p4">이제 초록 우산 어린이 재단은 스타벅스 커뮤니티 스토어의 소중한 파트너로써<br>청년인재 양성 프로그램을 성공적으로 수행해 나갈 방침입니다.</p>
							</dt>
							<dd>
								<img src="../common/img/responsibility/cms_pic3.jpg" alt="">
							</dd>
						</dl>
					</div>
				</section>
...
// 					});
		...
		<script>
			$(document).ready(function(){
				...
				controller.addTween(10, TweenMax.from($('.respon_cms_bg'), 1, {css:{top:-423, opacity:0}, ease: Quad.easeOut}), 1, 450);
