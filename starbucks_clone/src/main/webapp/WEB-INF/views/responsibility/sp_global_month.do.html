...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="../common/css/style_responsibility-3.css?v=210726" rel="stylesheet">
	</head>
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit13.jpg" alt="지구촌 봉사의 달"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="sp_global_month.do.html" class="this">지구촌 봉사의 달</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<section class="respon_section">
					<!-- 170201 이미지 수정 -->
					<p class="mb60"><img src="../common/img/responsibility/16global_slide_img2.jpg" alt=""></p>
					<!-- 170201 이미지 수정 end -->
					<!-- 170201 탭 수정 -->
					<dl class="sp_month">
						<dt class="box_bg"></dt>
						<dt class="dt1"><a href="javascript:void(0)" class="on">2016년</a></dt>
						<dd class="on">
							<ul class="sp_month_cont">
								<li class="li1">
									<div class="mySlideArea1">
										<div class="bxslide-main">
											<ul class="youth_slider_s1">
												<li><img src="../common/img/responsibility/gs_2016_img2.jpg?v=210726" alt=""></li> <!-- 20210726 이미지 수정 -->
												<li><img src="../common/img/responsibility/gs_2016_img3.jpg" alt=""></li>
												<li><img src="../common/img/responsibility/gs_2016_img4.jpg" alt=""></li>
											</ul>
											<div class="youth_slider_control_pager">
												<div class="youth_slider_s1_controls"></div>
												<div class="youth_slider_s1_pagers"></div>
											</div>
										</div>
										<div class="youthslide_btn_wrap">
								...
								<li class="li2">
									<p class="gt">“2016년, 여섯 번째 지구촌 봉사의 달을 맞이한 스타벅스는 4월 한 달 동안 지역사회 환경과 우리의 청년들에게 긍정적인 영향을 불러일으키는 다양한 활동을 전개했습니다.”</p>
									<p class="gc mb30">스타벅스는 커피박 자원재활용이라는 장기적인 목표를 가지고 환경부, 자원순환사회연대와 함께 ‘커피박 재활용에 관한 업무 협약’을 체결하였습니다. 이를 통해 전 세계 스타벅스 최초로 전국 매장에서 커피박을 수거하여 다양한 상품으로 재활용하는 자원 선순환 활동에 앞장서고 있습니다.</p><!-- 20210914 수정 -->
									<p class="gc mb30">이러한 친환경 활동의 일환으로, 스타벅스는 4년 연속 서울시와 함께 서울시청 광장에서 ‘서울, 꽃으로 피다’ 캠페인을 진행하며, 서울광장에 아메리카노 5만잔 분량의 커피박을 재활용하여 만든 대형 사이렌을 전시하고 5천여 명의 시민들과 함께 환경사랑의 의미를 공유하였습니다.</p><!-- 20210914 수정 -->
									<p class="gc mb30">또한 JA 코리아와 함께 특성화고등학교 3학년을 대상으로＜Barista Job Fair＞를 진행하여 이력서 작성법 교육, 모의면접, 바리스타 직업 체험 등의 프로그램을 운영하며 실질적인 진로 교육에 일조하고자 노력했습니다.</p>
									<p class="gc mb30">아울러 미래창조과학부, 청년위원회와 함께 ‘스타벅스 창업카페 시즌2’를 개시하여 스타벅스 매장에서 예비 청년 창업가들이 교류할 수 있는 장을 열었고, 재능기부카페 6호점이 광주광역시에 문을 열며 청년들에게 미래의 기회를 열어주고 꿈을 응원하기 위한 다양한 활동을 전개하였습니다.</p>
									<p class="gc">이처럼 스타벅스 지구촌 봉사의 달 한 달 동안 전국 1,802명의 바리스타들이 지역사회 곳곳에서 총 5,318시간의 자원봉사 활동에 참여하였으며, 전국적으로 참여고객 및 수혜자가 7만 4천여 명을 넘어섰습니다.</p><!-- 20210914 수정 -->
								</li>
							</ul>
						</dd>
						<dt class="dt2"><a href="javascript:void(0)">2015년</a></dt>
						<dd>
							<ul class="sp_month_cont">
								<li class="li1">
									<div class="mySlideArea2">
										<div class="bxslide-main">
											<ul class="youth_slider_s2">
												<li><img src="../common/img/responsibility/gs_2015_img1.png" alt=""></li>
												<li><img src="../common/img/responsibility/gs_2015_img2.png" alt=""></li>
												<li><img src="../common/img/responsibility/gs_2015_img3.png" alt=""></li>
											</ul>
											<div class="youth_slider_control_pager">
												<div class="youth_slider_s2_controls"></div>
												<div class="youth_slider_s2_pagers"></div>
											</div>
										</div>
										<div class="youthslide_btn_wrap">
											<p class="prevBtn"><a href="javascript:void(0)">이전 버튼</a></p>
								...
								<li class="li2">
									<p class="gt">“2015년, 다섯 번째 지구촌 봉사의 달을 맞이한 스타벅스는 <br>4월 한 달 동안 전 세계의 청년들과 지역사회에 <br>긍정적인 변화를 일으키고자 다양한 활동을 전개했습니다.</p><!-- 20210914 수정 -->
									<p class="gc mb30">국내에서도 스타벅스는 ‘재능기부 카페’ 5호점 개점과 함께 여성가족부와 청소년 자립 지원을 위한 업무 협약을 맺고, 청소년들을 위한 바리스타 직업교육을 점진적으로 펼쳐 나갈 예정입니다. <br>또한 전국적으로 114개의 매장에서 바리스타 직업을 소개하는 특별한 커피 세미나를 <br>개최하였습니다.</p>
									<p class="gc mb30">이뿐만 아니라, 스타벅스는 3년째 서울시와 함께 서울시청 광장에서<br>‘서울, 꽃으로 피다’ 캠페인을 진행하였으며, 지역 곳곳에서 환경 캠페인을 후원하며 더 많은 고객분들과 함께 지역사회 활동에 참여하였습니다. </p><!-- 20210914 수정 -->
									<p class="gc"> 이처럼 다양한 활동을 통해 스타벅스 지구촌 봉사의 달 한 달 동안 전국 1,024명의 바리스타들이 지역사회 곳곳에서 총 5,968시간의 자원봉사 활동에 참여하였으며, 이를 통해 국내의 8천여 명의 청소년 및 청년들과 함께하는 기회를 가졌습니다. </p><!-- 20210914 수정 -->
								</li>
							</ul>
						</dd>
						<dt class="dt3"><a href="javascript:void(0)">2014년</a></dt>
						<dd>
							<ul class="sp_month_cont">
								<li class="li1">
									<div class="mySlideArea3">
										<div class="bxslide-main">
											<ul class="youth_slider_s3">
												<li><img src="../common/img/responsibility/gs_2014_img1.png" alt=""></li>
												<li><img src="../common/img/responsibility/gs_2014_img2.png" alt=""></li>
												<li><img src="../common/img/responsibility/gs_2014_img3.png" alt=""></li>
											</ul>
											<div class="youth_slider_control_pager">
												<div class="youth_slider_s3_controls"></div>
												<div class="youth_slider_s3_pagers"></div>
											</div>
										</div>
										<div class="youthslide_btn_wrap">
											<p class="prevBtn"><a href="javascript:void(0)">이전 버튼</a></p>
								...
								<li class="li2">
									<p class="gt">“스타벅스는 2014년 네 번째로 지구촌 봉사의 달을 맞아 4월 한 달 동안 전 세계 지역사회 발전에 이바지하는 다양한 봉사활동을 전개했습니다.”</p><!-- 20210914 수정 -->
									<p class="gc mb30">국내에서는 ‘서울숲 공원돌보미’ 활동으로 지역사회 환경보호활동을 개시하였으며 작년에 이어 서울시와 함께 서울시청 광장에서 진행한 ‘서울, 꽃으로 피다’ 캠페인에는 스타벅스 파트너와 5천여 명의 고객들이 참여하였습니다. 이 외에도 아름다운 제주 올레의 환경보호를 위한 ‘클린올레’ 활동, 부산전포종합사회복지관과 대전혜광학교의 장애인 바리스타들을 위한 커피 재능기부 등 다양한 활동을 펼쳤습니다. 4월 한 달간 전국 스타벅스 파트너들이 5천여 명의 고객 및 NGO 관계자들과 함께 170여 건의 봉사활동을 펼쳐, 15,000 시간의 지역사회 활동에 동참하였습니다.</p>
									<p class="gc mb30">스타벅스는 윤리구매, 환경 보호, 지역사회 참여 등을 주요 활동 축으로 하는 사회 공헌 활동의 일환으로 ‘지구촌 봉사의 달(Global Month of Service)’를 2011년부터 전개하고 있으며 2015년까지 전 세계적으로 모두 100만 시간의 자원봉사 활동을 달성하기로 선언한 바 있습니다.</p><!-- 20210914 수정 -->
									<p class="gc">처음 시작한 2011년 4월 한 달간 전 세계 4개 대륙 30개국에서 6만여 자원봉사자들이 참여해 15만 6천 시간에 달하는 봉사 활동 이전 세계에서 이루어졌습니다.  이는 1년간 76명의 풀타임 근무 시간에 상당하는 시간입니다. 스타벅스 코리아도 같은 해 4월 한 달 동안 87개 지역 사회 단체들과 190여 활동을 통해 3,000여 시간의 자원봉사 활동을 전개하였습니다.</p><!-- 220112 수정 -->
								</li>
							</ul>
						</dd>
					</dl>
...
// 					});
		...
		<script>
			$(document).ready(function(){
				...
				var spSlide = $('.sp_slider').bxSlider({
					minSlides: 3,
					maxSlides: 3,
					slideWidth: 271,
					slideMargin: 50,
					...
					auto: true,
					pager: true,
					pagerSelector:'.sp_slider_pagers',
					autoControlsSelector:'.sp_slider_controls'
				});

				$(".spSlideArea p.prevBtn a").on("click",function(e){
					spSlide.goToPrevSlide();
					e.preventDefault();
				});

				$(".spSlideArea p.nextBtn a").on("click",function(e){
					spSlide.goToNextSlide();
					e.preventDefault();
				});
				/* 150613 성연욱 - 지구촌 봉사의 달 end */
				/* jsp 추가 - 150625 성연욱 - 윤리경영 보고서 수정 */
				$('dl.sp_month > dt > a').bind('click', function(){
					$('dl.sp_month > dt > a').removeClass('on');
					$(this).addClass('on');
					$('dl.sp_month > dd').hide();
					$(this).parent().next().show();
					// 150716 DOM 수정
					mySlide_s1.reloadSlider();
					mySlide_s2.reloadSlider();
					mySlide_s3.reloadSlider();
					// 150716 DOM 수정 end
				});
				/* jsp 추가 - 150625 성연욱 - 윤리경영 보고서 수정 end */
				// jsp 추가 -150630
				$('dl.sp_month dt.box_bg, dl.sp_month dt a').bind('click', function(){
					var ww = $(window).width();
					if(ww <= 640){
						if($('dl.sp_month dt.dt1 a').hasClass('on')){
							$('dl.sp_month dt.dt1').css({left:10, top:10});
							$('dl.sp_month dt.dt2').css({left:10, top:35});
							$('dl.sp_month dt.dt3').css({left:10, top:60});
						}else if($('dl.sp_month dt.dt2 a').hasClass('on')){
							$('dl.sp_month dt.dt1').css({left:10, top:35});
							$('dl.sp_month dt.dt2').css({left:10, top:10});
							$('dl.sp_month dt.dt3').css({left:10, top:60});
						}else if($('dl.sp_month dt.dt3 a').hasClass('on')){
							$('dl.sp_month dt.dt1').css({left:10, top:35});
							$('dl.sp_month dt.dt2').css({left:10, top:60});
							$('dl.sp_month dt.dt3').css({left:10, top:10});
						}
						if($('dl.sp_month dt.box_bg').css('height')=='35px'){
							$('dl.sp_month dt.box_bg').stop().animate({height: 88}, 500, function(){
								$('dl.sp_month > dt > a').css({display: 'block'});
							});
						}else{
							$('dl.sp_month dt.box_bg').css({height: 35});
							$('dl.sp_month > dt > a:not(.on)').css({display: 'none'});
						}
					}
				});
				// jsp 추가 -150630 end
				
				// 150716 DOM 수정 - 성연욱 추가
				...
				var mySlide_s3 = $('.youth_slider_s3').bxSlider({
					pause: 5000,
					speed: 2000,
					// mode: 'fade',
					controls: true,
					...
					auto: true,
					pager: true,
					pagerSelector:'.youth_slider_s3_pagers',
					autoControlsSelector:'.youth_slider_s3_controls'
				});

				$(".mySlideArea3 p.prevBtn a").on("click",function(e){
					mySlide_s3.goToPrevSlide();
					e.preventDefault();
				});

				$(".mySlideArea3 p.nextBtn a").on("click",function(e){
					mySlide_s3.goToNextSlide();
					e.preventDefault();
				});
				// 150716 DOM 수정 - 성연욱 추가  end
			});
		</script>
	</div></body>
