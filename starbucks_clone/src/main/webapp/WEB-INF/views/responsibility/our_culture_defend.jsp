			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/responsibility/tit7.jpg" alt="우리 문화 지키기"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li class="en"><a href="our_culture_defend.do.html" class="this">우리 문화 지키기</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="respon_wrap">
					<section class="respon_section">
						...
						<div class="youthSlideArea">
							<div class="bxslide-main">
								<ul class="youth_slider">
									<li><img src="../common/img/responsibility/culture_slide_img1.jpg" alt=""></li>
									<li><img src="../common/img/responsibility/culture_slide_img2.png" alt=""></li>
									<li><img src="../common/img/responsibility/culture_slide_img3.jpg" alt=""></li>
								</ul>
						...
						<!-- 사회공헌 대표 슬라이드 영역 end -->
						<p class="res_gt2">“스타벅스 코리아는 2008년 2월부터 우리 문화재 지키기 캠페인을 전개해 오고 있습니다. ”</p> <!-- 220112 수정 -->
						<p class="agri_txt1">그 첫 번째 활동으로 숭례문 인근 무료 커피 봉사와 함께 숭례문 텀블러 모금 행사를 실시해 목조 건축용 이산화탄소 소화기 74대를 경기도 소방재난본부에 전달하였습니다. <br>본 소화기는 화성 행궁, 남한산성 행궁, 수원 향교회관, 장경사, 망월사, 칠장사 등 경기도 내 20개 목조 문화재에 비치되었습니다.</p>
						<p class="agri_txt1">또한 2009년 문화재청과 ‘한 문화재 한 지킴이’ 협약식을 맺고 정기적으로 고궁 청소활동 등 문화재 곳곳에서 다양한 활동을 전개해 오고 있습니다.</p>
						<p class="agri_txt1">특히 매년 봄, 가을 진행되는 ‘정관헌에서 명사와 함께’는 고종 황제가 커피와 함께 연회를 즐겼던 역사적 장소인 덕수궁 정관헌에서 문화, 사회 전반의 유명인사를 초청하여 강연을 들을 수 있는 행사로, <br>스타벅스는 행사 후원 및 직원 봉사 활동 등을 지원하고 있습니다. <!-- <br>그동안 ‘정관헌에서 명사와 함께’ 행사를 통해 작가 조정례 씨, 신경숙 씨, 연극인 손숙 씨, 혜민 스님, 아나운서 김주하 씨 등 40여명의 명사들이 청중들과 함께 했습니다. 20210820 문구삭제 --></p>
						<p class="agri_txt3">더불어, 한글 간판으로 꾸며진 스타벅스 광화문점, 인사점, 경복궁역점, 안국역점이 한국문화연대가 선정한 ‘2011년 우리말 사랑꾼’으로 선정되기도 했습니다. <br>스타벅스는 11년간 고궁문화행사 후원 및 주요 문화재 기부, 복원 후원 활동 등 다양하게 펼쳐온 문화유산 보호 활동 공로를 인정받아 2019년도 문화유산보호 유공자 포상 대통령 표창을 수여받았습니다.</p> <!-- 20210820 문구수정 -->
					</section>
				</div>
			</div>
			<!-- container end -->
