...
var eFrequencyPlannerYn = 'Y';
	...
	<link href="../common/css/style_main-3.css?v=181022" rel="stylesheet">
	<link href="../common/css/style_whatsnew-4.css?v=181022" rel="stylesheet">
	<link href="../common/css/2022summer_style_efreq_gift.css?v=220504" rel="stylesheet"> <!-- 220504 캐싱처리 -->
	...
	<li class="util_nav04"><a href="../store/store_map.do.html">Find a Store</a></li>
		...
		<div class="sub_tit_wrap">
			<div class="sub_tit_inner">
				<h2>
					<img src="../upload/common/img/util/efreq/m_2022summer_frequency_gift_tit.jpg" class="mo-img" alt="서머 e-프리퀀시 증정품 안내">
					<img src="../upload/common/img/util/efreq/2022summer_frequency_gift_tit.jpg" class="pc-img" alt="서머 e-프리퀀시 증정품 안내">
				</h2>
				<ul class="smap">
					...
					<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
					<li><a href="eFreq_gift.do.html" class="this">e-프리퀀시 증정품</a></li>
				</ul>
			</div>
		</div>
		<!-- 서브 타이틀 end -->
		...
		<!-- container -->
		<div id="container">
			<div class="summer_efreq_gift"> <!-- 220420 클래스 수정  -->
				<!-- 증정품 상단 -->
				<section class="section_wrap gift">
					<h2 class="hid">MY TRAVEL BUDDY 우리의 즐거운 여행에 함께할 22 서머 e-프리퀀시 선물을 소개 합니다.</h2>
					<div class="section_cont">
						<div class="section_cont_inner">
							<img src="../upload/common/img/util/efreq/m_2022summer_section1_contents.png" class="mo-img" alt="22 SUMMER e-FREQUENCY">
							<img src="../upload/common/img/util/efreq/2022summer_section1_contents.png" class="pc-img" alt="22 SUMMER e-FREQUENCY">
						</div>
					</div>
				</section>
				<!-- //증정품 상단 -->  
				...
				<!-- 캐리백 소개 -->
				<section class="section_wrap carrybag"> <!--  220420 클래스 수정 -->
					<h2 class="hid">STARBUCKS SUMMER CARRY BAG</h2>
					<div class="section_cont">
						<div class="section_cont_inner">
							<img src="../upload/common/img/util/efreq/m_2022summer_section2_contents.png" class="mo-img" alt="스타벅스 서머 캐리백 소개. 서머 캐리백 레드(증정용), 서머 캐리백 크림(증정용), 서머 캐리백 그린(증정용)">
							<img src="../upload/common/img/util/efreq/2022summer_section2_contents.png" class="pc-img" alt="스타벅스 서머 캐리백 소개. 서머 캐리백 레드(증정용), 서머 캐리백 크림(증정용), 서머 캐리백 그린(증정용)">
						</div>
					</div>
				</section>
				<!-- //캐리백 소개 -->
				...
				<!-- 캐빈 파우치 소개 -->
				<section class="section_wrap cabinpouch"> <!--  220420 클래스 수정 -->
					<h2 class="hid">STARBUCKS SUMMER CABIN POUCH</h2>
					<div class="section_cont">
						<div class="section_cont_inner">
							<img src="../upload/common/img/util/efreq/m_2022summer_section3_contents.png" class="mo-img" alt="스타벅스 서머 캐빈 파우치 소개. 서머 캐빈 파우치 핑크(증정용), 서머 캐빈 파우치 그린(증정용)">
							<img src="../upload/common/img/util/efreq/2022summer_section3_contents.png" class="pc-img" alt="스타벅스 서머 캐빈 파우치 소개. 서머 캐빈 파우치 핑크(증정용), 서머 캐빈 파우치 그린(증정용)">
						</div>
					</div>
				</section>
				<!-- //캐빈 파우치 소개 -->
				...
				<!-- 서머 코지 후디 소개 -->
				<section class="section_wrap cozyhoodie"> <!--  220420 클래스 수정 -->
					<h2 class="hid">STARBUCKS SUMMER COZY HOODIE</h2>
					<div class="section_cont">
						<div class="section_cont_inner">
							<img src="../upload/common/img/util/efreq/m_2022summer_section4_contents.png" class="mo-img" alt="스타벅스 서머 코지 후디 소개. 서머 코지 후디 블랙(증정용), 서머 코지 후디 핑크(증정용)">
							<img src="../upload/common/img/util/efreq/2022summer_section4_contents.png" class="pc-img" alt="스타벅스 서머 코지 후디 소개. 서머 코지 후디 블랙(증정용), 서머 코지 후디 핑크(증정용)">
						</div>
					</div>
				</section>
				<!-- //서머 코지 후디 소개 -->
				...
				<!-- 프리퀀시 연계상품 소개 -->
				<section class="section_wrap product">
					<h2 class="hid">STARBUCKS e-프리퀀시 연계 상품</h2>
					<p class="hid">22 서머 e-프리퀀시 연계 상품을 매장에서 만나보세요.</p>
					<div class="section_cont">
						<div class="section_cont_inner">
							<img src="../upload/common/img/util/efreq/m_2022summer_section5_contents.png" class="mo-img" alt="STARBUCKS 22 서머 e-프리퀀시 연계 상품을 매장에서 만나보세요"><!-- 220429 alt 내용 수정 -->
							<img src="../upload/common/img/util/efreq/2022summer_section5_contents.png" class="pc-img" alt="STARBUCKS 22 서머 e-프리퀀시 연계 상품을 매장에서 만나보세요"><!-- 220429 alt 내용 수정 -->
							<!-- dev : 220429 a태그 삭제 -->
						</div>
					</div>
				</section>
				...
				<!-- 증정품 관련 유의 사항 -->
				<section class="section_wrap notice">
					<h2 class="hid">e-프리퀀시 증정품 관련 유의 사항</h2>
					<div class="section_cont">
						<img src="../upload/common/img/util/efreq/m_2022summer_section6_contents.png" class="mo-img" alt="교환/불량/소진 시 운영 안내, 스타벅스 캐리백 취급 시 주의사항, 스타벅스 캐빈파우치 취급 시 주의사항, 스타벅스 코지 후디 취급 시 주의사항">
						<img src="../upload/common/img/util/efreq/2022summer_section6_contents.png" class="pc-img" alt="교환/불량/소진 시 운영 안내, 스타벅스 캐리백 취급 시 주의사항, 스타벅스 캐빈파우치 취급 시 주의사항, 스타벅스 코지 후디 취급 시 주의사항">
					</div>
				</section>
				<!-- //증정품 관련 유의 사항-->
			</div>			
...
// 					});
	...
	<script src="../common/js/gift_summer2021.js"></script>
