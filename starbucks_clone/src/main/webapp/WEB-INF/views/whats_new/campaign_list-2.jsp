					...
					<nav class="mob_gnb_menus">
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="campaign_list">전체</a></li>
									<li><a href="campaign_list-1?menu_cd=STB2812">스타벅스 카드</a></li>
									<li><a href="campaign_list-2?menu_cd=STB2813">스타벅스 리워드</a></li> <!-- 스타벅스 리워드 수정 -->
									<li><a href="campaign_list-3?menu_cd=STB2814">온라인</a></li>
									
									
										<li><a href="eFreq_gift">e-프리퀀시 증정품</a></li> <!-- 20210423 메뉴명, 경로 수정 -->
							...
							<li>
								...
								<ul>
									<li><a href="news_list">전체</a></li>
									<li><a href="news_list-1?cate=N01">상품 출시</a></li>
									<li><a href="news_list-2?cate=N02">스타벅스와 문화</a></li>
									<li><a href="news_list-3?cate=N03">스타벅스 사회공헌</a></li>
									<li><a href="news_list-4?cate=N04">스타벅스 카드출시</a></li>
								</ul>
							</li>
							<li>
								<a role="button" href="javascript:void(0);">매장별 이벤트<span class="mob_gnb_arrow_down"></span></a><!-- 접근성_20171106 role 추가 -->
								<ul>
									<li><a href="store_event_list">일반 매장</a></li>
									<li><a href="store_event_list-1?search_date=1&tab=1">신규 매장</a></li>
								</ul>
							</li>
							<li><a href="notice_list">공지사항</a></li>
							<li><a href="wallpaper">월페이퍼</a></li>
						</ul>
					</nav>
				</div>
			</div>
        ...
        <script>
            ...
            function getEndList(menu_cd) {
                ...
                if(menu_cd != "") {
                    ...
                    __ajaxCall('/whats_new/getEndList', option , true, "JSON", "POST", 
                    function(data) {
                        if(data.list.length > 0) {
