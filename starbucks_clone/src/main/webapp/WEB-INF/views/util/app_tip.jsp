...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="../common/css/style_csi-1.css?v=210218" rel="stylesheet">
	</head>
		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="어플리케이션 이용 팁" src="../common/img/util/csi/csi_appTip_ttl.png"></h4>
							<ul class="smap">
				...
				<div class="ms_cont_wrap">
					<!-- ms_cont -->
					<div class="ms_cont">
						<div class="csi_appTip_cont">
							<div class="csi_appTip_img">								
								<p>
									<!-- 160830 사이렌오더 링크 없앰 -->
									<a href="javascript:void(0);">
									<img src="../common/img/util/csi/csi_appTip_img.png?v=210810" alt="스타벅스 홈페이지 이용 시 유용한 꿀팁과 노하우를 소개합니다. 검색을 통해서도 찾으실 수 있습니다."> <!-- 20210809 수정 -->
									</a>
									<!-- 160830 사이렌오더 링크 없앰 end -->
								</p>
							</div>
						
							<div class="csi_appTip_info">
								<p>스타벅스 애플리케이션으로 스타벅스의 모든 정보를 쉽고 편리하게 만나보세요.</p><!-- 20210809 수정 -->
							</div>
							<section class="csi_application">
								<article class="csi_application_inner">
									<div class="csi_app_wrap">
										<dl>
											<dt>스타벅스 애플리케이션</dt>
											<!-- <dd>스타벅스 애플리케이션은 스타벅스 리워드, 스타벅스 카드 e-Gift,<br>사이렌 오더, e-프리퀀시, e-쿠폰 선물하기 등, 스타벅스를 보다 편리하고<br>스마트하게 사용하실 수 있는 애플리케이션입니다.</dd> -->
											<!-- 151005 DOM 수정 - 문구 수정 -->
											<dd>스타벅스 애플리케이션은 스타벅스 리워드, 스타벅스 카드, e-Gift 카드, <br>사이렌 오더 메뉴 주문 및 e-Gift Item 선물, Gift, Coupon, <br>e-Frequency, 홀케이크 선물/예약 등의 서비스를 편리하고 스마트하게 사용하실 수 있는 스타벅스 코리아의 공식 애플리케이션입니다.</dd> <!-- 220112 수정 -->
											<!-- 151005 DOM 수정 - 문구 수정 end -->
										</dl>
										<ul class="csi_app_btnzone">
											<!-- 160810 이미지 수정 -->
											<li class="csi_app_btn01">
												<a href="https://play.google.com/store/apps/details?id=com.starbucks.co">
													<img class="w_pic" src="../common/img/util/csi/csi_app_btn01.png" alt="">
													<img class="m_pic" src="../common/img/util/csi/m_csi_app_btn01.png" alt="">
												</a>
											</li>
											<li class="csi_app_btn02">
												<a href="https://itunes.apple.com/kr/app/seutabeogseukadeu/id466682252?mt=8">
													<img class="w_pic" src="../common/img/util/csi/csi_app_btn02.png" alt="">
													<img class="m_pic" src="../common/img/util/csi/m_csi_app_btn02.png" alt="">
												</a>
											</li>
											<!-- 160810 이미지 수정 end -->
										</ul>
										<!-- <ul class="csi_app_infoTip">
											<li>스타벅스 애플리케이션은 안드로이드 4.0(ICS) 및 iOS 6 이상 버전에 <br>최적화 되어 있습니다.</li>
											<li>갤럭시 S2 및 iPhone 4 이상의 기종에 최적화 되어 있으며, 일부 스마트폰의 <br>기종 및 OS 버전에 따라 정상동작 하지 않거나 설치되지 않을 수 있습니다.</li>
										</ul> -->
										<ul class="csi_app_infoTip">
											<li>일부 기종 및 OS버전에 따라 정상동작 하지 않거나 설치되지 않을 수 있습니다.</li> <!-- 20210226 문구수정 -->
										</ul>
									</div>									
								</article>
							</section>
							...
							<!-- 검색 -->
						 	...
						 	<div class="csi_appTip_sch_wrap">
								<form action="" method="post" onsubmit="return false">
									<fieldset>
										<legend>어플리케이션 이용 팁 검색</legend>										
										<div class="csi_appTip_sch_input">
											<input type="text" name="csi_appTip_bar01" id="csi_appTip_bar01" placeholder="검색어를 입력하세요."> <a href="javascript:searchBtn('STB2708', 'app');" class="sch_btn">검색</a>
										</div>
									</fieldset>
								</form>
							</div>
							...
							<p class="csi_appTip_total" id="listCnt"><!-- <span>총 12개 이용안내</span> --></p>
							<section class="csi_appTip_list">
								<ul class="csi_aTip_list" id='app_tipList'>
								</ul>
							</section>
							<!-- 페이징 -->
							<div class="csi_aTip_list_pagination">
								<ul class="pager">
								</ul>
							</div> 
							<!-- 페이징 end -->
...
// 					});
			...
			<script src="../common/js/customer/starbuk_tip.js"></script>
		<script>
			var page  = 1;
			var menu_cd = "STB2708";//어플리케이션 이용팁
			var status = "app";
			var  searchKeyword = "";
