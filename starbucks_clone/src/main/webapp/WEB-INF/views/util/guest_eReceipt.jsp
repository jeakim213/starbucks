                ...
                <div class="ms_sub_tit_bg">
                    <div class="ms_sub_tit_inner">
                        ...
                        <ul class="smap">
                            ...
                            <li><img class="arrow" src="common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
                            <li><a href="guest_eReceipt">비회원 전자영수증 조회</a></li><!-- 20181029 텍스트 수정 -->
                        </ul>
                    </div>
                </div>
            </header>
											...
											<fieldset class="mem_captcha_field">
												...
												<div class="mem_captcha_input_wrap">
													<dl>
														...
														<dd>
															<p class="mem_captcha_img"><img alt="" src="mem/captcha"></p>
...
// 					});
        ...
        function captchaReload() {
            ...
            setTimeout(function() {
                $(".mem_captcha_img > img").attr("src", "mem/captcha?rndCod="+randomString());
            }, 150);
        ...
        function getCardAppInfo() {
            ...
            ___ajaxCall("interface/getInipayAppInfo", param, false, "json", "post", function (_response) {
            	var $tbl = $('#tblAppList tbody');
            	
                if (_response.result_code == "SUCCESS") {
                	if (typeof _response.data === 'undefined' || _response.data == null) {
                		$tbl('<tr><td colspan="5">데이터가 없습니다.</td></tr>');
		...
		function getSsgAppInfo() {
			var param = $('#searchForm').serialize();
		    ___ajaxCall("interface/getSsgAppInfo", param, false, "json", "post", function (_response) {
		    	var $tbl = $('#tblAppList tbody');
