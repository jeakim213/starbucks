...
var eFrequencyPlannerYn = 'Y';
    ...
    <link href="../common/css/style_mem-1.css" rel="stylesheet">
    <link href="../common/css/style_util2-1.css" rel="stylesheet"><!-- 20181029 추가 --> 
</head>
<body>
	...
	<div class="pop_receipt" style="display:none;">
	    <div class="pop_receipt_header">
	        ...
	        <a class="pop_receipt_print" href="javascript:void(0);"><img src="../common/img/receipt/pop_receipt_print.png" alt="">인쇄</a>
...
<div class="receipt_wrap">
	<div class="receipt_header" style="display:none;">
		<figure class="ttl_logo">
			<img src="../common/img/receipt/receipt_logo.png" alt="">
		</figure>
		<strong></strong>
	</div>
...
<ul>
	...
	<li class="util_nav04"><a href="../store/store_map.do.html">Find a Store</a></li>
        ...
        <div id="container">
            ...
            <header class="ms_sub_tit_wrap">
                <div class="ms_sub_tit_bg">
                    <div class="ms_sub_tit_inner">
                        <!-- 20181029 텍스트, 이미지 수정 -->
                        <h4><img alt="비회원 전자영수증 조회" src="../common/img/util/nomemberReceipt_ttl.png"></h4>
                        <!-- 20181029 텍스트, 이미지 수정 -->
                        <ul class="smap">
                            ...
                            <li><img class="arrow" src="../common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
                            <li><a href="guest_eReceipt.do.html">비회원 전자영수증 조회</a></li><!-- 20181029 텍스트 수정 -->
                        </ul>
                    </div>
                </div>
            </header>
            ...
            <!-- s::20181029 비회원 전자영수증 조회 추가-->
            <!-- 내용 -->
            <div class="ms_cont_wrap">
                <div class="ms_cont">
                    <header class="nomemberTitle">
                        <h6>전자영수증 조회를 위해 아래 항목을<br class="for_mob"> 입력해 주세요.</h6>
                    </header>
                    <!-- 기간선택 -->
						<!-- 20181115 비회원 전자영수증 조회 -->
						<div class="nomemberArea"><!-- 20181115 태그추가 -->
						<form id="searchForm">
							<!-- 기간선택 -->
							<section class="my_card_pick_period nomemberReceipt">
								<fieldset>
									<legend>기간 선택 폼</legend>
									<div class="my_card_pick_date1 dealArea">
										<dl class="my_card_pick_bg withAll">
											<dt>거래유형</dt>
											<dd>
												<input id="dealType1" name="order" type="radio" value="siren" checked="checked">
												<label for="dealType1">사이렌 오더(비회원)</label>
										...
										<dl class="my_card_pick_bg withAll">
											<dt>결제수단</dt>
											<dd>
												<input id="paymentType1" name="svcCd" type="radio" value="03" checked="checked">
												<label for="paymentType1">신용카드</label>
												<input id="paymentType2" name="svcCd" type="radio" value="21">
												<label for="paymentType2">SSGPAY 머니</label>
												<input id="paymentType3" name="svcCd" type="radio" value="01">
												<label for="paymentType3">SSGPAY 카드</label>
											</dd>
											<dd class="payAreaTxt">
												<p>* SSGPAY 복합 결제 건 조회 시 ‘SSGPAY카드’를 선택해 주세요.</p>
											</dd>
										</dl>
									</div>
									
									<div class="my_card_pick_date2 dealArea">
										<dl class="my_card_pick_date">
											<dt>거래일자</dt>
											<dd>
												<div class="pick_date_each">
													<div class="pick_date_each_left"><input id="appDt" name="appDt" title="원하는 날짜를 선택해 주세요." type="text"></div>
													<div class="pick_date_each_right"><label for="appDt">날짜 선택</label></div>
												</div>
											</dd>
										</dl>
										<!-- 20181115 결제수단 신용카드 선택시 -->
										<dl class="card_regi_dl dealTypeArea creditCheck"><!-- 20181115 신용카드 선택시 class="creditCheck" 추가 -->
											<dt id="serachCardNumberViewDt">카드번호</dt>
											<dd id="serachCardNumberViewDd">
												<input id="cardN1" name="cardN1" class="card_regi_input2" title="카드번호 첫째 자리" ref="num" type="tel" pattern="[0-9]*" inputmode="numeric" maxlength="4" oninput="maxLengthCheck(this, 'cardN2')">
												<span class="hyphen_bg17"></span>
												<input id="cardN2" name="cardN2" class="card_regi_input2 pass" title="카드번호 둘째 자리" ref="num" type="password" pattern="[0-9]*" inputmode="numeric" maxlength="4" oninput="maxLengthCheck(this, 'cardN3')">
												<span class="hyphen_bg17"></span>
												<input id="cardN3" name="cardN3" class="card_regi_input2 pass" title="카드번호 셋째 자리" ref="num" type="password" pattern="[0-9]*" inputmode="numeric" maxlength="4" oninput="maxLengthCheck(this, 'cardN4')">
												<span class="hyphen_bg17"></span>
												<input id="cardN4" name="cardN4" class="card_regi_input2" title="카드번호 넷째 자리" ref="num" type="tel" pattern="[0-9]*" inputmode="numeric" maxlength="4" oninput="maxLengthCheck(this)">
											</dd>
											<dt>승인번호</dt>
                                               <dd class="approvalCheck">
                                                   <input name="appNo" id="appNo" class="card_regi_input2 approvalInpit" title="승인번호" type="tel" pattern="[0-9]*" maxlength="30">
                                                   <p id="searchAppNoText">* 승인번호는 카드사에 확인하시기 바랍니다.</p>
                                               </dd>
                                               <dt>결제금액</dt>
                                               <dd class="paymentCheck">
                                                   <input name="amt" id="amt" class="card_regi_input2 paymentInpit" title="결제금액" type="tel" pattern="[0-9]*" maxlength="20">
                                                   <em>원</em>
                                               </dd>
										</dl>
										<!-- //20181115 결제수단 신용카드 선택시 -->
									...
									<div class="noteArea">
										<dt>유의사항</dt>
										<dd>
											결제 당사자의 거래내역 조회에 한하며, <span>타인의 거래를 임의로 조회함으로 인한 문제 발생 시 모든 책임은 조회 당사자</span>에게 있습니다.
										</dd>
									</div>
									<!-- //20181115 유의사항 추가 -->
								</fieldset>
							...
							<section class="renew_joinform_v2 mem_captcha dtCaptcha">
								<dl>
									<dt>보안문자</dt>
									<dd>
										<div class="captcha_infoInput_text">
											<p class="captcha_guidet">비회원 전자영수증 조회를 위해서, 보안문자를 함께 입력하셔야 합니다. 아래 이미지의 보안문자를 보이는 대로 입력해주세요.</p>
										</div>
										<div class="mem_captcha_frm">
											<fieldset class="mem_captcha_field">
												...
												<div class="mem_captcha_input_wrap">
													<dl>
														<dt class="hid"><label for="captcha" class="hid">보안문자</label></dt><!-- 접근성_20171120 : 레이블 추가 -->
														<dd>
															<p class="mem_captcha_img"><img alt="" src="/mem/captcha.do"></p>
															<a class="btn_login btn_new_captcha" href="javascript:void(0);" role="button">새로<br>고침</a><!-- 접근성_20171120 role 추가 -->
															<input id="captcha" name="captcha" type="text" maxlength="10" title="보안문자">
														</dd>
													</dl>
												</div>
											</fieldset>
							...
							<div class="card_regi_btn1"><a id="searchBtn" href="javascript:void(0);">조회</a></div>
						</form>
						</div>
                            
                    <p class="receipt_tb_notice mb10 noMemberNotice">비회원 사이렌 오더를 통해 주문하신 건에 한하여 전자영수증을 <br class="for_mob">확인하실 수 있습니다.</p>
                    <table id="tblAppList" class="card_use_info_tbl noMember" summary="카드사, 승인일시, 승인금액, 전자영수증에 대한 테이블">
                        <caption>카드사, 승인일시, 승인금액, 전자영수증에 대한 테이블</caption>
                        <colgroup>
                            <col width="10%">
                            <col width="25%">
                            <col width="25%">
                    ...
                    <script id="cardAppInfoList" type="text/x-jquery-tmpl">
                        <tr>
                            <td>${$item.seq()}</td>
                            <td>${$item.cardNm()}</td>
                            <td>${$item.date()}</td>
                            ...
                            <td class="lastTd">
                                {{if tid != null && tid != "" }}
                                    <a href="javascript:void(0)" data-tid="${tid}" class="btnReView">보기</a>
                                {{/if}}
                            </td>                           
                        </tr>
                    </script>
					...
					<script id="ssgAppInfoList" type="text/x-jquery-tmpl">
                        <tr>
                            <td>${$item.seq()}</td>
                            <td>${$item.cardNm()}</td>
                            <td>${$item.date()}</td>
...
// 					});
        ...
        function setEvent(){
        	...
        	//현재 날짜를 결제일자에 셋팅
        	$('#appDt').datepicker("setDate", new Date());
        	
        	
        	$('input[name=svcCd]').on('change', function(){
        		if (this.value == '03') { //신용카드 선택
        			$('#serachCardNumberViewDt').show();
        			$('#serachCardNumberViewDd').show();
        			$('dl.dealTypeArea dt').eq(1).css('margin-top', '15px');
        			$('#searchAppNoText').text('* 승인번호는 카드사에 확인하시기 바랍니다.');
        			
        		} else {
        			$('#serachCardNumberViewDt').hide();
        			$('#serachCardNumberViewDd').hide();
        			$('dl.dealTypeArea dt').eq(1).css('margin-top', '0px');
        			$('#searchAppNoText').text('* 승인번호는 SSG PAY 앱에서 확인하시기 바랍니다.');
        		}
        	});
        	
        	$('#searchBtn').on('click', _.debounce(searchList, 250));
        	
        	
        	$(".btn_new_captcha").on("click", _.debounce(captchaReload, 250));
        	
            
         	$('#amt').on('keyup', function(){
         		this.value = $.number(this.value);
         	});
         	$('#amt').on('focusout', function(){
         	    this.value = $.number(this.value);
            });
         ...
         * 승일일시로 변환하기 위한 함수
         */
        function getDateFormatConvert(date, time) {
        	if (typeof date !== 'undefined' && date.length == 8) {
        		date = date.substr(0, 4) + '-' + date.substr(4, 2) + '-' + date.substr(6, 2);
        	}
        	if (typeof time !== 'undefined' && time.length >= 4) {
        ...
        function captchaReload() {
        	$(".mem_captcha_img > img").removeAttr("src");
            setTimeout(function() {
                $(".mem_captcha_img > img").attr("src", "/mem/captcha.do?rndCod="+randomString());
            }, 150);
            
            $("#captcha").val('').focus().stbScrollTop();
        }
        ...
        function searchList() {
            ...
            if ($('input[name=svcCd]:checked').val() == '03') {
                $input = $('#cardN1,#cardN2,#cardN3,#cardN4');
                $input.each(function(){
                    if ( this.id != 'cardN4' && $.trim(this.value).length < 4  ) {
                        isVaild = true;
                        
                        alert($(this).attr('title') + '를 입력해 주세요.');
                        $(this).focus().stbScrollTop();
                        return false;
                    } else if ( this.id == 'cardN4' && $.trim(this.value) == '' ) {
                        isVaild = true;
                    ...
                    if(!chkPattern($.trim(this.value),'NUM')){
                    	isVaild = true;
                    	
                    	alert($(this).attr('title') + "는 숫자만 입력 가능합니다.");
                    	$(this).focus().stbScrollTop();
                    	return false;
                    }
                });
            ...
            if (!isVaild) {
                $input = $('#appNo');
                if ( $.trim($input.val()) == '' ) {
                    alert($input.attr('title') + '를 입력해 주세요.');
                    $input.focus().stbScrollTop();
                    return;
                }
                
                $input = $('#amt');
                if ( $.trim($input.val()) == '' ) {
                    alert($input.attr('title') + '을 입력해 주세요.');
                    $input.focus().stbScrollTop();
                    return;
                }
         ...
         * 신용카드 정보 조회
         */
        function getCardAppInfo() {
            var param = $('#searchForm').serialize();
            ___ajaxCall("/interface/getInipayAppInfo.do", param, false, "json", "post", function (_response) {
            	var $tbl = $('#tblAppList tbody');
            	
                if (_response.result_code == "SUCCESS") {
                	if (typeof _response.data === 'undefined' || _response.data == null) {
                		$tbl.html('<tr><td colspan="5">데이터가 없습니다.</td></tr>');
                        
                    } else {
                    	var data = $.parseJSON(_response.data);
                    	var listSeq = 0;
                    	
                        $tbl.empty();
                        
                        try {
	                        $("#cardAppInfoList").tmpl(data, {
	                            seq : function () {
	                                return ++listSeq;
	                            }
		                        ,cardNm : function() {
		                            return $.trim(this.data.cardNm) == "" ? "-" : this.data.cardNm;  
		                        }
	                            ,date : function() {
	                                return getDateFormatConvert(this.data.dtAppl, this.data.tmAppl);
	                            }
	                            ,goodsAmt : function() {
	                                return $.number(this.data.krwTransAmt);
	                            }
	                        }).appendTo($tbl);
	                    
	                        
	                        $('.btnReView').on('click', function(){
	                            showReceipt($(this).data('tid'));
	                        });
         ...
         * SSG 정보 조회
         */
		function getSsgAppInfo() {
			var param = $('#searchForm').serialize();
		    ___ajaxCall("/interface/getSsgAppInfo.do", param, false, "json", "post", function (_response) {
		    	var $tbl = $('#tblAppList tbody');
		    	
		    	if (_response.result_code == "SUCCESS") {
		            var data = $.parseJSON(_response.data);
		            var receiptList = data.appList;
		            
		            if (typeof receiptList === 'undefined' || receiptList.length <= 0) {
		            	$tbl.html('<tr><td colspan="5">데이터가 없습니다.</td></tr>');
		            } else {
		            	var listSeq = 0;
                        $tbl.empty();
                        ...
                        try {
	                        $("#ssgAppInfoList").tmpl(receiptList, {
	                            seq : function () {
	                                return ++listSeq;
	                            }
		                        ,cardNm : function() {
		                            return $.trim(this.data.app_co_nm) == "" ? "-" : this.data.app_co_nm;  
		                        }
	                            ,date : function() {
	                                return getDateFormatConvert(this.data.app_dt, this.data.app_tm);
	                            }
	                            ,goodsAmt : function() {
	                                return $.number(this.data.goods_amt);
	                            }
	                        }).appendTo($tbl);
