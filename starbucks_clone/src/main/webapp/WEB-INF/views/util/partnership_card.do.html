...
<ul>
	...
	<li class="util_nav03"><a href="index.do.html">Customer Service & Ideas</a></li>
		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="제휴카드 안내" src="../common/img/util/csi/csi_partnershipCard_ttl.png"></h4>
							<ul class="smap">
								...
								<li><a href="index.do.html"><span class="en">Customer Service & Ideas</span></a></li>
								<li><img class="arrow" src="../common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
								<li><a href="index.do.html">스타벅스 이용 팁</a></li>
								<li><img class="arrow" src="../common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
								<li><a href="partnership_card.do.html">제휴카드 안내</a></li>
							</ul>
						</div>
					</div>
				</header>
				...
				<div class="ms_cont_wrap">
					<!-- ms_cont -->
					<div class="ms_cont">
						<div class="csi_partnershipCard_cont">
							<div class="csi_partnershipCard_img">
								<!-- 151216 수정 -->
								<p><img class="w_pic" src="../common/img/util/csi/csi_partnershipCard_img.png" alt="제휴카드로 할인 및 서비스 업그레이드 등 다양한 혜택을 누리세요. 일부 매장 및 사이렌 오더 결제 시 제휴카드 혜택 적용이 제외될 수 있습니다.제휴카드 혜택은 각 카드사의 사정에 따라 변경, 제한, 폐지될 수 있으며, 관련 문의는 각 카드사 고객센터에 문의해주시기 바랍니다. "><img class="m_pic" src="../common/img/util/csi/m_csi_partnershipCard_img.png" alt="제휴카드로 할인 및 서비스 업그레이드 등 다양한 혜택을 누리세요."></p>
								<p class="hidden_txt">일부 매장 및 사이렌 오더 결제 시 제휴카드 혜택 적용이 제외될 수 있습니다.<br>제휴카드 혜택은 각 카드사의 사정에 따라 변경, 제한, 폐지될 수 있으며, 관련 문의는 각 카드사 고객센터에 문의해주시기 바랍니다. </p>
								<!-- 151216 수정 end -->
							</div>
							<section class="csi_partnershipCard_best">
								<header>
									<h5>베스트 제휴카드</h5>
									<p class="csi_psCard_total"><span>총 7개 이용안내</span></p>
								</header>
								<ul class="csi_psCard_list bestCard">
									
										<li>
											<dl>
												<dt>
													
													<p class="card_img"><img alt="SSG 카드" src="../upload/prcmcard/SSG-master_138x87.jpg"></p> 
													<p class="card_text">SSG 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>SSGPAY로 SSG카드 캐쉬백 쿠폰 사용 시 20% 할인 </li>
														<li>1일 1회, 월 4회</li>
														<li>1회 최대 5,000원</li>
														<li>전월 30만원 이상 SSGPAY로 SSG카드 이용 시</li>
														<li>SSGPAY SSG카드 결제 시 1.5% SSG머니 기본 적립</li>
													</ul>
												</dd>
											</dl>
										</li>
										...
										<li>
											<dl>
												<dt>
													...
													<p class="card_img"><img alt="SSG PAY" src="../upload/prcmcard/csi_bestCard_img9.png"></p> 
													<p class="card_text">SSG PAY</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>SSG MONEY 또는 SSG PAY 간편결제로 스타벅스 매장 내 결제 가능 </li>
														<li>(단, SSG MONEY는 스타벅스 카드 충전 불가)</li>
														<li></li>
														<li></li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>
													...
													<p class="card_img"><img alt="KT멤버십(전체)" src="../upload/prcmcard/pkmcUD_20220330111641172.jpg"></p> 
													<p class="card_text">KT멤버십(전체)</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>Free Size Upgrade </li>
														<li>KT 멤버십 회원 본인에 한함(구 멤버십 회원 제외)</li>
														<li>500 포인트 차감, 월 1회, 제조음료에 한함</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>
													...
													<p class="card_img"><img alt="KT멤버십(VIP)" src="../upload/prcmcard/pkmcUD_20220330111729189.jpg"></p> 
													<p class="card_text">KT멤버십(VIP)</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>아메리카노 숏사이즈 무료 제공 </li>
														<li>VIP, VVIP 고객 본인에 한함, 4,000포인트 차감</li>
														<li>VIP초이스(VIP) 통합 월 1회 / 연 6회 제공</li>
														<li>VIP초이스(VVIP) 통합 월 1회 / 연 12회 제공</li>
														<li>* 2022년 4월 1일(금)부터 4,000포인트 차감 후 혜택 제공</li>
													</ul>
												</dd>
											</dl>
										</li>
										...
										<li>
											<dl>
												<dt>
													...
													<p class="card_img"><img alt="티머니 카드 (모바일티머니)" src="../upload/prcmcard/csi_bestCard_img8.png"></p> 
													<p class="card_text">티머니 카드 (모바일티머니)</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 매장 내 결제 가능 </li>
														<li>(단, 스타벅스 카드 충전 불가)</li>
														<li></li>
														<li></li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>
													...
													<p class="card_img"><img alt="신세계 포인트 카드" src="../upload/prcmcard/csi_bestCard_img03.png"></p> 
													<p class="card_text">신세계 포인트 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>결제수단별 결제금액 1천원당 1포인트 적립 또는 포인트 결제 가능 </li>
														<li>스타벅스 카드, 통신사 멤버십 결제건 등 제외</li>
														<li></li>
														<li></li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>
													...
													<p class="card_img"><img alt="현대카드 H-Coin" src="../upload/prcmcard/Hyundai_HCoin_img.png"></p> 
													<p class="card_text">현대카드 H-Coin</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>현대카드 H-Coin 현금처럼 100% 사용 </li>
														<li>(일부 매장 및 사이렌오더 사용 불가 / 스타벅스 카드 충전 가능)</li>
														<li></li>
														<li></li>
														<li></li>
													</ul>
									...
									<li class="csi_faq_wrap2">
										<i><img alt="" src="../common/img/util/csi/icon_faq.png"></i>
										<p class="titl">[FAQ]</p>
										<p class="txt">제휴카드에 대한 다양한 질문보기 </p>
										<p class="btn_faq"><a href="../community/faq.do-3.html?menu_cd=STB2703&cate=F04">FAQ 바로가기</a></p>
									</li>
								</ul>
							</section>
							
							<section class="csi_partnershipCard_all">
								<header>
									<h5>전체 제휴카드</h5>
									<p class="csi_psCard_total"><span>총 41개 이용안내</span></p>
								</header>
								<ul class="csi_psCard_list allCard">
									
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="THE 1 BY SAMSUNG CARD" src="../upload/prcmcard/a1.png"></p>
													<p class="card_text">THE 1 BY SAMSUNG CARD</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 2,000원 할인 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li>1만원 이상 결제 시 2,000원 결제일 할인(청구할인), 월2회 연12회</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="삼성카드 & YOUNG" src="../upload/prcmcard/a2.png"></p>
													<p class="card_text">삼성카드 & YOUNG</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 5% 할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="삼성아멕스블루카드" src="../upload/prcmcard/a3.png"></p>
													<p class="card_text">삼성아멕스블루카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 사이즈 1단계 업그레이드 무료 제공 </li>
														<li>직전3개월간 월평균 10만원 이상 시</li>
														<li>1일1회(잔), 월4회, 연24회 제공</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="삼성지엔미 포인트카드" src="../upload/prcmcard/a4.png"></p>
													<p class="card_text">삼성지엔미 포인트카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 1,000원 할인 </li>
														<li>조건 없음</li>
														<li>1만원 이상 결제 시 1,000원 결제일할인(청구할인), 월1회, 연5회</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="THE O[더 오](포인트) 카드" src="../upload/prcmcard/a5.png"></p>
													<p class="card_text">THE O[더 오](포인트) 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 3,000원 할인 </li>
														<li>직전 3개월간 일시불 및 할부 이용실적이 있는 경우 제공</li>
														<li>1만원 이상 결제 시 3,000원 결제일 할인(청구할인), 월1회 연12회</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="신한카드 THE CLASSIC+" src="../upload/prcmcard/b1.png"></p>
													<p class="card_text">신한카드 THE CLASSIC+</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 3,000원 할인 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li>스타벅스에서 7,000원 이상 구매 시 3,000원 할인, 월1회 연6회</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="신한카드 THE CLASSIC-Y" src="../upload/prcmcard/b2.png"></p>
													<p class="card_text">신한카드 THE CLASSIC-Y</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 5% 할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="신한 J PLUS 카드" src="../upload/prcmcard/b3.png"></p>
													<p class="card_text">신한 J PLUS 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 20% 할인 </li>
														<li>전월 20만원 이상 이용 시</li>
														<li>1회 최대 2,000원</li>
														<li>1일 1회, 월 5회</li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="신한 LOVE PLATINUM#" src="../upload/prcmcard/b4.png"></p>
													<p class="card_text">신한 LOVE PLATINUM#</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 최대 20% 청구할인 </li>
														<li>전월 50만원 이상</li>
														<li>통합할인한도 내</li>
														<li></li>
														<li></li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="신한카드 Simple+" src="../upload/prcmcard/b5.png"></p>
													<p class="card_text">신한카드 Simple+</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>잔돈할인(Coin-Save) </li>
														<li>전월 30만원 이상</li>
														<li>월 10회에 한하여 서비스 제공</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="KB국민 스타맥스카드" src="../upload/prcmcard/c1.png"></p>
													<p class="card_text">KB국민 스타맥스카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 최소 5%에서 최대 20%할인 </li>
														<li>전월 30만원 이상</li>
														<li></li>
														<li></li>
														<li></li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="KB국민 스윗드림카드" src="../upload/prcmcard/c2.png"></p>
													<p class="card_text">KB국민 스윗드림카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 5% 할인 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li>전월 결제금액에 따라 차등(최소 5,000원 ~ 최대 40,000)</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="KB국민 굿데이카드" src="../upload/prcmcard/c3.png"></p>
													<p class="card_text">KB국민 굿데이카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 10% 할인 </li>
														<li>전월 60만원 이상 이용 시</li>
														<li>월 할인한도 5천원</li>
														<li></li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="myOne KB국민카드" src="../upload/prcmcard/c4.png"></p>
													<p class="card_text">myOne KB국민카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 10% 할인 </li>
														<li>승인월 직전 3개월 월평균 결제금액 10만원이상 고객대상</li>
														<li></li>
														<li></li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="KB국민 FINETECH 카드" src="../upload/prcmcard/c5.png"></p>
													<p class="card_text">KB국민 FINETECH 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>사이렌오더 결제 시 50%, 매장 결제 시 30% 할인 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li>월 최대 20,000원</li>
														<li></li>
														<li></li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="NEW우리V카드" src="../upload/prcmcard/d1.png"></p>
													<p class="card_text">NEW우리V카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 20% 할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="우리 가득한 할인카드" src="../upload/prcmcard/d2.png"></p>
													<p class="card_text">우리 가득한 할인카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 20% 할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="우리 Every Mall 카드" src="../upload/prcmcard/d4.png"></p>
													<p class="card_text">우리 Every Mall 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 5% 청구할인 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li>월 할인 한도: 3,000원</li>
														<li>일 1회</li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="우리 나만의 포인트카드" src="../upload/prcmcard/d5.png"></p>
													<p class="card_text">우리 나만의 포인트카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 20% 청구할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="하나 2X α(투엑스알파)카드" src="../upload/prcmcard/e1.png"></p>
													<p class="card_text">하나 2X α(투엑스알파)카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 25%~50% 할인 </li>
														<li>직전 1개월 합계 25만원 이상</li>
														<li>25%(월 1만원) ~ 50%(월 2만원) 할인</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="VIVA G 카드" src="../upload/prcmcard/e2.png"></p>
													<p class="card_text">VIVA G 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 5% 청구할인 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li>월 할인 한도 : 5,000원</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="하나N G플러스카드" src="../upload/prcmcard/e3.png"></p>
													<p class="card_text">하나N G플러스카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 10% 할인 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li>건당 최대 10,000원 할인</li>
														<li>통합 월 3회</li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="하나 CLUB SK 카드" src="../upload/prcmcard/e4.png"></p>
													<p class="card_text">하나 CLUB SK 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 5% 할인 </li>
														<li>전월 40만원 이상 이용 시</li>
														<li>월 5,000원</li>
														<li></li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="씨티 클리어 카드" src="../upload/prcmcard/f2.png"></p>
													<p class="card_text">씨티 클리어 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 10% 할인 </li>
														<li>전월 15만원 이상 이용 시</li>
														<li>통합할인한도 내</li>
														<li></li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="씨티 메가마일 스카이패스 카드" src="../upload/prcmcard/f3.png"></p>
													<p class="card_text">씨티 메가마일 스카이패스 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 5마일 특별적립 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="씨티 메가마일 아시아나 카드" src="../upload/prcmcard/f4.png"></p>
													<p class="card_text">씨티 메가마일 아시아나 카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 최대 7마일 특별적립 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li></li>
														<li></li>
														<li></li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="신세계 씨티카드 콰트로" src="../upload/prcmcard/f5.png"></p>
													<p class="card_text">신세계 씨티카드 콰트로</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 20% 청구할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="NH농협 TAKE5카드" src="../upload/prcmcard/g1.png"></p>
													<p class="card_text">NH농협 TAKE5카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>전세계 스타벅스 및 국내커피30%할인 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li>일 할인한도 1만원</li>
														<li></li>
														<li></li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="NH농협 스카이패스카드" src="../upload/prcmcard/g2.png"></p>
													<p class="card_text">NH농협 스카이패스카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>1,500원당 2마일리지 적립 </li>
														<li>조건 없음</li>
														<li></li>
														<li></li>
														<li></li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="NH농협 아이행복카드(Edu)" src="../upload/prcmcard/g4.png"></p>
													<p class="card_text">NH농협 아이행복카드(Edu)</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 10% 청구할인 </li>
														<li>전월 30만원 이상 이용 시 / 1만원 이상 결제 건에 한함</li>
														<li>월 5천원 한도</li>
														<li>월 2회</li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="NH농협 아이행복카드(shopping)" src="../upload/prcmcard/g5.png"></p>
													<p class="card_text">NH농협 아이행복카드(shopping)</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 10% 청구할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="현대카드M3 Edition2" src="../upload/prcmcard/h1.png"></p>
													<p class="card_text">현대카드M3 Edition2</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 500원 할인 </li>
														<li>전월 50만원 이상 이용 시</li>
														<li>연간 30회 한도, 본인+가족 1일 1회</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="현대카드M2 Edition2" src="../upload/prcmcard/h2.png"></p>
													<p class="card_text">현대카드M2 Edition2</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 500원 할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="현대카드X2" src="../upload/prcmcard/h3.png"></p>
													<p class="card_text">현대카드X2</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 500원 할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="NH농협 ME카드" src="../upload/prcmcard/g3.png"></p>
													<p class="card_text">NH농협 ME카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 최대 30% 할인 </li>
														<li>전월 30만원 이상 이용 시</li>
														<li>전월실적:30만원 이상 / 할인한도 5천원 / 50만원 이상 / 할인한도 1만원 / 100만원 이상 / 할인한도 2만원</li>
														<li>통합 할인 한도 내 할인 혜택 제공, 할인 횟수 제한없음</li>
														<li></li>
													</ul>
												</dd>
											</dl>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="신세계360체크카드" src="../upload/prcmcard/i2.png"></p>
													<p class="card_text">신세계360체크카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 5% 포인트 적립 </li>
														<li>3개월이상 연속 30만원 이상 사용시 10% 포인트 적립</li>
														<li></li>
														<li></li>
														<li></li>
													</ul>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="에이스플러스 체크카드" src="../upload/prcmcard/i3.png"></p>
													<p class="card_text">에이스플러스 체크카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 20% 할인 </li>
														<li>월 2회</li>
														<li>월 최대 3,000원 할인</li>
														<li>직전 3개월 합계 30만원 이상 사용 시</li>
														<li></li>
													</ul>
												</dd>
											</dl>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="타임카드" src="../upload/prcmcard/i4.png"></p>
													<p class="card_text">타임카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 20% 할인 </li>
														<li>일 1회</li>
														<li>12:00~14:00 결제 금액 한정</li>
														<li></li>
														<li></li>
													</ul>
												</dd>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="국민행복카드" src="../upload/prcmcard/i5.png"></p>
													<p class="card_text">국민행복카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 최대 20% 할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="아이행복카드" src="../upload/prcmcard/i6.png"></p>
													<p class="card_text">아이행복카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 최대 20% 할인 </li>
										...
										<li>
											<dl>
												<dt>												    
													<p class="card_img"><img alt="이마트360신용카드" src="../upload/prcmcard/i7.png"></p>
													<p class="card_text">이마트360신용카드</p>
												</dt>
												<dd>
													<ul class="csi_psCard_list_dot">
														<li>스타벅스 3% 적립 (전월 실적 30만원 사용 시) </li>
														<li>기본 0.5% 적립</li>
														<li></li>
														<li></li>
														<li></li>
							...
							<!-- 페이징 -->
							<!-- 150809 수정 삭제
							<div class="csi_partnershipCard_pagination">
								<ul class="pager">
									<li class="control"><a href="javascript:void(0)"><img alt="처음으로" src="//image.istarbucks.co.kr/common/img/util/ec/first.jpg"></a></li>
									<li class="control"><a href="javascript:void(0)"><img alt="앞으로" src="//image.istarbucks.co.kr/common/img/util/ec/prev.jpg"></a></li>
									<li class="active"><a href="javascript:void(0)">1</a></li>
									<li><a href="javascript:void(0)">2</a></li>
									<li><a href="javascript:void(0)">3</a></li>
									<li class="control"><a href="javascript:void(0)"><img alt="뒤로" src="//image.istarbucks.co.kr/common/img/util/ec/next.jpg"></a></li>
									<li class="control"><a href="javascript:void(0)"><img alt="끝으로" src="//image.istarbucks.co.kr/common/img/util/ec/last.jpg"></a></li>
								</ul>
							</div> 
							-->
							<!-- 페이징 end -->
...
<nav class="ms_nav" id="msRnb">
	<ul>
		<li class="msRnb_btn"><a href="faq.do.html">자주 하는 질문</a></li> <!-- 20210809 수정 -->
		<li class="msRnb_btn"><a href="../customer/suggestionWrite.do.html">고객의 소리</a></li>
		<li class="msRnb_btn"><a href="storecareList.do.html">스토어 케어</a></li>
		<li><a href="javascript:void(0);">스타벅스 이용 팁<span class="sbox_arrow_down"></span></a>
			<ul>
				<li><a href="web_tip.do.html">· 홈페이지 이용 팁</a></li>
				<li><a href="app_tip.do.html">· 애플리케이션 이용 팁</a></li>
				<li><a href="partnership_card.do.html">· 제휴카드 안내</a></li>
			</ul></li>
		<li class="msRnb_btn"><a href="online_survey.do.html">고객 경험 설문조사</a></li> <!-- 20210811 수정 -->
		
		
		<li class="msRnb_btn"><a href="guest_eReceipt.do.html">비회원 전자영수증 조회</a></li>
				...
				<div class="footer_wrap">
					<div class="footer_menus">
						<ul class="footer_first_menu">
							...
							<li><a href="faq.do.html">자주 하는 질문</a></li><!-- 20210809 수정 -->
							...
							<li><a href="online_survey.do.html">고객 경험 설문조사</a></li> <!-- 20210811 수정  -->
							
							
							<li><a href="guest_eReceipt.do.html">비회원 전자영수증 조회</a></li>
