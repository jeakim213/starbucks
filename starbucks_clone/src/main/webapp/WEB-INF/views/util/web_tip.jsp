		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="홈페이지 이용 팁" src="../common/img/util/csi/website_tip_ttl.png?v=210823"></h4> <!-- 20210823 수정 -->
							<ul class="smap">
								...
								<li><a href="/util/index.do">스타벅스 이용 팁</a></li> 20210809 주석 처리-->
								<li><img class="arrow" src="../common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
								<li><a href="web_tip.do.html">홈페이지 이용 팁</a></li> <!-- 20210811 수정 -->
							</ul>
						</div>
					</div>
				</header>
				...
				<div class="ms_cont_wrap">
					<!-- ms_cont -->
					<div class="ms_cont">
						<div class="csi_websiteTip_cont">
							<div class="csi_websiteTip_img">	
								<!-- 150628 디자인 수정  -->
                                <p><img class="w_pic" src="../common/img/util/csi/csi_websiteTip_img.png?v=210823" alt="스타벅스 홈페이지 이용 시 유용한 꿀팁과 노하우를 소개합니다."><img class="m_pic" src="../common/img/util/csi/m_csi_websiteTip_img.png?v=210823" alt="스타벅스 홈페이지 이용 시 유용한 꿀팁과 노하우를 소개합니다."></p><!-- 20210809 수정 -->
								<!-- 150628 디자인 수정 삭제
								<dl>
									<dt>여러분들이 궁금해 하시는 내용에 대한 팁과 노하우를 정리 해 놓았습니다. </dt>
									<dd> 검색을 통해서도 찾으실 수 있습니다.</dd>
								</dl>-->
							</div>	
							<!-- 검색 -->
							<div class="csi_websiteTip_sch_wrap">
								<form action="" method="post" onsubmit="return false">
									<fieldset>
										<legend>홈페이지 이용 팁 검색</legend>										
										<div class="csi_websiteTip_sch_input">
											<input type="text" name="csi_websiteTip_bar01" id="csi_websiteTip_bar01" placeholder="검색어를 입력하세요."> <a href="javascript:searchBtn('STB2709', 'web');" class="sch_btn">검색</a>
										</div>
									</fieldset>
								</form>
							</div>
							<!-- 검색 end -->
							<p class="csi_websiteTip_total" id="listCnt"><!-- <span>총 12개 이용안내</span> --></p>
							<section class="csi_websiteTip_list">
								<ul class="csi_wTip_list" id='web_tipList'>
								</ul>
							</section>
							<!-- 페이징 -->
							 <div class="csi_wTip_list_pagination">
								<ul class="pager">
								</ul>
							</div> 
							<!-- 페이징 end -->
