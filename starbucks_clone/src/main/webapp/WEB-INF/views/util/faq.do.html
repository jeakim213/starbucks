...
var eFrequencyPlannerYn = 'Y';
		...
		<link rel="stylesheet" href="../common/css/style_faq.css?v=220104">
		<style type="text/css">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="자주 하는 질문" src="../common/img/util/csi/faq_tit.png?v=210823"></h4> <!-- 20210823 수정 -->
							<ul class="smap">
				...
				<div class="ms_cont_wrap">
					...
					<div class="ms_cont">
						<div class="csi_faq_vis">
							<p><img class="w_pic" src="../common/img/util/csi/faq_vis.png?v=210818" alt="고객님들께서 가장 많이 묻는 질문을 모두 모았습니다. 검색을 통해 궁금한 사항을 빠르게 찾아보세요."><img class="m_pic" src="../common/img/util/csi/m_faq_vis.png?v=210818" alt="고객님들께서 가장 많이 묻는 질문을 모두 모았습니다. 검색을 통해 궁금한 사항을 빠르게 찾아보세요."></p> <!-- 20210809 수정 -->
						</div>
						<!-- 새 마크업 영역 -->
                    ...
                    <div class="faq_list_area">
                        ...
                        <div id="tabs">
                            <ul id="cause_list">
                            <li class="check-all">
                                <a href="#tabs-all"><span>전체</span></a>
                            </li>
                            
                            </ul>
                            <div id="tabs-all">
                            	<div class="accrodion-wrap" id="accrodionWrap">
                                FAQ 전체
                                </div>
                            </div>
                            <div id="tabs-1">
                    ...
                    <!-- //새 마크업 영역 -->
						...
						<div class="csi_faq_contact">
							...
							<p class="contact_btn"><a href="../customer/suggestionWrite.do.html">고객의 소리 문의하기</a></p>
						</div>
	...
	<ul>
		...
		<li class="msRnb_btn"><a href="guest_eReceipt.do.html">비회원 전자영수증 조회</a></li>
			...
			<form name="faqFrm" method="poat">
				<input type="hidden" id="cate_cd" name="cate_cd" value="000">
				<input type="hidden" id="seq" name="seq" value="0000000000">
