...
<ul>
	...
	<li class="util_nav03"><a href="index">Customer Service & Ideas</a></li>
					...
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							...
							<ul class="smap">
								...
								<li><a href="index"><span class="en">Customer Service & Ideas</span></a></li>
								<li><img class="arrow" src="common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
								<li><a href="index">스타벅스 이용 팁</a></li>
								<li><img class="arrow" src="common/img/common/icon_arrow_w.png" alt="하위메뉴"></li>
								<li><a href="partnership_card">제휴카드 안내</a></li>
							</ul>
						</div>
					</div>
				</header>
							...
							<section class="csi_partnershipCard_best">
								...
								<ul class="csi_psCard_list bestCard">
									...
									<li class="csi_faq_wrap2">
										...
										<p class="btn_faq"><a href="community/faq-3?menu_cd=STB2703&cate=F04">FAQ 바로가기</a></p>
									</li>
								</ul>
							</section>
...
<nav class="ms_nav" id="msRnb">
	<ul>
		<li class="msRnb_btn"><a href="faq">자주 하는 질문</a></li> <!-- 20210809 수정 -->
		<li class="msRnb_btn"><a href="customer/suggestionWrite">고객의 소리</a></li>
		<li class="msRnb_btn"><a href="storecareList">스토어 케어</a></li>
		<li><a href="javascript:void(0);">스타벅스 이용 팁<span class="sbox_arrow_down"></span></a>
			<ul>
				<li><a href="web_tip">· 홈페이지 이용 팁</a></li>
				<li><a href="app_tip">· 애플리케이션 이용 팁</a></li>
				<li><a href="partnership_card">· 제휴카드 안내</a></li>
			</ul></li>
		<li class="msRnb_btn"><a href="online_survey">고객 경험 설문조사</a></li> <!-- 20210811 수정 -->
		
		
		<li class="msRnb_btn"><a href="guest_eReceipt">비회원 전자영수증 조회</a></li>
				...
				<div class="footer_wrap">
					<div class="footer_menus">
						<ul class="footer_first_menu">
							...
							<li><a href="faq">자주 하는 질문</a></li><!-- 20210809 수정 -->
							...
							<li><a href="online_survey">고객 경험 설문조사</a></li> <!-- 20210811 수정  -->
							
							
							<li><a href="guest_eReceipt">비회원 전자영수증 조회</a></li>
