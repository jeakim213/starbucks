		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="고객 경험 설문조사" src="../common/img/util/csi/csi_survey_tit.png?v=210810"></h4><!-- 20210809 수정 -->
							<ul class="smap">
								...
								<!-- 160504 문구 수정 -->
								<li><a href="online_survey.do.html"><span>고객 경험 설문조사</span></a></li><!-- 20210809 수정 -->
								<!-- 160504 문구 수정 end -->
				...
				<div class="ms_cont_wrap">
					<!-- ms_cont -->
					<div class="ms_cont">
						<div class="survey_vis">
							<img class="w_pic" src="../common/img/util/csi/survey_visual.jpg" alt="">
							<img class="m_pic" src="../common/img/util/csi/m_survey_visual.jpg" alt="">
						</div>
						
						<p class="survey_tit">스타벅스는 고객님의 소중한 의견에 귀 기울이겠습니다.</p>

						<!-- <p class="survey_con">고객경험 설문조사(Customer Experience Survey)는 SR 고객을 대상으로 방문하신 매장 이용 경험에 대한 의견을 통해 <br/>스타벅스를 이용하는 모든 순간을 가치 있게 만들고자 스타벅스에서 진행하는 국제 온라인 설문 조사입니다. 
						<br/>설문 참여는 스타벅스 APP를 통해 편리하게 참여하실 수 있으며 추가적으로 궁금하신 점은 “Customer Service & Ideas > 자주하는 질문”을 통해 <br/>확인하실 수 있습니다.</p> 20210809 주석 처리-->
						
						<p class="survey_con">고객 경험 설문조사(Customer Experience Survey)는 스타벅스 APP 사용 고객을 대상으로 방문하신 매장 이용 경험에 대한 의견을 통해, 스타벅스를 이용하는 모든 순간을 가치 있게 만들고자 스타벅스에서 진행하는 국제 온라인 설문 조사입니다. 설문 참여는 스타벅스 APP을 통해 쉽게 참여하실 수 있으며, 추가적으로 궁금하신 점은 ‘Customer Service &amp; Ideas &gt; 자주 하는 질문’을 통해 확인하실 수 있습니다.</p> <!-- 20210811 수정 -->
		...
		<script>
			$(document).ready(function(){
				...
				if(myWindow > 1099){
					...
					var news_slide = $('.sb_use_tip_slide ul').bxSlider({
						minSlides:2,
						maxSlides:2,
						slideWidth:328,
						slideMargin:24,
